...
def build(bld):
    ...
    module.source = [
        ...
        'model/beamforming-algorithm.cc',
        ...
        'model/nr-sl-sci-f1a-header.cc',
        'model/nr-sl-sci-f2-header.cc',
        'model/nr-sl-sci-f2a-header.cc',
    ...
    headers.source = [
        ...
        'model/nr-sl-sci-f1a-header.h',
        'model/nr-sl-sci-f2-header.h',
        'model/nr-sl-sci-f2a-header.h',
