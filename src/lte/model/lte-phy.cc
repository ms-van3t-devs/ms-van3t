...
//  uint16_t SrsCiHigh[9] = {0, 1, 6, 16, 36, 76, 156, 316, 636};
  uint16_t SrsPeriodicity[14] = {0, 2, 5, 10, 20, 40, 80, 160, 320, 640, 1280, 2560, 5120, 10240};
  uint16_t SrsCiLow[14] = {0, 0, 2, 7, 17, 37, 77, 157, 317, 637, 1277, 2557, 5117, 10237};
  int16_t SrsCiHigh[14] = {0, 1, 6, 16, 36, 76, 156, 316, 636, 1276, 2556, 5116, 10236, 20476};
  //  uint8_t i;
  //  for (i = 8; i > 0; i --)
  //    {
...
//  uint16_t SrsCiLow[9] = {0, 0, 2, 7, 17, 37, 77, 157, 317};
//  uint16_t SrsCiHigh[9] = {0, 1, 6, 16, 36, 76, 156, 316, 636};
  uint16_t SrsSubframeOffset[14] = {0, 0, 2, 7, 17, 37, 77, 157, 317, 637, 1277, 2557, 5117, 10237};
  uint16_t SrsCiLow[14] = {0, 0, 2, 7, 17, 37, 77, 157,317, 637, 1277, 2557, 5117, 10237};
  uint16_t SrsCiHigh[14] = {0, 1, 6, 16, 36, 76, 156, 316, 636, 1276, 2556, 5116, 10236, 20476};
//  uint8_t i;
//  for (i = 8; i > 0; i --)
//    {
//      if ((srcCi>=SrsCiLow[i])&&(srcCi<=SrsCiHigh[i]))
