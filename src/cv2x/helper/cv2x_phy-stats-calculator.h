...
#ifndef CV2X_PHY_STATS_CALCULATOR_H_
#define CV2X_PHY_STATS_CALCULATOR_H_
 ...
 */
class cv2x_PhyStatsCalculator : public cv2x_LteStatsCalculator
{
public:
  /**
   * Constructor
   */
  cv2x_PhyStatsCalculator ();

  /**
   * Destructor
   */
  virtual ~cv2x_PhyStatsCalculator ();
   ...
   * \param componentCarrierId
   */
  static void ReportCurrentCellRsrpSinrCallback (Ptr<cv2x_PhyStatsCalculator> phyStats,
   ...
   * \param componentCarrierId
   */
  static void ReportUeSinr (Ptr<cv2x_PhyStatsCalculator> phyStats, std::string path,
   ...
   * \param interference 
   */
  static void ReportInterference (Ptr<cv2x_PhyStatsCalculator> phyStats, std::string path,
...
#endif /* CV2X_PHY_STATS_CALCULATOR_H_ */
