...
#ifndef CV2X_RADIO_BEARER_STATS_CONNECTOR_H
#define CV2X_RADIO_BEARER_STATS_CONNECTOR_H
...
class cv2x_RadioBearerStatsCalculator;
 ...
 * cv2x_RadioBearerStatsCalculator to appropriate trace sinks.
 * Usually user does not use this class. All he/she needs
 * to do is to call: cv2x_LteHelper::EnablePdcpTraces() and/or
 * cv2x_LteHelper::EnableRlcTraces().
 */

class cv2x_RadioBearerStatsConnector
{
public:
  /// Constructor
  cv2x_RadioBearerStatsConnector ();

  /**
   * Enables trace sinks for RLC layer. Usually, this function
   * is called by cv2x_LteHelper::EnableRlcTraces().
   * \param rlcStats statistics calculator for RLC layer
   */
  void EnableRlcStats (Ptr<cv2x_RadioBearerStatsCalculator> rlcStats);

  /**
   * Enables trace sinks for PDCP layer. Usually, this function
   * is called by cv2x_LteHelper::EnablePdcpTraces().
   * \param pdcpStats statistics calculator for PDCP layer
   */
  void EnablePdcpStats (Ptr<cv2x_RadioBearerStatsCalculator> pdcpStats);
   ...
   * \param rnti
   */
  static void NotifyRandomAccessSuccessfulUe (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
   ...
   * \param rnti
   */
  static void NotifyConnectionSetupUe (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
   ...
   * \param rnti
   */
  static void NotifyConnectionReconfigurationUe (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
   ...
   * \param targetCellId
   */
  static void NotifyHandoverStartUe (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti, uint16_t targetCellId);
   ...
   * \param rnti
   */
  static void NotifyHandoverEndOkUe (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
   ...
   * \param rnti
   */
  static void NotifyNewUeContextEnb (cv2x_RadioBearerStatsConnector* c, std::string context, uint16_t cellid, uint16_t rnti);
   ...
   * \param rnti
   */
  static void NotifyConnectionReconfigurationEnb (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
   ...
   * \param targetCellId
   */
  static void NotifyHandoverStartEnb (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti, uint16_t targetCellId);
   ...
   * \param rnti
   */
  static void NotifyHandoverEndOkEnb (cv2x_RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti);
...
private:
  ...
  Ptr<cv2x_RadioBearerStatsCalculator> m_rlcStats; //!< Calculator for RLC Statistics
  Ptr<cv2x_RadioBearerStatsCalculator> m_pdcpStats; //!< Calculator for PDCP Statistics
...
#endif // CV2X_RADIO_BEARER_STATS_CONNECTOR_H
