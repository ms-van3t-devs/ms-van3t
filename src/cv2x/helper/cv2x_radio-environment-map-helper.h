...
#ifndef CV2X_RADIO_ENVIRONMENT_MAP_HELPER_H
#define CV2X_RADIO_ENVIRONMENT_MAP_HELPER_H
 ...
 */
class cv2x_RadioEnvironmentMapHelper : public Object
{
public:  

  cv2x_RadioEnvironmentMapHelper ();
  virtual ~cv2x_RadioEnvironmentMapHelper ();
  ...
  /** 
   * Deploy the cv2x_RemSpectrumPhy objects that generate the map according to the specified settings.
   * 
   */
  void Install ();
...
}; // end of `class cv2x_RadioEnvironmentMapHelper`


} // end of `namespace ns3`

#endif /* CV2X_RADIO_ENVIRONMENT_MAP_HELPER_H */
