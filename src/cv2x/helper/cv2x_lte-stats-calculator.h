...
#ifndef CV2X_LTE_STATS_CALCULATOR_H_
#define CV2X_LTE_STATS_CALCULATOR_H_
...
class cv2x_LteStatsCalculator : public Object
{
public:
  /**
   * Constructor
   */
  cv2x_LteStatsCalculator ();

  /**
   * Destructor
   */
  virtual ~cv2x_LteStatsCalculator ();
...
protected:
  ...
  /**
   * Retrieves IMSI from cv2x_LteNetDevice path in the attribute system
   * @param path Path in the attribute system to get
   * @return the IMSI associated with the given path
   */
...
#endif /* CV2X_LTE_STATS_CALCULATOR_H_ */
