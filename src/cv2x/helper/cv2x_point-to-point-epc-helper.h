...
#ifndef CV2X_POINT_TO_POINT_EPC_HELPER_H
#define CV2X_POINT_TO_POINT_EPC_HELPER_H
 ...
 * PointToPoint links. 
 */
class cv2x_PointToPointEpcHelper : public cv2x_EpcHelper
{
public:
   ...
   * Constructor
   */
  cv2x_PointToPointEpcHelper ();

  /** 
   * Destructor
   */  
  virtual ~cv2x_PointToPointEpcHelper ();
...
#endif // CV2X_POINT_TO_POINT_EPC_HELPER_H
