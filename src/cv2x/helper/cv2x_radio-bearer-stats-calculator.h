...
#ifndef CV2X_RADIO_BEARER_STATS_CALCULATOR_H_
#define CV2X_RADIO_BEARER_STATS_CALCULATOR_H_
 ...
 */
class cv2x_RadioBearerStatsCalculator : public cv2x_LteStatsCalculator
{
public:
  /**
   * Class constructor
   */
  cv2x_RadioBearerStatsCalculator ();

  /**
    * Class constructor
    * \param protocolType the name of the protocol type
    */
  cv2x_RadioBearerStatsCalculator (std::string protocolType);
...
#endif /* CV2X_RADIO_BEARER_STATS_CALCULATOR_H_ */
