...
#ifndef CV2X_LTE_GLOBAL_PATHLOSS_DATABASE_H
#define CV2X_LTE_GLOBAL_PATHLOSS_DATABASE_H
 ...
 * 
 */
class cv2x_LteGlobalPathlossDatabase
{
public:

  virtual ~cv2x_LteGlobalPathlossDatabase (void);
 ...
 */
class cv2x_DownlinkLteGlobalPathlossDatabase : public cv2x_LteGlobalPathlossDatabase
{
public:
  // inherited from cv2x_LteGlobalPathlossDatabase
 ...
 */
class cv2x_UplinkLteGlobalPathlossDatabase : public cv2x_LteGlobalPathlossDatabase
{
public:
  // inherited from cv2x_LteGlobalPathlossDatabase
  virtual void UpdatePathloss (std::string context, Ptr<SpectrumPhy> txPhy, Ptr<SpectrumPhy> rxPhy, double lossDb);
...
#endif // CV2X_LTE_GLOBAL_PATHLOSS_DATABASE_H
