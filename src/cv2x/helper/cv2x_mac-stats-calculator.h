...
#ifndef CV2X_MAC_STATS_CALCULATOR_H_
#define CV2X_MAC_STATS_CALCULATOR_H_
 ...
 */
class cv2x_MacStatsCalculator : public cv2x_LteStatsCalculator
{
public:
  /**
   * Constructor
   */
  cv2x_MacStatsCalculator ();

  /**
   * Destructor
   */
  virtual ~cv2x_MacStatsCalculator ();
  ...
  void DlScheduling (uint16_t cellId, uint64_t imsi, cv2x_DlSchedulingCallbackInfo dlSchedulingCallbackInfo);
  ...
  */
  void SlUeScheduling (cv2x_SlUeMacStatParameters params);
  
  /**
  * Notifies the stats calculator that a sidelink shared channel ue mac scheduling has occurred.
  */
  void SlSharedChUeScheduling (cv2x_SlUeMacStatParameters params);


  /** 
   * Trace sink for the ns3::cv2x_LteEnbMac::DlScheduling trace source
   * 
   * \param macStats 
   * \param path 
   * \param dlSchedulingCallbackInfo cv2x_DlSchedulingCallbackInfo structure containing all downlink information that is generated what DlScheduling traces is fired
   */
  static void DlSchedulingCallback (Ptr<cv2x_MacStatsCalculator> macStats, std::string path, cv2x_DlSchedulingCallbackInfo dlSchedulingCallbackInfo);

  /** 
   * Trace sink for the ns3::cv2x_LteEnbMac::UlScheduling trace source
   * 
   * \param macStats 
   * \param path 
   * \param frameNo 
   ...
   */
  static void UlSchedulingCallback (Ptr<cv2x_MacStatsCalculator> macStats, std::string path,
   ...
   * Trace sink for the ns3::cv2x_LteEnbMac::DlScheduling trace source
   */
  static void SlUeSchedulingCallback (Ptr<cv2x_MacStatsCalculator> macStats, std::string path, cv2x_SlUeMacStatParameters params);

  /** 
   * Trace sink for the ns3::cv2x_LteEnbMac::DlScheduling trace source
   */
  static void SlSharedChUeSchedulingCallback (Ptr<cv2x_MacStatsCalculator> macStats, std::string path, cv2x_SlUeMacStatParameters params);
...
#endif /* CV2X_MAC_STATS_CALCULATOR_H_ */
