...
#ifndef CV2X_LTE_RLC_AM_H
#define CV2X_LTE_RLC_AM_H
...
private:
   ...
   * method called when the T_status_prohibit timer expires
   * 
   * \param seqNumber cv2x_SequenceNumber10
   * \returns true is inside receivign window
   */
  bool IsInsideReceivingWindow (cv2x_SequenceNumber10 seqNumber);
// 
...
private:
  ...
  std::vector <RetxPdu> m_retxBuffer;  ///< Buffer for PDUs considered for retransmission
    ...
    struct PduBuffer
    {
      cv2x_SequenceNumber10  m_seqNumber; ///< sequence number
...
// 
   ...
   */
  // Transmitting side
  cv2x_SequenceNumber10 m_vtA;                   ///< VT(A)
  cv2x_SequenceNumber10 m_vtMs;                  ///< VT(MS)
  cv2x_SequenceNumber10 m_vtS;                   ///< VT(S)
  cv2x_SequenceNumber10 m_pollSn;                ///< POLL_SN

  // Receiving side
  cv2x_SequenceNumber10 m_vrR;                   ///< VR(R)
  cv2x_SequenceNumber10 m_vrMr;                  ///< VR(MR)
  cv2x_SequenceNumber10 m_vrX;                   ///< VR(X)
  cv2x_SequenceNumber10 m_vrMs;                  ///< VR(MS)
  cv2x_SequenceNumber10 m_vrH;                   ///< VR(H)
   ...
   */
  cv2x_SequenceNumber10 m_expectedSeqNumber;
