...
#ifndef CV2X_TDTBFQ_FF_MAC_SCHEDULER_H
#define CV2X_TDTBFQ_FF_MAC_SCHEDULER_H
...
class cv2x_TdTbfqFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_TdTbfqFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_TdTbfqFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_TdTbfqFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_TdTbfqFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_TdTbfqFfMacScheduler> class friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_TdTbfqFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, cv2x_tdtbfqsFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, cv2x_tdtbfqsFlowPerf_t> m_flowStatsUl;
  ...
  */
  ...
  cv2x_FfMacSchedSapUser* m_schedSapUser; ///< A=Sched SAP user
...
#endif /* CV2X_TDTBFQ_FF_MAC_SCHEDULER_H */
