...
NS_LOG_COMPONENT_DEFINE ("cv2x_PssFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (cv2x_PssFfMacScheduler);



cv2x_PssFfMacScheduler::cv2x_PssFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new cv2x_MemberCschedSapProvider<cv2x_PssFfMacScheduler> (this);
  m_schedSapProvider = new cv2x_MemberSchedSapProvider<cv2x_PssFfMacScheduler> (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new cv2x_MemberLteFfrSapUser<cv2x_PssFfMacScheduler> (this);
}
...
void
cv2x_PssFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
cv2x_PssFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::cv2x_PssFfMacScheduler")
    .SetParent<cv2x_FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<cv2x_PssFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&cv2x_PssFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("PssFdSchedulerType",
                   "FD scheduler in PSS (default value is PFsch)",
                   StringValue ("PFsch"),
                   MakeStringAccessor (&cv2x_PssFfMacScheduler::m_fdSchedulerType),
                   MakeStringChecker ())
    .AddAttribute ("nMux",
                   "The number of UE selected by TD scheduler (default value is 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&cv2x_PssFfMacScheduler::m_nMux),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&cv2x_PssFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&cv2x_PssFfMacScheduler::m_ulGrantMcs),
...
void
cv2x_PssFfMacScheduler::SetFfMacCschedSapUser (cv2x_FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
cv2x_PssFfMacScheduler::SetFfMacSchedSapUser (cv2x_FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

cv2x_FfMacCschedSapProvider*
cv2x_PssFfMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

cv2x_FfMacSchedSapProvider*
cv2x_PssFfMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
cv2x_PssFfMacScheduler::SetLteFfrSapProvider (cv2x_LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

cv2x_LteFfrSapUser*
cv2x_PssFfMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
cv2x_PssFfMacScheduler::DoCschedCellConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoCschedUeConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
cv2x_PssFfMacScheduler::DoCschedLcConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);

  std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          cv2x_pssFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, cv2x_pssFlowPerf_t> (params.m_rnti, flowStatsDl));
          cv2x_pssFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, cv2x_pssFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
...
void
cv2x_PssFfMacScheduler::DoCschedLcReleaseReq (const struct cv2x_FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoCschedUeReleaseReq (const struct cv2x_FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoSchedDlRlcBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
cv2x_PssFfMacScheduler::DoSchedDlPagingBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoSchedDlMacBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
cv2x_PssFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
unsigned int
cv2x_PssFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <cv2x_LteFlowId_t, cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
uint8_t
cv2x_PssFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
cv2x_PssFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
cv2x_PssFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoSchedDlTriggerReq (const struct cv2x_FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator it;
  std::map <uint16_t, cv2x_pssFlowPerf_t> tdUeSet; // the result of TD scheduler

  // schedulability check
  std::map <uint16_t, cv2x_pssFlowPerf_t> ueSet;
  for (it = m_flowStatsDl.begin (); it != m_flowStatsDl.end (); it++)
    {
      if( LcActivePerFlow ((*it).first) > 0 )
        {
          ueSet.insert(std::pair <uint16_t, cv2x_pssFlowPerf_t> ((*it).first, (*it).second));
        }
    }
          ...
          for (it = m_flowStatsDl.begin (); it != m_flowStatsDl.end (); it--)
           {
             ...
             for (itSet = ueSet1.begin (); itSet != ueSet1.end () && nMux != 0; itSet++)
               {  
                 std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator itUe;
                 itUe = m_flowStatsDl.find((*itSet).second);
                 tdUeSet.insert(std::pair<uint16_t, cv2x_pssFlowPerf_t> ( (*itUe).first, (*itUe).second ) );
                 nMux--;
               }
              ...
              for (int i = 0; i < rbgNum; i++)
                {
                  ...
                  std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator itMax = tdUeSet.end ();
  ...
  std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator itStats;
  ...
  for (itStats = m_flowStatsDl.begin (); itStats != m_flowStatsDl.end (); itStats++)
    { 
      std::map <uint16_t, cv2x_pssFlowPerf_t>::iterator itUeScheduleted = tdUeSet.end();
...
void
cv2x_PssFfMacScheduler::DoSchedDlRachInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoSchedDlCqiInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
cv2x_PssFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
cv2x_PssFfMacScheduler::DoSchedUlTriggerReq (const struct cv2x_FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
cv2x_PssFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct cv2x_FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
cv2x_PssFfMacScheduler::DoSchedUlSrInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
cv2x_PssFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_PssFfMacScheduler::DoSchedUlCqiInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case cv2x_UlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("cv2x_PssFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
cv2x_PssFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
cv2x_PssFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
cv2x_PssFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<cv2x_LteFlowId_t, cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
cv2x_PssFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
cv2x_PssFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
