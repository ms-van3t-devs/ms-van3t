...
#include "cv2x_lte-ffr-distributed-algorithm.h"
#include <ns3/log.h>

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("cv2x_LteFfrDistributedAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (cv2x_LteFfrDistributedAlgorithm);


cv2x_LteFfrDistributedAlgorithm::cv2x_LteFfrDistributedAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0)
{
  NS_LOG_FUNCTION (this);
  m_ffrSapProvider = new cv2x_MemberLteFfrSapProvider<cv2x_LteFfrDistributedAlgorithm> (this);
  m_ffrRrcSapProvider = new cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFfrDistributedAlgorithm> (this);
}
...
void
cv2x_LteFfrDistributedAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
cv2x_LteFfrDistributedAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::cv2x_LteFfrDistributedAlgorithm")
    .SetParent<cv2x_LteFfrAlgorithm> ()
    .SetGroupName("Lte")
    .AddConstructor<cv2x_LteFfrDistributedAlgorithm> ()
    .AddAttribute ("CalculationInterval",
                   "Time interval between calculation of Edge sub-band, Default value 1 second",
                   TimeValue (Seconds (1)),
                   MakeTimeAccessor (&cv2x_LteFfrDistributedAlgorithm::m_calculationInterval),
                   MakeTimeChecker ())
    .AddAttribute ("RsrqThreshold",
                   "If the RSRQ of is worse than this threshold, UE should be served in Edge sub-band",
                   UintegerValue (20),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_edgeSubBandRsrqThreshold),
    ...
    .AddAttribute ("RsrpDifferenceThreshold",
                   ...
                   UintegerValue (20),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_rsrpDifferenceThreshold),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("CenterPowerOffset",
                   "PdschConfigDedicated::Pa value for Edge Sub-band, default value dB0",
                   UintegerValue (5),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_centerPowerOffset),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgePowerOffset",
                   "PdschConfigDedicated::Pa value for Edge Sub-band, default value dB0",
                   UintegerValue (5),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_edgePowerOffset),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeRbNum",
                   "Number of RB that can be used in edge Sub-band",
                   UintegerValue (8),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_edgeRbNum),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFfrDistributedAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
...
void
cv2x_LteFfrDistributedAlgorithm::SetLteFfrSapUser (cv2x_LteFfrSapUser* s)
{
...
cv2x_LteFfrDistributedAlgorithm::GetLteFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::SetLteFfrRrcSapUser (cv2x_LteFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
cv2x_LteFfrDistributedAlgorithm::GetLteFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
  ...
  cv2x_LteRrcSap::ReportConfigEutra reportConfigA4;
  reportConfigA4.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A4;
  reportConfigA4.threshold1.choice = cv2x_LteRrcSap::ThresholdEutra::THRESHOLD_RSRP;
  reportConfigA4.threshold1.range = 0; // intentionally very low threshold
  reportConfigA4.triggerQuantity = cv2x_LteRrcSap::ReportConfigEutra::RSRP;
  reportConfigA4.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS120;
  ...
  m_calculationEvent = Simulator::ScheduleNow (&cv2x_LteFfrDistributedAlgorithm::Calculate, this);

}

void
cv2x_LteFfrDistributedAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
cv2x_LteFfrDistributedAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
}

void
cv2x_LteFfrDistributedAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
}

void
cv2x_LteFfrDistributedAlgorithm::InitializeDownlinkRbgMaps ()
{
  NS_LOG_FUNCTION (this);
  m_dlRbgMap.clear ();
  int rbgSize = GetRbgSize (m_dlBandwidth);
...
void
cv2x_LteFfrDistributedAlgorithm::InitializeUplinkRbgMaps ()
{
  NS_LOG_FUNCTION (this);
  m_ulRbgMap.clear ();
...
std::vector <bool>
cv2x_LteFfrDistributedAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFfrDistributedAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
cv2x_LteFfrDistributedAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFfrDistributedAlgorithm::DoIsUlRbgAvailableForUe (int rbId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::DoReportDlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::DoReportUlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
cv2x_LteFfrDistributedAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
cv2x_LteFfrDistributedAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
cv2x_LteFfrDistributedAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::DoReportUeMeas (uint16_t rnti,
  ...
  if (measResults.measId == m_rsrqMeasId)
  ...
  else if (measResults.measId == m_rsrpMeasId)
    {
      ...
      if (measResults.haveMeasResultNeighCells
        ...
        {
          for (std::list <cv2x_LteRrcSap::MeasResultEutra>::iterator it = measResults.measResultListEutra.begin ();
...
void
cv2x_LteFfrDistributedAlgorithm::Calculate ()
{
  NS_LOG_FUNCTION (this);
  m_calculationEvent = Simulator::Schedule (m_calculationInterval, &cv2x_LteFfrDistributedAlgorithm::Calculate, this);
...
void
cv2x_LteFfrDistributedAlgorithm::SendLoadInformation (uint16_t targetCellId)
{
  NS_LOG_FUNCTION (this);
  ...
  cv2x_EpcX2Sap::CellInformationItem cii;
...
void
cv2x_LteFfrDistributedAlgorithm::DoRecvLoadInformation (cv2x_EpcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrDistributedAlgorithm::UpdateNeighbourMeasurements (uint16_t rnti,
                                                         uint16_t cellId,
                                                         uint8_t rsrp,
                                                         uint8_t rsrq)
{
