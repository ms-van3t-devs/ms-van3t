...
#ifndef CV2X_LTE_RLC_UM_H
#define CV2X_LTE_RLC_UM_H
...
private:
   ...
   */
  bool IsInsideReorderingWindow (cv2x_SequenceNumber10 seqNumber);
   ...
   */
  void ReassembleSnInterval (cv2x_SequenceNumber10 lowSeqNumber, cv2x_SequenceNumber10 highSeqNumber);
...
private:
   ...
   */
  cv2x_SequenceNumber10 m_sequenceNumber; ///< VT(US)

  cv2x_SequenceNumber10 m_vrUr;           ///< VR(UR)
  cv2x_SequenceNumber10 m_vrUx;           ///< VR(UX)
  cv2x_SequenceNumber10 m_vrUh;           ///< VR(UH)
