...
#ifndef CV2X_TRACE_FADING_LOSS_MODEL_H
#define CV2X_TRACE_FADING_LOSS_MODEL_H
 ...
 */
class cv2x_TraceFadingLossModel : public SpectrumPropagationLossModel
{
public:
  cv2x_TraceFadingLossModel ();
  virtual ~cv2x_TraceFadingLossModel ();
...
#endif /* CV2X_TRACE_FADING_LOSS_MODEL_H */
