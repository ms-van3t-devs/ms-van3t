...
#ifndef CV2X_TDMT_FF_MAC_SCHEDULER_H
#define CV2X_TDMT_FF_MAC_SCHEDULER_H
...
class cv2x_TdMtFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_TdMtFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_TdMtFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_TdMtFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_TdMtFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_TdMtFfMacScheduler> class friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_TdMtFfMacScheduler>;
...
#endif /* CV2X_TDMT_FF_MAC_SCHEDULER_H */
