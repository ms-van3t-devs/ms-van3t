...
#include "cv2x_lte-fr-soft-algorithm.h"
#include <ns3/log.h>
#include "ns3/boolean.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("cv2x_LteFrSoftAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (cv2x_LteFrSoftAlgorithm);
...
cv2x_LteFrSoftAlgorithm::cv2x_LteFrSoftAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    ...
    m_measId (0)
{
  ...
  m_ffrSapProvider = new cv2x_MemberLteFfrSapProvider<cv2x_LteFrSoftAlgorithm> (this);
  m_ffrRrcSapProvider = new cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFrSoftAlgorithm> (this);
}
...
void
cv2x_LteFrSoftAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
cv2x_LteFrSoftAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::cv2x_LteFrSoftAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFrSoftAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFrSoftAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
cv2x_LteFrSoftAlgorithm::SetLteFfrSapUser (cv2x_LteFfrSapUser* s)
{
...
cv2x_LteFrSoftAlgorithm::GetLteFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::SetLteFfrRrcSapUser (cv2x_LteFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
cv2x_LteFrSoftAlgorithm::GetLteFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
cv2x_LteFrSoftAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
cv2x_LteFrSoftAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
cv2x_LteFrSoftAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFrSoftAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
cv2x_LteFrSoftAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFrSoftAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::DoReportDlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::DoReportUlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
cv2x_LteFrSoftAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
cv2x_LteFrSoftAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
cv2x_LteFrSoftAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrSoftAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
cv2x_LteFrSoftAlgorithm::DoRecvLoadInformation (cv2x_EpcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
