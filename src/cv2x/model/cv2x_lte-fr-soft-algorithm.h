...
#ifndef CV2X_LTE_FR_SOFT_ALGORITHM_H
#define CV2X_LTE_FR_SOFT_ALGORITHM_H
 ...
 */
class cv2x_LteFrSoftAlgorithm : public cv2x_LteFfrAlgorithm
{
public:
  /**
   * \brief Creates a trivial ffr algorithm instance.
   */
  cv2x_LteFrSoftAlgorithm ();

  virtual ~cv2x_LteFrSoftAlgorithm ();
  ...
  friend class cv2x_MemberLteFfrSapProvider<cv2x_LteFrSoftAlgorithm>;
  /// let the forwarder class access the protected and private members
  friend class cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFrSoftAlgorithm>;
...
}; // end of class cv2x_LteFrSoftAlgorithm


} // end of namespace ns3


#endif /* CV2X_LTE_FR_SOFT_ALGORITHM_H */
