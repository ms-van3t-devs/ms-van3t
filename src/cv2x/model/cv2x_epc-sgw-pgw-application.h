...
#ifndef CV2X_EPC_SGW_PGW_APPLICATION_H
#define CV2X_EPC_SGW_PGW_APPLICATION_H
 ...
 */
class cv2x_EpcSgwPgwApplication : public Application
{
  /// allow cv2x_MemberEpcS11SapSgw<cv2x_EpcSgwPgwApplication> class friend access
  friend class cv2x_MemberEpcS11SapSgw<cv2x_EpcSgwPgwApplication>;
...
public:
  ...
  cv2x_EpcSgwPgwApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket);

  /** 
   * Destructor
   */
  virtual ~cv2x_EpcSgwPgwApplication (void);
   ...
   */
  void SetS11SapMme (cv2x_EpcS11SapMme * s);

  /** 
   * 
   * \return the SGW side of the S11 SAP 
   */
  cv2x_EpcS11SapSgw* GetS11SapSgw ();
...
private:
   ...
   * \param msg cv2x_EpcS11SapSgw::CreateSessionRequestMessage
   */
  void DoCreateSessionRequest (cv2x_EpcS11SapSgw::CreateSessionRequestMessage msg);
  /**
   * Modify bearer request function
   * \param msg cv2x_EpcS11SapSgw::ModifyBearerRequestMessage
   */
  void DoModifyBearerRequest (cv2x_EpcS11SapSgw::ModifyBearerRequestMessage msg);  

  /**
   * Delete bearer command function
   * \param req cv2x_EpcS11SapSgw::DeleteBearerCommandMessage
   */
  void DoDeleteBearerCommand (cv2x_EpcS11SapSgw::DeleteBearerCommandMessage req);
  /**
   * Delete bearer response function
   * \param req cv2x_EpcS11SapSgw::DeleteBearerResponseMessage
   */
  void DoDeleteBearerResponse (cv2x_EpcS11SapSgw::DeleteBearerResponseMessage req);
...
public:
     ...
     */
    void AddBearer (Ptr<cv2x_EpcTft> tft, uint8_t epsBearerId, uint32_t teid);
  ...
  */
   ...
   * 
   */
  cv2x_EpcS11SapMme* m_s11SapMme;

  /**
   * SGW side of the S11 SAP
   * 
   */
  cv2x_EpcS11SapSgw* m_s11SapSgw;
...
#endif /* CV2X_EPC_SGW_PGW_APPLICATION_H */
