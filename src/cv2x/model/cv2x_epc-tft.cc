...
NS_LOG_COMPONENT_DEFINE ("cv2x_EpcTft");
 ...
 * \return ostream
 */
std::ostream& operator<< (std::ostream& os, cv2x_EpcTft::Direction& d)
{
  switch (d)
  {
    case cv2x_EpcTft::DOWNLINK:
      os << "DOWNLINK";
      break;
    case cv2x_EpcTft::UPLINK:
      os << "UPLINK";
      break;
    default:
      os << "BIDIRECTIONAL";
 ...
 * \return ostream
 */
std::ostream& operator<< (std::ostream& os, cv2x_EpcTft::PacketFilter& f)
{
...
cv2x_EpcTft::PacketFilter::PacketFilter ()
: precedence (255),
...
bool 
cv2x_EpcTft::PacketFilter::Matches (Direction d,
                               Ipv4Address ra,
                               Ipv4Address la,
                               uint16_t rp,
                               uint16_t lp,
...
cv2x_EpcTft::Default ()
{
  ...
  cv2x_EpcTft::PacketFilter defaultPacketFilter;
  tft->Add (defaultPacketFilter);
  return tft;
}


cv2x_EpcTft::cv2x_EpcTft ()
: m_numFilters (0)
{
  NS_LOG_FUNCTION (this);
}
...
uint8_t 
cv2x_EpcTft::Add (PacketFilter f)
{
...
bool 
cv2x_EpcTft::Matches (Direction direction,
