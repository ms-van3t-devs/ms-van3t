...
#ifndef CV2X_EPS_GTPU_V1_H
#define CV2X_EPS_GTPU_V1_H
 ...
 *
 */
class cv2x_GtpuHeader : public Header
{
public:
  /**
   ...
   * Equality operator.
   *
   * \param b cv2x_GtpuHeader object to compare
   * \returns true of equal
   */
  bool operator == (const cv2x_GtpuHeader& b) const;
