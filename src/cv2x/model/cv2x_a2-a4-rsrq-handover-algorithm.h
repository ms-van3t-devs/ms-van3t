...
#ifndef CV2X_A2_A4_RSRQ_HANDOVER_ALGORITHM_H
#define CV2X_A2_A4_RSRQ_HANDOVER_ALGORITHM_H
 ...
 *       cv2x_LteHelper::InstallEnbDevice does not have any effect to the devices
 *       that have already been installed.
 */
class cv2x_A2A4RsrqHandoverAlgorithm : public cv2x_LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  cv2x_A2A4RsrqHandoverAlgorithm ();

  virtual ~cv2x_A2A4RsrqHandoverAlgorithm ();
  ...
  // inherited from cv2x_LteHandoverAlgorithm
  virtual void SetLteHandoverManagementSapUser (cv2x_LteHandoverManagementSapUser* s);
  virtual cv2x_LteHandoverManagementSapProvider* GetLteHandoverManagementSapProvider ();

  /// let the forwarder class access the protected and private members
  friend class cv2x_MemberLteHandoverManagementSapProvider<cv2x_A2A4RsrqHandoverAlgorithm>;
...
protected:
  ...
  // inherited from cv2x_LteHandoverAlgorithm as a Handover Management SAP implementation
...
}; // end of class cv2x_A2A4RsrqHandoverAlgorithm


} // end of namespace ns3


#endif /* CV2X_A2_A4_RSRQ_HANDOVER_ALGORITHM_H */
