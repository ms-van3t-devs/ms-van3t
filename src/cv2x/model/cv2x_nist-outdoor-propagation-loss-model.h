...
#ifndef CV2X_NIST_OUTDOOR_PROPAGATION_LOSS_MODEL_H
#define CV2X_NIST_OUTDOOR_PROPAGATION_LOSS_MODEL_H
 ...
 * \ingroup nist
 *
 * \brief Outdoor propagation model for the 700 MHz frequency (Public Safety use cases)
 * 
 ...
 */
class cv2x_NistOutdoorPropagationLossModel : public PropagationLossModel
{
...
public:
  ...
  cv2x_NistOutdoorPropagationLossModel ();
  virtual ~cv2x_NistOutdoorPropagationLossModel ();
...
#endif // CV2X_NIST_OUTDOOR_PROPAGATION_LOSS_MODEL_H
