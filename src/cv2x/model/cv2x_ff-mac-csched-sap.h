...
#ifndef CV2X_FF_MAC_CSCHED_SAP_H
#define CV2X_FF_MAC_CSCHED_SAP_H
...
{
public:
  virtual ~cv2x_FfMacCschedSapProvider ();
  ...
  struct CschedCellConfigReqParameters
  {
    ...
    struct cv2x_SiConfiguration_s m_siConfiguration; ///< SI configuration
  ...
  struct CschedUeConfigReqParameters
  {
    ...
    struct cv2x_DrxConfig_s m_drxConfig; ///< drx config
    ...
    struct cv2x_SpsConfig_s m_spsConfig; ///< SPS config
    bool      m_srConfigPresent; ///< SR config present
    struct cv2x_SrConfig_s m_srConfig; ///< SR config
    bool      m_cqiConfigPresent; ///< CQI config present
    struct cv2x_CqiConfig_s m_cqiConfig; ///< CQI config
    ...
    struct cv2x_UeCapabilities_s m_ueCapabilities; ///< UE capabilities
  ...
  struct CschedLcConfigReqParameters
  {
    ...
    std::vector <struct cv2x_LogicalChannelConfigListElement_s> m_logicalChannelConfigList; ///< logicalChannelConfigList
...
/**
 * cv2x_FfMacCschedSapUser class
 */
class cv2x_FfMacCschedSapUser
{
public:
  virtual ~cv2x_FfMacCschedSapUser ();
...
/// cv2x_MemberCschedSapProvider class
template <class C>
class cv2x_MemberCschedSapProvider : public cv2x_FfMacCschedSapProvider
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_MemberCschedSapProvider (C* scheduler);
...
private:
  cv2x_MemberCschedSapProvider ();
  C* m_scheduler; ///< scheduler class
};

template <class C>
cv2x_MemberCschedSapProvider<C>::cv2x_MemberCschedSapProvider ()
{
}

template <class C>
cv2x_MemberCschedSapProvider<C>::cv2x_MemberCschedSapProvider (C* scheduler) : m_scheduler (scheduler)
{
}

template <class C>
void
cv2x_MemberCschedSapProvider<C>::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
...
template <class C>
void
cv2x_MemberCschedSapProvider<C>::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
template <class C>
void
cv2x_MemberCschedSapProvider<C>::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
...
template <class C>
void
cv2x_MemberCschedSapProvider<C>::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
...
template <class C>
void
cv2x_MemberCschedSapProvider<C>::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
#endif /* CV2X_FF_MAC_CSCHED_SAP_H */
