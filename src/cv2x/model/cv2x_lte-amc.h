...
#ifndef CV2X_AMCMODULE_H
#define CV2X_AMCMODULE_H
 ...
 */
class cv2x_LteAmc : public Object
{
  ...
  enum AmcModel
    {
      ...
      PiroEW2010,
      /**
       * An AMC model based on 10% of BER according to cv2x_LteMiErrorModel.
       */
      MiErrorModel,
      /**
       * An AMC model based on 10% of BER according to cv2x_LtePhyErrorModel
       */
      NistErrorModel
    };
...
}; // end of `class cv2x_LteAmc`


}

#endif /* CV2X_AMCMODULE_H */
