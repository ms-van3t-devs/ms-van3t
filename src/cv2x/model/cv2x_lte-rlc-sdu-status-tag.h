...
#ifndef CV2X_LTE_RLC_SDU_STATUS_TAG_H
#define CV2X_LTE_RLC_SDU_STATUS_TAG_H
 ...
 * Status of RLC SDU
 */
class cv2x_LteRlcSduStatusTag : public Tag
{
public:
  cv2x_LteRlcSduStatusTag ();
...
#endif // CV2X_LTE_RLC_SDU_STATUS_TAG_H
