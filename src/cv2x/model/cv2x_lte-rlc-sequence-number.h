...
#ifndef CV2X_LTE_RLC_SEQUENCE_NUMBER_H
#define CV2X_LTE_RLC_SEQUENCE_NUMBER_H
...
/// cv2x_SequenceNumber10 class
class cv2x_SequenceNumber10
{
public:
   ...
   */
  explicit cv2x_SequenceNumber10 (uint16_t value)
    : m_value (value % 1024),
      m_modulusBase (0)
  {}
   ...
   * \param value the value
   */
  cv2x_SequenceNumber10 (cv2x_SequenceNumber10 const &value)
   ...
   * 
   * \param value the value
   * \returns cv2x_SequenceNumber10
   */
  cv2x_SequenceNumber10& operator= (uint16_t value)
  {
    m_value = value % 1024;
    return *this;
  }
   ...
   */
  void SetModulusBase (cv2x_SequenceNumber10 modulusBase)
  {
   ...
   * \returns cv2x_SequenceNumber10
   */
  cv2x_SequenceNumber10 operator++ (int)
  {
    cv2x_SequenceNumber10 retval (m_value);
   ...
   * \returns cv2x_SequenceNumber10
   */
  cv2x_SequenceNumber10 operator + (uint16_t delta) const
  {
    cv2x_SequenceNumber10 ret ((m_value + delta) % 1024);
   ...
   * \returns cv2x_SequenceNumber10
   */
  uint16_t operator - (const cv2x_SequenceNumber10 &other) const
  {
   ...
   */
  bool operator > (const cv2x_SequenceNumber10 &other) const
  {
  ...
  friend std::ostream & operator<< (std::ostream& os, const cv2x_SequenceNumber10 &val);
...
#endif // CV2X_LTE_RLC_SEQUENCE_NUMBER_H
