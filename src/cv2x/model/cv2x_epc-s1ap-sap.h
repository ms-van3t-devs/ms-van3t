...
#ifndef CV2X_EPC_S1AP_SAP_H
#define CV2X_EPC_S1AP_SAP_H
 ...
 */
class cv2x_EpcS1apSap
{
public:
  virtual ~cv2x_EpcS1apSap ();
 ...
 */
class cv2x_EpcS1apSapMme : public cv2x_EpcS1apSap
{
public:
 ...
 */
class cv2x_EpcS1apSapEnb : public cv2x_EpcS1apSap
{
public:
  ...
  struct ErabToBeSetupItem
  {
    ...
    cv2x_EpsBearer   erabLevelQosParameters; ///< Level QOS parameters
...
/**
 * Template for the implementation of the cv2x_EpcS1apSapMme as a member
 * of an owner class of type C to which all methods are forwarded
 * 
 */
template <class C>
class cv2x_MemberEpcS1apSapMme : public cv2x_EpcS1apSapMme
{
public:
/**
 * Constructor
 ...
 */
  cv2x_MemberEpcS1apSapMme (C* owner);

  // inherited from cv2x_EpcS1apSapMme
  /**
...
private:
  cv2x_MemberEpcS1apSapMme ();
  C* m_owner; ///< owner class
};

template <class C>
cv2x_MemberEpcS1apSapMme<C>::cv2x_MemberEpcS1apSapMme (C* owner)
  : m_owner (owner)
{
}

template <class C>
cv2x_MemberEpcS1apSapMme<C>::cv2x_MemberEpcS1apSapMme ()
{
}

template <class C>
void cv2x_MemberEpcS1apSapMme<C>::InitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t imsi, uint16_t ecgi)
{
  m_owner->DoInitialUeMessage (mmeUeS1Id, enbUeS1Id, imsi, ecgi);
}

template <class C>
void cv2x_MemberEpcS1apSapMme<C>::ErabReleaseIndication (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeReleasedIndication> erabToBeReleaseIndication)
{
  m_owner->DoErabReleaseIndication (mmeUeS1Id, enbUeS1Id, erabToBeReleaseIndication);
}

template <class C>
void cv2x_MemberEpcS1apSapMme<C>::InitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabSetupItem> erabSetupList)
{
  m_owner->DoInitialContextSetupResponse (mmeUeS1Id, enbUeS1Id, erabSetupList);
}

template <class C>
void cv2x_MemberEpcS1apSapMme<C>::PathSwitchRequest (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi, std::list<ErabSwitchedInDownlinkItem> erabToBeSwitchedInDownlinkList)
{
...
/**
 * Template for the implementation of the cv2x_EpcS1apSapEnb as a member
 * of an owner class of type C to which all methods are forwarded
 * 
 */
template <class C>
class cv2x_MemberEpcS1apSapEnb : public cv2x_EpcS1apSapEnb
{
public:
/**
 * Constructor
 ...
 * \param owner the owner class
 */
  cv2x_MemberEpcS1apSapEnb (C* owner);

  // inherited from cv2x_EpcS1apSapEnb
  /**
...
private:
  cv2x_MemberEpcS1apSapEnb ();
  C* m_owner; ///< owner class
};

template <class C>
cv2x_MemberEpcS1apSapEnb<C>::cv2x_MemberEpcS1apSapEnb (C* owner)
  : m_owner (owner)
{
}

template <class C>
cv2x_MemberEpcS1apSapEnb<C>::cv2x_MemberEpcS1apSapEnb ()
{
}

template <class C>
void cv2x_MemberEpcS1apSapEnb<C>::InitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList)
{
  m_owner->DoInitialContextSetupRequest (mmeUeS1Id, enbUeS1Id, erabToBeSetupList);
}

template <class C>
void cv2x_MemberEpcS1apSapEnb<C>::PathSwitchRequestAcknowledge (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi, std::list<ErabSwitchedInUplinkItem> erabToBeSwitchedInUplinkList)
{
