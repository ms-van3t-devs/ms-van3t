...
#ifndef CV2X_EPC_X2_SAP_H
#define CV2X_EPC_X2_SAP_H
...
/**
 * \brief Common structures for cv2x_EpcX2SapProvider and cv2x_EpcX2SapUser
 */
class cv2x_EpcX2Sap
{
public:
  virtual ~cv2x_EpcX2Sap ();
  ...
  struct ErabToBeSetupItem
  {
    ...
    cv2x_EpsBearer   erabLevelQosParameters; ///< E-RAB level QOS parameters
 ...
 */
class cv2x_EpcX2SapProvider : public cv2x_EpcX2Sap
{
public:
  virtual ~cv2x_EpcX2SapProvider ();
 ...
 */
class cv2x_EpcX2SapUser : public cv2x_EpcX2Sap
{
public:
  virtual ~cv2x_EpcX2SapUser ();
...
/**
 * cv2x_EpcX2SpecificEpcX2SapProvider
 */
template <class C>
class cv2x_EpcX2SpecificEpcX2SapProvider : public cv2x_EpcX2SapProvider
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_EpcX2SpecificEpcX2SapProvider (C* x2);

  //
  // Interface implemented from cv2x_EpcX2SapProvider
  //
...
template <class C>
cv2x_EpcX2SpecificEpcX2SapProvider<C>::cv2x_EpcX2SpecificEpcX2SapProvider (C* x2)
  : m_x2 (x2)
{
}

template <class C>
cv2x_EpcX2SpecificEpcX2SapProvider<C>::cv2x_EpcX2SpecificEpcX2SapProvider ()
{
}

template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendHandoverRequest (HandoverRequestParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendHandoverRequestAck (HandoverRequestAckParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendHandoverPreparationFailure (HandoverPreparationFailureParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendSnStatusTransfer (SnStatusTransferParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendUeContextRelease (UeContextReleaseParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendLoadInformation (LoadInformationParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendResourceStatusUpdate (ResourceStatusUpdateParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapProvider<C>::SendUeData (UeDataParams params)
{
  m_x2->DoSendUeData (params);
}

/**
 * cv2x_EpcX2SpecificEpcX2SapUser
 */
template <class C>
class cv2x_EpcX2SpecificEpcX2SapUser : public cv2x_EpcX2SapUser
{
public:
  /**
   * Constructor
   ...
   * \param rrc RRC
   */
  cv2x_EpcX2SpecificEpcX2SapUser (C* rrc);

  //
  // Interface implemented from cv2x_EpcX2SapUser
  //
...
template <class C>
cv2x_EpcX2SpecificEpcX2SapUser<C>::cv2x_EpcX2SpecificEpcX2SapUser (C* rrc)
  : m_rrc (rrc)
{
}

template <class C>
cv2x_EpcX2SpecificEpcX2SapUser<C>::cv2x_EpcX2SpecificEpcX2SapUser ()
{
}

template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvHandoverRequest (HandoverRequestParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvHandoverRequestAck (HandoverRequestAckParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvHandoverPreparationFailure (HandoverPreparationFailureParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvSnStatusTransfer (SnStatusTransferParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvUeContextRelease (UeContextReleaseParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvLoadInformation (LoadInformationParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvResourceStatusUpdate (ResourceStatusUpdateParams params)
{
...
template <class C>
void
cv2x_EpcX2SpecificEpcX2SapUser<C>::RecvUeData (UeDataParams params)
{
