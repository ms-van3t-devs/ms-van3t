...
#ifndef CV2X_LTE_FFR_DISTRIBUTED_ALGORITHM_H
#define CV2X_LTE_FFR_DISTRIBUTED_ALGORITHM_H
 ...
 */
class cv2x_LteFfrDistributedAlgorithm : public cv2x_LteFfrAlgorithm
{
public:
  cv2x_LteFfrDistributedAlgorithm ();
  virtual ~cv2x_LteFfrDistributedAlgorithm ();
  ...
  friend class cv2x_MemberLteFfrSapProvider<cv2x_LteFfrDistributedAlgorithm>;
  /// let the forwarder class access the protected and private members
  friend class cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFfrDistributedAlgorithm>;
...
}; // end of class cv2x_LteFfrDistributedAlgorithm
