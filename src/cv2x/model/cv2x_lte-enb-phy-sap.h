...
#ifndef CV2X_LTE_ENB_PHY_SAP_H
#define CV2X_LTE_ENB_PHY_SAP_H
 ...
 */
class cv2x_LteEnbPhySapProvider
{
public:
  virtual ~cv2x_LteEnbPhySapProvider ();
 ...
 */
class cv2x_LteEnbPhySapUser
{
public:
  virtual ~cv2x_LteEnbPhySapUser ();
   ...
   */
  virtual void UlCqiReport (cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters ulcqi) = 0;
   ...
   * \param params
   */
  virtual void UlInfoListElementHarqFeeback (cv2x_UlInfoListElement_s params) = 0;
   ...
   * \param params
   */
  virtual void DlInfoListElementHarqFeeback (cv2x_DlInfoListElement_s params) = 0;
