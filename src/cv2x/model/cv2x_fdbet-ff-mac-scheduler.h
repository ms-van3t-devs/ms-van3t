...
#ifndef CV2X_FDBET_FF_MAC_SCHEDULER_H
#define CV2X_FDBET_FF_MAC_SCHEDULER_H
...
/// cv2x_fdbetsFlowPerf_t structure
struct cv2x_fdbetsFlowPerf_t
{
...
class cv2x_FdBetFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_FdBetFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_FdBetFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_FdBetFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_FdBetFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_FdBetFfMacScheduler> class friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_FdBetFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, cv2x_fdbetsFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, cv2x_fdbetsFlowPerf_t> m_flowStatsUl;
  ...
  */
  ...
  std::map <uint16_t, cv2x_DlHarqRlcPduListBuffer_t> m_dlHarqProcessesRlcPduListBuffer; ///< DL HARQ process RLC PDU List
...
#endif /* CV2X_FDBET_FF_MAC_SCHEDULER_H */
