...
#ifndef CV2X_EPC_S11_SAP_H
#define CV2X_EPC_S11_SAP_H
 ...
 * cv2x_EpcS11Sap
 */
class cv2x_EpcS11Sap
{
public:

  virtual ~cv2x_EpcS11Sap ();
 ...
 */
class cv2x_EpcS11SapMme : public cv2x_EpcS11Sap
{
public:
 ...
 /**
  ...
  struct BearerContextCreated
  {
    ...
    cv2x_EpcS11Sap::Fteid sgwFteid; ///< EPC FTEID
    uint8_t epsBearerId; ///< EPS bearer ID
    cv2x_EpsBearer bearerLevelQos; ///< EPS bearer
 ...
 */
class cv2x_EpcS11SapSgw : public cv2x_EpcS11Sap
{
public:
  ...
  {    
    cv2x_EpcS11Sap::Fteid sgwFteid; ///< FTEID
    uint8_t epsBearerId; ///< EPS bearer ID
    cv2x_EpsBearer bearerLevelQos; ///< bearer QOS level
    Ptr<cv2x_EpcTft> tft; ///< traffic flow template
  };
...
/**
 * Template for the implementation of the cv2x_EpcS11SapMme as a member
 * of an owner class of type C to which all methods are forwarded
 * 
 */
template <class C>
class cv2x_MemberEpcS11SapMme : public cv2x_EpcS11SapMme
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_MemberEpcS11SapMme (C* owner);

  // inherited from cv2x_EpcS11SapMme
 ...
 */
template <class C>
cv2x_MemberEpcS11SapMme<C>::cv2x_MemberEpcS11SapMme (C* owner)
  : m_owner (owner)
{
}

template <class C>
cv2x_MemberEpcS11SapMme<C>::cv2x_MemberEpcS11SapMme ()
{
}

template <class C>
void cv2x_MemberEpcS11SapMme<C>::CreateSessionResponse (CreateSessionResponseMessage msg)
{
  m_owner->DoCreateSessionResponse (msg);
}

template <class C>
void cv2x_MemberEpcS11SapMme<C>::DeleteBearerRequest (DeleteBearerRequestMessage msg)
{
  m_owner->DoDeleteBearerRequest (msg);
}

template <class C>
void cv2x_MemberEpcS11SapMme<C>::ModifyBearerResponse (ModifyBearerResponseMessage msg)
{
...
/**
 * Template for the implementation of the cv2x_EpcS11SapSgw as a member
 * of an owner class of type C to which all methods are forwarded
 * 
 */
template <class C>
class cv2x_MemberEpcS11SapSgw : public cv2x_EpcS11SapSgw
{
public:
/**
 * Constructor
 ...
 * \param owner the owner class
 */
  cv2x_MemberEpcS11SapSgw (C* owner);

  // inherited from cv2x_EpcS11SapSgw
 ...
 */
template <class C>
cv2x_MemberEpcS11SapSgw<C>::cv2x_MemberEpcS11SapSgw (C* owner)
  : m_owner (owner)
{
}

template <class C>
cv2x_MemberEpcS11SapSgw<C>::cv2x_MemberEpcS11SapSgw ()
{
}

template <class C>
void cv2x_MemberEpcS11SapSgw<C>::CreateSessionRequest (CreateSessionRequestMessage msg)
{
  m_owner->DoCreateSessionRequest (msg);
}

template <class C>
void cv2x_MemberEpcS11SapSgw<C>::ModifyBearerRequest (ModifyBearerRequestMessage msg)
{
  m_owner->DoModifyBearerRequest (msg);
}

template <class C>
void cv2x_MemberEpcS11SapSgw<C>::DeleteBearerCommand (DeleteBearerCommandMessage msg)
{
  m_owner->DoDeleteBearerCommand (msg);
}

template <class C>
void cv2x_MemberEpcS11SapSgw<C>::DeleteBearerResponse (DeleteBearerResponseMessage msg)
{
