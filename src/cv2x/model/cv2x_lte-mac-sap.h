...
#ifndef CV2X_LTE_MAC_SAP_H
#define CV2X_LTE_MAC_SAP_H
...
{
public:
  virtual ~cv2x_LteMacSapProvider ();

  /**
   * Parameters for cv2x_LteMacSapProvider::TransmitPdu
   *
   */
   ...
   * called as a response to cv2x_LteMacSapUser::NotifyTxOpportunity
   *
  ...
  /**
   * Parameters for cv2x_LteMacSapProvider::ReportBufferStatus
   */
...
/// cv2x_EnbMacMemberLteMacSapProvider class
template <class C>
class cv2x_EnbMacMemberLteMacSapProvider : public cv2x_LteMacSapProvider
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_EnbMacMemberLteMacSapProvider (C* mac);
...
template <class C>
cv2x_EnbMacMemberLteMacSapProvider<C>::cv2x_EnbMacMemberLteMacSapProvider (C* mac)
  : m_mac (mac)
{
}

template <class C>
void cv2x_EnbMacMemberLteMacSapProvider<C>::TransmitPdu (TransmitPduParameters params)
{
  m_mac->DoTransmitPdu (params);
}

template <class C>
void cv2x_EnbMacMemberLteMacSapProvider<C>::ReportBufferStatus (ReportBufferStatusParameters params)
{
