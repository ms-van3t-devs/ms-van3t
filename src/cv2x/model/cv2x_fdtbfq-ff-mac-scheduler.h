...
#ifndef CV2X_FDTBFQ_FF_MAC_SCHEDULER_H
#define CV2X_FDTBFQ_FF_MAC_SCHEDULER_H
...
class cv2x_FdTbfqFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_FdTbfqFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_FdTbfqFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_FdTbfqFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_FdTbfqFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_FdTbfqFfMacScheduler> claass friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_FdTbfqFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, cv2x_fdtbfqsFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, cv2x_fdtbfqsFlowPerf_t> m_flowStatsUl;
...
#endif /* CV2X_FDTBFQ_FF_MAC_SCHEDULER_H */
