...
NS_LOG_COMPONENT_DEFINE ("cv2x_RrcHeader");


//////////////////// cv2x_RrcAsn1Header class ///////////////////////////////
cv2x_RrcAsn1Header::cv2x_RrcAsn1Header ()
{
}

TypeId
cv2x_RrcAsn1Header::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::cv2x_RrcAsn1Header")
    .SetParent<Header> ()
    .SetGroupName("Lte")
  ;
  return tid;
...
TypeId
cv2x_RrcAsn1Header::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

int
cv2x_RrcAsn1Header::GetMessageType ()
{
  return m_messageType;
}

int
cv2x_RrcAsn1Header::BandwidthToEnum (uint8_t bandwidth) const
{
  int n;
  switch (bandwidth)
    {
...
uint8_t
cv2x_RrcAsn1Header::EnumToBandwidth (int n) const
{
  uint8_t bw;
  switch (n)
    {
...
void
cv2x_RrcAsn1Header::SerializeDrbToAddModList (std::list<cv2x_LteRrcSap::DrbToAddMod> drbToAddModList) const
{
  ...
  std::list<cv2x_LteRrcSap::DrbToAddMod>::iterator it = drbToAddModList.begin ();
  for (; it != drbToAddModList.end (); it++)
    {
      ...
      switch (it->rlcConfig.choice)
        ...
        case cv2x_LteRrcSap::RlcConfig::UM_UNI_DIRECTIONAL_UL:
          // Serialize rlc-Config choice
        ...
        case cv2x_LteRrcSap::RlcConfig::UM_UNI_DIRECTIONAL_DL:
          // Serialize rlc-Config choice
...
void
cv2x_RrcAsn1Header::SerializeSrbToAddModList (std::list<cv2x_LteRrcSap::SrbToAddMod> srbToAddModList) const
{
  // Serialize SRB-ToAddModList ::= SEQUENCE (SIZE (1..2)) OF SRB-ToAddMod
  SerializeSequenceOf (srbToAddModList.size (),2,1);

  // Serialize the elements in the sequence-of list
  std::list<cv2x_LteRrcSap::SrbToAddMod>::iterator it = srbToAddModList.begin ();
...
void
cv2x_RrcAsn1Header::SerializeLogicalChannelConfig (cv2x_LteRrcSap::LogicalChannelConfig logicalChannelConfig) const
{
...
void
cv2x_RrcAsn1Header::SerializePhysicalConfigDedicated (cv2x_LteRrcSap::PhysicalConfigDedicated physicalConfigDedicated) const
{
  ...
  if (physicalConfigDedicated.haveSoundingRsUlConfigDedicated)
    {
      ...
      switch (physicalConfigDedicated.soundingRsUlConfigDedicated.type)
        {
        case cv2x_LteRrcSap::SoundingRsUlConfigDedicated::RESET:
          SerializeChoice (2,0,false);
          SerializeNull ();
          break;

        case cv2x_LteRrcSap::SoundingRsUlConfigDedicated::SETUP:
        default:
...
void
cv2x_RrcAsn1Header::SerializeRadioResourceConfigDedicated (cv2x_LteRrcSap::RadioResourceConfigDedicated radioResourceConfigDedicated) const
{
...
void
cv2x_RrcAsn1Header::SerializeSystemInformationBlockType1 (cv2x_LteRrcSap::SystemInformationBlockType1 systemInformationBlockType1) const
{
...
void
cv2x_RrcAsn1Header::SerializeRadioResourceConfigCommon (cv2x_LteRrcSap::RadioResourceConfigCommon radioResourceConfigCommon) const
{
...
void
cv2x_RrcAsn1Header::SerializeRadioResourceConfigCommonSib (cv2x_LteRrcSap::RadioResourceConfigCommonSib radioResourceConfigCommonSib) const
{
...
void
cv2x_RrcAsn1Header::SerializeSystemInformationBlockType2 (cv2x_LteRrcSap::SystemInformationBlockType2 systemInformationBlockType2) const
{
...
void
cv2x_RrcAsn1Header::SerializeMeasResults (cv2x_LteRrcSap::MeasResults measResults) const
{
  ...
  if (measResults.haveMeasResultNeighCells)
    {
      ...
      std::list<cv2x_LteRrcSap::MeasResultEutra>::iterator it;
    ...
    if (measResults.haveScellsMeas)
      {
        ...
        std::list<cv2x_LteRrcSap::MeasResultScell>::iterator it;
...
void
cv2x_RrcAsn1Header::SerializePlmnIdentity (uint32_t plmnId) const
{
...
void 
cv2x_RrcAsn1Header::SerializeRachConfigCommon (cv2x_LteRrcSap::RachConfigCommon rachConfigCommon) const
{
  // rach-ConfigCommon
  SerializeSequence (std::bitset<0> (0),true);
...
void
cv2x_RrcAsn1Header::SerializeQoffsetRange (int8_t qOffsetRange) const
{
  switch (qOffsetRange)
    {
    case -24:
...
void
cv2x_RrcAsn1Header::SerializeThresholdEutra (cv2x_LteRrcSap::ThresholdEutra thresholdEutra) const
{
  switch (thresholdEutra.choice)
    {
    case cv2x_LteRrcSap::ThresholdEutra::THRESHOLD_RSRP:
      SerializeChoice (2,0,false);
      SerializeInteger (thresholdEutra.range, 0, 97);
      break;
    case cv2x_LteRrcSap::ThresholdEutra::THRESHOLD_RSRQ:
    default:
      SerializeChoice (2,1,false);
...
void
cv2x_RrcAsn1Header::SerializeMeasConfig (cv2x_LteRrcSap::MeasConfig measConfig) const
{
  ...
  if (!measConfig.measObjectToAddModList.empty ())
    {
      ...
      for (std::list<cv2x_LteRrcSap::MeasObjectToAddMod>::iterator it = measConfig.measObjectToAddModList.begin (); it != measConfig.measObjectToAddModList.end (); it++)
        {
          SerializeSequence (std::bitset<0> (), false);
          ...
          if (!it->measObjectEutra.cellsToAddModList.empty ())
            {
              ...
              for (std::list<cv2x_LteRrcSap::CellsToAddMod>::iterator it2 = it->measObjectEutra.cellsToAddModList.begin (); it2 != it->measObjectEutra.cellsToAddModList.end (); it2++)
                {
                  SerializeSequence (std::bitset<0> (), false);
          ...
          if (!it->measObjectEutra.blackCellsToAddModList.empty () )
            {
              ...
              for (std::list<cv2x_LteRrcSap::BlackCellsToAddMod>::iterator it2 = it->measObjectEutra.blackCellsToAddModList.begin (); it2 != it->measObjectEutra.blackCellsToAddModList.end (); it2++)
                {
                  SerializeSequence (std::bitset<0> (),false);
                  SerializeInteger (it2->cellIndex, 1, MAX_CELL_MEAS);
  ...
  if (!measConfig.reportConfigToAddModList.empty () )
    {
      ...
      for (std::list<cv2x_LteRrcSap::ReportConfigToAddMod>::iterator it = measConfig.reportConfigToAddModList.begin (); it != measConfig.reportConfigToAddModList.end (); it++)
        {
          SerializeSequence (std::bitset<0> (), false);
          ...
          switch (it->reportConfigEutra.triggerType)
            {
            case cv2x_LteRrcSap::ReportConfigEutra::PERIODICAL:
              SerializeChoice (2, 1, false); 
              SerializeSequence (std::bitset<0> (),false);
              switch (it->reportConfigEutra.purpose)
                {
                case cv2x_LteRrcSap::ReportConfigEutra::REPORT_CGI:
                  SerializeEnum (2,1);
                  break;
                case cv2x_LteRrcSap::ReportConfigEutra::REPORT_STRONGEST_CELLS:
                default:
                  SerializeEnum (2,0);
                }
              break;
            case cv2x_LteRrcSap::ReportConfigEutra::EVENT:
            default: 
              SerializeChoice (2, 0, false);
              SerializeSequence (std::bitset<0> (),false);
          ...
          if (it->reportConfigEutra.triggerQuantity == cv2x_LteRrcSap::ReportConfigEutra::RSRP)
            {
              SerializeEnum (2, 0);
            }
          else
          ...
          if (it->reportConfigEutra.reportQuantity == cv2x_LteRrcSap::ReportConfigEutra::SAME_AS_TRIGGER_QUANTITY)
            {
              SerializeEnum (2, 0);
            }
          else
          ...
          switch (it->reportConfigEutra.reportInterval)
            ...
            case cv2x_LteRrcSap::ReportConfigEutra::MIN60:
              SerializeEnum (16, 12);
              break;
            case cv2x_LteRrcSap::ReportConfigEutra::SPARE3:
              SerializeEnum (16, 13);
              break;
            case cv2x_LteRrcSap::ReportConfigEutra::SPARE2:
              SerializeEnum (16, 14);
              break;
            case cv2x_LteRrcSap::ReportConfigEutra::SPARE1:
            default:
              SerializeEnum (16, 15);
            }
  ...
  if (!measConfig.measIdToAddModList.empty () )
    {
      ...
      for (std::list<cv2x_LteRrcSap::MeasIdToAddMod>::iterator it = measConfig.measIdToAddModList.begin (); it != measConfig.measIdToAddModList.end (); it++)
        {
  ...
  if (measConfig.haveMeasGapConfig )
    {
      switch (measConfig.measGapConfig.type)
        {
        case cv2x_LteRrcSap::MeasGapConfig::RESET:
          SerializeChoice (2, 0, false);
          SerializeNull ();
          break;
        case cv2x_LteRrcSap::MeasGapConfig::SETUP:
        default:
          SerializeChoice (2, 1, false);
          SerializeSequence (std::bitset<0> (),false);
          switch (measConfig.measGapConfig.gapOffsetChoice)
            {
            case cv2x_LteRrcSap::MeasGapConfig::GP0:
              SerializeChoice (2, 0, true);
              SerializeInteger (measConfig.measGapConfig.gapOffsetValue, 0, 39);
              break;
            case cv2x_LteRrcSap::MeasGapConfig::GP1:
            default:
  ...
  if (measConfig.haveSpeedStatePars )
    {
      switch (measConfig.speedStatePars.type)
        {
        case cv2x_LteRrcSap::SpeedStatePars::RESET:
          SerializeChoice (2, 0, false);
          SerializeNull ();
          break;
        case cv2x_LteRrcSap::SpeedStatePars::SETUP:
        default:
          SerializeChoice (2, 1, false);
          SerializeSequence (std::bitset<0> (), false);
  ...
  void
  cv2x_RrcAsn1Header::SerializeNonCriticalExtensionConfiguration (cv2x_LteRrcSap::NonCriticalExtensionConfiguration nonCriticalExtension) const
  {
    ...
    if (!nonCriticalExtension.sCellsToAddModList.empty ())
      {
        ...
        for (std::list<cv2x_LteRrcSap::SCellToAddMod>::iterator it = nonCriticalExtension.sCellsToAddModList.begin (); it != nonCriticalExtension.sCellsToAddModList.end (); it++)
          {
  ...
  void
  cv2x_RrcAsn1Header::SerializeRadioResourceConfigCommonSCell (cv2x_LteRrcSap::RadioResourceConfigCommonSCell rrccsc) const
  {
  ...
  void
  cv2x_RrcAsn1Header::SerializeRadioResourceDedicatedSCell (cv2x_LteRrcSap::RadioResourceConfigDedicatedSCell rrcdsc) const
  {
    //Serialize RadioResourceConfigDedicatedSCell
    ...
    cv2x_LteRrcSap::PhysicalConfigDedicatedSCell pcdsc = rrcdsc.physicalConfigDedicatedSCell;
    SerializePhysicalConfigDedicatedSCell (pcdsc);
  }
  
  void
  cv2x_RrcAsn1Header::SerializePhysicalConfigDedicatedSCell (cv2x_LteRrcSap::PhysicalConfigDedicatedSCell pcdsc) const
  {
...
void
cv2x_RrcAsn1Header::SerializeSidelinkUeInformation (cv2x_LteRrcSap::SidelinkUeInformation slUeInfo) const
{
}

Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeThresholdEutra (cv2x_LteRrcSap::ThresholdEutra * thresholdEutra, Buffer::Iterator bIterator)
{
  ...
  switch (thresholdEutraChoice)
    {
    case 0:
      thresholdEutra->choice = cv2x_LteRrcSap::ThresholdEutra::THRESHOLD_RSRP;
      bIterator = DeserializeInteger (&range, 0, 97, bIterator);
      thresholdEutra->range = range;
      break;
    case 1:
    default:
      thresholdEutra->choice = cv2x_LteRrcSap::ThresholdEutra::THRESHOLD_RSRQ;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeQoffsetRange (int8_t * qOffsetRange, Buffer::Iterator bIterator)
{
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeRadioResourceConfigDedicated (cv2x_LteRrcSap::RadioResourceConfigDedicated *radioResourceConfigDedicated, Buffer::Iterator bIterator)
{
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeSrbToAddModList (std::list<cv2x_LteRrcSap::SrbToAddMod> *srbToAddModList, Buffer::Iterator bIterator)
{
  int numElems;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeDrbToAddModList (std::list<cv2x_LteRrcSap::DrbToAddMod> *drbToAddModList, Buffer::Iterator bIterator)
{
  int n;
  int val;
  bIterator = DeserializeSequenceOf (&n,MAX_DRB,1,bIterator);
      ...
      if (optionalFields[2])
        {
          ...
          switch (chosen)
            {
            case 0:
              drbToAddMod.rlcConfig.choice = cv2x_LteRrcSap::RlcConfig::AM;
            ...
            case 1:
              drbToAddMod.rlcConfig.choice = cv2x_LteRrcSap::RlcConfig::UM_BI_DIRECTIONAL;
            ...
            case 2:
              drbToAddMod.rlcConfig.choice = cv2x_LteRrcSap::RlcConfig::UM_UNI_DIRECTIONAL_UL;
            ...
            case 3:
              drbToAddMod.rlcConfig.choice = cv2x_LteRrcSap::RlcConfig::UM_UNI_DIRECTIONAL_DL;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeLogicalChannelConfig (cv2x_LteRrcSap::LogicalChannelConfig *logicalChannelConfig, Buffer::Iterator bIterator)
{
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializePhysicalConfigDedicated (cv2x_LteRrcSap::PhysicalConfigDedicated *physicalConfigDedicated, Buffer::Iterator bIterator)
{
  ...
  if (optionalFieldPresent[2])
    {
      ...
      if (sel == 0)
        {
          physicalConfigDedicated->soundingRsUlConfigDedicated.type = cv2x_LteRrcSap::SoundingRsUlConfigDedicated::RESET;
...
void
cv2x_RrcAsn1Header::Print (std::ostream &os) const
{
  NS_LOG_FUNCTION (this << &os);
  NS_FATAL_ERROR ("cv2x_RrcAsn1Header Print() function must also specify cv2x_LteRrcSap::RadioResourceConfigDedicated as a second argument");
}

  Buffer::Iterator
  cv2x_RrcAsn1Header::DeserializeNonCriticalExtensionConfig (cv2x_LteRrcSap::NonCriticalExtensionConfiguration *nonCriticalExtension, Buffer::Iterator bIterator)
  {
            ...
            for (int i = 0; i < numElems; i++)
              {
                ...
                cv2x_LteRrcSap::SCellToAddMod sctam;
  ...
  Buffer::Iterator 
  cv2x_RrcAsn1Header::DeserializeCellIdentification (cv2x_LteRrcSap::CellIdentification *ci, Buffer::Iterator bIterator)
  {
    NS_LOG_FUNCTION (this);
    std::bitset<2> cellIdentification_r10;
  ...
  Buffer::Iterator 
  cv2x_RrcAsn1Header::DeserializeRadioResourceConfigCommonSCell (cv2x_LteRrcSap::RadioResourceConfigCommonSCell *rrccsc, Buffer::Iterator bIterator)
  {
    NS_LOG_FUNCTION (this);
    std::bitset<2> radioResourceConfigCommonSCell_r10;
  ...
  Buffer::Iterator 
  cv2x_RrcAsn1Header::DeserializeRadioResourceConfigDedicatedSCell (cv2x_LteRrcSap::RadioResourceConfigDedicatedSCell *rrcdsc, Buffer::Iterator bIterator)
  {
    NS_LOG_FUNCTION (this);
    std::bitset<1> RadioResourceConfigDedicatedSCell_r10;
  ...
  Buffer::Iterator 
  cv2x_RrcAsn1Header::DeserializePhysicalConfigDedicatedSCell (cv2x_LteRrcSap::PhysicalConfigDedicatedSCell *pcdsc, Buffer::Iterator bIterator)
  {
    NS_LOG_FUNCTION (this);
    std::bitset<2> pcdscOpt;
         ...
         if (pcdsc->haveSoundingRsUlConfigDedicated)
           {
             ...
             if (sel == 0)
               {
                 pcdsc->soundingRsUlConfigDedicated.type = cv2x_LteRrcSap::SoundingRsUlConfigDedicated::RESET;
               ...
               {
                 pcdsc->soundingRsUlConfigDedicated.type = cv2x_LteRrcSap::SoundingRsUlConfigDedicated::SETUP;
...
void
cv2x_RrcAsn1Header::Print (std::ostream &os, cv2x_LteRrcSap::RadioResourceConfigDedicated radioResourceConfigDedicated) const
{
  os << "   srbToAddModList: " << std::endl;
  std::list<cv2x_LteRrcSap::SrbToAddMod>::iterator it = radioResourceConfigDedicated.srbToAddModList.begin ();
  ...
  std::list<cv2x_LteRrcSap::DrbToAddMod>::iterator it2 = radioResourceConfigDedicated.drbToAddModList.begin ();
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeSystemInformationBlockType1 (cv2x_LteRrcSap::SystemInformationBlockType1 *systemInformationBlockType1, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeSystemInformationBlockType2 (cv2x_LteRrcSap::SystemInformationBlockType2 *systemInformationBlockType2, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeRadioResourceConfigCommon (cv2x_LteRrcSap::RadioResourceConfigCommon * radioResourceConfigCommon, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeRachConfigCommon (cv2x_LteRrcSap::RachConfigCommon * rachConfigCommon, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeRadioResourceConfigCommonSib (cv2x_LteRrcSap::RadioResourceConfigCommonSib * radioResourceConfigCommonSib, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeMeasResults (cv2x_LteRrcSap::MeasResults *measResults, Buffer::Iterator bIterator)
{
  int n;
  std::bitset<0> b0;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializePlmnIdentity (uint32_t *plmnId, Buffer::Iterator bIterator)
{
  int n;
...
Buffer::Iterator
cv2x_RrcAsn1Header::DeserializeMeasConfig (cv2x_LteRrcSap::MeasConfig * measConfig, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  ...
  if (bitset11[9])
    {
      ...
      for (int i = 0; i < measObjectToAddModListElems; i++)
        {
          cv2x_LteRrcSap::MeasObjectToAddMod elem;
  ...
  if (bitset11[7])
    {
      ...
      for (int i = 0; i < reportConfigToAddModListElems; i++)
        {
          cv2x_LteRrcSap::ReportConfigToAddMod elem;
          ...
          if (reportConfigChoice == 0)
            {
              ...
              if (triggerTypeChoice == 0)
                {
                  // event
                  elem.reportConfigEutra.triggerType = cv2x_LteRrcSap::ReportConfigEutra::EVENT;
                  bIterator = DeserializeSequence (&bitset0, false, bIterator);
                  ...
                  switch (eventIdChoice)
                    {
                    case 0:
                      elem.reportConfigEutra.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A1;
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                      bIterator = DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
                      break;

                    case 1:
                      elem.reportConfigEutra.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A2;
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                      bIterator = DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
                      break;

                    case 2:
                      elem.reportConfigEutra.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A3;
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                    ...
                    case 3:
                      elem.reportConfigEutra.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A4;
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                      bIterator = DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
                      break;
                    ...
                    case 4:
                    default:
                      elem.reportConfigEutra.eventId = cv2x_LteRrcSap::ReportConfigEutra::EVENT_A5;
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                      bIterator = DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
              ...
              if (triggerTypeChoice == 1)
                {
                  // periodical
                  elem.reportConfigEutra.triggerType = cv2x_LteRrcSap::ReportConfigEutra::PERIODICAL;

                  bIterator = DeserializeSequence (&bitset0, false, bIterator);
                  bIterator = DeserializeEnum (2, &n, bIterator);
                  if (n == 0)
                    {
                      elem.reportConfigEutra.purpose = cv2x_LteRrcSap::ReportConfigEutra::REPORT_STRONGEST_CELLS;
                    }
                  else
                    {
                      elem.reportConfigEutra.purpose = cv2x_LteRrcSap::ReportConfigEutra::REPORT_CGI;
                    }
                }
              ...
              if (n == 0)
                {
                  elem.reportConfigEutra.triggerQuantity = cv2x_LteRrcSap::ReportConfigEutra::RSRP;
                }
              else
                {
                  elem.reportConfigEutra.triggerQuantity = cv2x_LteRrcSap::ReportConfigEutra::RSRQ;
                }
              ...
              if (n == 0)
                {
                  elem.reportConfigEutra.reportQuantity = cv2x_LteRrcSap::ReportConfigEutra::SAME_AS_TRIGGER_QUANTITY;
                }
              else
                {
                  elem.reportConfigEutra.reportQuantity = cv2x_LteRrcSap::ReportConfigEutra::BOTH;
                }
              ...
              switch (n)
                {
                case 0:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS120;
                  break;
                case 1:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS240;
                  break;
                case 2:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS480;
                  break;
                case 3:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS640;
                  break;
                case 4:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS1024;
                  break;
                case 5:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS2048;
                  break;
                case 6:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS5120;
                  break;
                case 7:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MS10240;
                  break;
                case 8:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MIN1;
                  break;
                case 9:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MIN6;
                  break;
                case 10:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MIN12;
                  break;
                case 11:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MIN30;
                  break;
                case 12:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::MIN60;
                  break;
                case 13:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::SPARE3;
                  break;
                case 14:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::SPARE2;
                  break;
                case 15:
                default:
                  elem.reportConfigEutra.reportInterval = cv2x_LteRrcSap::ReportConfigEutra::SPARE1;
                }
  ...
  if (bitset11[5])
    {
      ...
      for (int i = 0; i < measIdToAddModListElems; i++)
        {
          cv2x_LteRrcSap::MeasIdToAddMod elem;
  ...
  if (measConfig->haveMeasGapConfig)
    {
      ...
      switch (measGapConfigChoice)
        {
        case 0:
          measConfig->measGapConfig.type = cv2x_LteRrcSap::MeasGapConfig::RESET;
          bIterator = DeserializeNull (bIterator);
          break;
        case 1:
        default:
          measConfig->measGapConfig.type = cv2x_LteRrcSap::MeasGapConfig::SETUP;
          bIterator = DeserializeSequence (&bitset0, false, bIterator);
          ...
          switch (gapOffsetChoice)
            {
            case 0:
              measConfig->measGapConfig.gapOffsetChoice = cv2x_LteRrcSap::MeasGapConfig::GP0;
              bIterator = DeserializeInteger (&n, 0, 39, bIterator);
              measConfig->measGapConfig.gapOffsetValue = n;
              break;
            case 1:
            default:
              measConfig->measGapConfig.gapOffsetChoice = cv2x_LteRrcSap::MeasGapConfig::GP1;
  ...
  if (measConfig->haveSpeedStatePars)
    {
      ...
      switch (speedStateParsChoice)
        {
        case 0:
          measConfig->speedStatePars.type = cv2x_LteRrcSap::SpeedStatePars::RESET;
          bIterator = DeserializeNull (bIterator);
          break;
        case 1:
        default:
          measConfig->speedStatePars.type = cv2x_LteRrcSap::SpeedStatePars::SETUP;
          bIterator = DeserializeSequence (&bitset0, false, bIterator);
...
// Constructor
cv2x_RrcConnectionRequestHeader::cv2x_RrcConnectionRequestHeader () : cv2x_RrcUlCcchMessage ()
{
...
// Destructor
cv2x_RrcConnectionRequestHeader::~cv2x_RrcConnectionRequestHeader ()
{
}

TypeId
cv2x_RrcConnectionRequestHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::cv2x_RrcConnectionRequestHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
  ;
  return tid;
...
void
cv2x_RrcConnectionRequestHeader::Print (std::ostream &os) const
{
...
void
cv2x_RrcConnectionRequestHeader::PreSerialize () const
{
...
uint32_t
cv2x_RrcConnectionRequestHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<1> dummy;
...
void
cv2x_RrcConnectionRequestHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionRequest msg)
{
...
cv2x_LteRrcSap::RrcConnectionRequest
cv2x_RrcConnectionRequestHeader::GetMessage () const
{
...
std::bitset<8>
cv2x_RrcConnectionRequestHeader::GetMmec () const
{
  return m_mmec;
}

std::bitset<32>
cv2x_RrcConnectionRequestHeader::GetMtmsi () const
{
  return m_mTmsi;
}
...
cv2x_RrcConnectionSetupHeader::cv2x_RrcConnectionSetupHeader ()
{
}
...
void
cv2x_RrcConnectionSetupHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int)m_rrcTransactionIdentifier << std::endl;
  os << "radioResourceConfigDedicated:" << std::endl;
  cv2x_RrcAsn1Header::Print (os,m_radioResourceConfigDedicated);
}

void
cv2x_RrcConnectionSetupHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionSetupHeader::Deserialize (Buffer::Iterator bIterator)
{
  int n;
...
void
cv2x_RrcConnectionSetupHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionSetup msg)
{
...
cv2x_LteRrcSap::RrcConnectionSetup
cv2x_RrcConnectionSetupHeader::GetMessage () const
{
...
uint8_t
cv2x_RrcConnectionSetupHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

bool
cv2x_RrcConnectionSetupHeader::HavePhysicalConfigDedicated () const
{
  return m_radioResourceConfigDedicated.havePhysicalConfigDedicated;
}

std::list<cv2x_LteRrcSap::SrbToAddMod>
cv2x_RrcConnectionSetupHeader::GetSrbToAddModList () const
{
  return m_radioResourceConfigDedicated.srbToAddModList;
}

std::list<cv2x_LteRrcSap::DrbToAddMod>
cv2x_RrcConnectionSetupHeader::GetDrbToAddModList () const
{
  return m_radioResourceConfigDedicated.drbToAddModList;
} 

std::list<uint8_t>
cv2x_RrcConnectionSetupHeader::GetDrbToReleaseList () const
{
  return m_radioResourceConfigDedicated.drbToReleaseList;
}

cv2x_LteRrcSap::PhysicalConfigDedicated
cv2x_RrcConnectionSetupHeader::GetPhysicalConfigDedicated () const
{
  return m_radioResourceConfigDedicated.physicalConfigDedicated;
}

cv2x_LteRrcSap::RadioResourceConfigDedicated
cv2x_RrcConnectionSetupHeader::GetRadioResourceConfigDedicated () const
{
  return m_radioResourceConfigDedicated;
}

//////////////////// cv2x_RrcConnectionSetupCompleteHeader class ////////////////////////

cv2x_RrcConnectionSetupCompleteHeader::cv2x_RrcConnectionSetupCompleteHeader ()
{
}
...
void
cv2x_RrcConnectionSetupCompleteHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionSetupCompleteHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
...
void
cv2x_RrcConnectionSetupCompleteHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int) m_rrcTransactionIdentifier << std::endl;
}

void
cv2x_RrcConnectionSetupCompleteHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionSetupCompleted msg)
{
  m_rrcTransactionIdentifier = msg.rrcTransactionIdentifier;
  m_isDataSerialized = false;
}
...
uint8_t
cv2x_RrcConnectionSetupCompleteHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

cv2x_LteRrcSap::RrcConnectionSetupCompleted
cv2x_RrcConnectionSetupCompleteHeader::GetMessage () const
{
...
//////////////////// cv2x_RrcConnectionReconfigurationCompleteHeader class ////////////////////////

cv2x_RrcConnectionReconfigurationCompleteHeader::cv2x_RrcConnectionReconfigurationCompleteHeader ()
{
}
...
void
cv2x_RrcConnectionReconfigurationCompleteHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReconfigurationCompleteHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcConnectionReconfigurationCompleteHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int) m_rrcTransactionIdentifier << std::endl;
}

void
cv2x_RrcConnectionReconfigurationCompleteHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReconfigurationCompleted msg)
{
  m_rrcTransactionIdentifier = msg.rrcTransactionIdentifier;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::RrcConnectionReconfigurationCompleted
cv2x_RrcConnectionReconfigurationCompleteHeader::GetMessage () const
{
...
uint8_t
cv2x_RrcConnectionReconfigurationCompleteHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

//////////////////// cv2x_RrcConnectionReconfigurationHeader class ////////////////////////

cv2x_RrcConnectionReconfigurationHeader::cv2x_RrcConnectionReconfigurationHeader ()
{
}
...
void
cv2x_RrcConnectionReconfigurationHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReconfigurationHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
...
void
cv2x_RrcConnectionReconfigurationHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int) m_rrcTransactionIdentifier << std::endl;
      ...
      if (!m_measConfig.measObjectToAddModList.empty ())
        {
          ...
          std::list<cv2x_LteRrcSap::MeasObjectToAddMod> auxList = m_measConfig.measObjectToAddModList;
          std::list<cv2x_LteRrcSap::MeasObjectToAddMod>::iterator it = auxList.begin ();
          for (; it != auxList.end (); it++)
            {
              ...
              if (!it->measObjectEutra.cellsToAddModList.empty ())
                {
                  ...
                  std::list<cv2x_LteRrcSap::CellsToAddMod> auxList = it->measObjectEutra.cellsToAddModList;
                  std::list<cv2x_LteRrcSap::CellsToAddMod>::iterator it = auxList.begin ();
                  for (; it != auxList.end (); it++)
                    {
              ...
              if (!it->measObjectEutra.blackCellsToAddModList.empty ())
                {
                  ...
                  std::list<cv2x_LteRrcSap::BlackCellsToAddMod> auxList = it->measObjectEutra.blackCellsToAddModList;
                  std::list<cv2x_LteRrcSap::BlackCellsToAddMod>::iterator it = auxList.begin ();
                  for (; it != auxList.end (); it++)
                    {
                      os << "      cellIndex: " <<  (int)it->cellIndex << std::endl;
      ...
      if (!m_measConfig.reportConfigToAddModList.empty ())
        {
          ...
          std::list<cv2x_LteRrcSap::ReportConfigToAddMod> auxList = m_measConfig.reportConfigToAddModList;
          std::list<cv2x_LteRrcSap::ReportConfigToAddMod>::iterator it = auxList.begin ();
          for (; it != auxList.end (); it++)
            {
              ...
              if (it->reportConfigEutra.triggerType == cv2x_LteRrcSap::ReportConfigEutra::EVENT)
                {
                  os << "    reportConfigEutra.eventId  " <<  (int)it->reportConfigEutra.eventId << std::endl;
                  if (it->reportConfigEutra.eventId == cv2x_LteRrcSap::ReportConfigEutra::EVENT_A3)
                    {
                  ...
                  else
                    {
                      ...
                      if (it->reportConfigEutra.eventId == cv2x_LteRrcSap::ReportConfigEutra::EVENT_A5)
                        {
      ...
      if (!m_measConfig.measIdToAddModList.empty ())
        {
          ...
          std::list<cv2x_LteRrcSap::MeasIdToAddMod> auxList = m_measConfig.measIdToAddModList;
          std::list<cv2x_LteRrcSap::MeasIdToAddMod>::iterator it = auxList.begin ();
          for (; it != auxList.end (); it++)
            {
...
void
cv2x_RrcConnectionReconfigurationHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReconfiguration msg)
{
  m_rrcTransactionIdentifier = msg.rrcTransactionIdentifier;
...
cv2x_RrcConnectionReconfigurationHeader::GetMessage () const
{
...
uint8_t
cv2x_RrcConnectionReconfigurationHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

bool
cv2x_RrcConnectionReconfigurationHeader::GetHaveMeasConfig ()
{
  return m_haveMeasConfig;
}

cv2x_LteRrcSap::MeasConfig
cv2x_RrcConnectionReconfigurationHeader::GetMeasConfig ()
{
  return m_measConfig;
}

bool
cv2x_RrcConnectionReconfigurationHeader::GetHaveMobilityControlInfo ()
{
  return m_haveMobilityControlInfo;
}

cv2x_LteRrcSap::MobilityControlInfo
cv2x_RrcConnectionReconfigurationHeader::GetMobilityControlInfo ()
{
  return m_mobilityControlInfo;
}

bool
cv2x_RrcConnectionReconfigurationHeader::GetHaveRadioResourceConfigDedicated ()
{
  return m_haveRadioResourceConfigDedicated;
}

cv2x_LteRrcSap::RadioResourceConfigDedicated
cv2x_RrcConnectionReconfigurationHeader::GetRadioResourceConfigDedicated ()
{
  return m_radioResourceConfigDedicated;
  }

  bool
  cv2x_RrcConnectionReconfigurationHeader::GetHaveNonCriticalExtensionConfig ()
  {
    return m_haveNonCriticalExtension;
  }

  cv2x_LteRrcSap::NonCriticalExtensionConfiguration
  cv2x_RrcConnectionReconfigurationHeader::GetNonCriticalExtensionConfig ()
  {
    return m_nonCriticalExtension;
}

bool
cv2x_RrcConnectionReconfigurationHeader::HavePhysicalConfigDedicated () const
{
  return m_radioResourceConfigDedicated.havePhysicalConfigDedicated;
}

std::list<cv2x_LteRrcSap::SrbToAddMod> 
cv2x_RrcConnectionReconfigurationHeader::GetSrbToAddModList () const
{
  return m_radioResourceConfigDedicated.srbToAddModList;
}

std::list<cv2x_LteRrcSap::DrbToAddMod> 
cv2x_RrcConnectionReconfigurationHeader::GetDrbToAddModList () const
{
  return m_radioResourceConfigDedicated.drbToAddModList;
}

std::list<uint8_t> 
cv2x_RrcConnectionReconfigurationHeader::GetDrbToReleaseList () const
{
  return m_radioResourceConfigDedicated.drbToReleaseList;
}

cv2x_LteRrcSap::PhysicalConfigDedicated 
cv2x_RrcConnectionReconfigurationHeader::GetPhysicalConfigDedicated () const
{
  return m_radioResourceConfigDedicated.physicalConfigDedicated;
}


//////////////////// cv2x_HandoverPreparationInfoHeader class ////////////////////////

cv2x_HandoverPreparationInfoHeader::cv2x_HandoverPreparationInfoHeader ()
{
}

void
cv2x_HandoverPreparationInfoHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_HandoverPreparationInfoHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_HandoverPreparationInfoHeader::Print (std::ostream &os) const
{
  cv2x_RrcAsn1Header::Print (os,m_asConfig.sourceRadioResourceConfig);
...
void
cv2x_HandoverPreparationInfoHeader::SetMessage (cv2x_LteRrcSap::HandoverPreparationInfo msg)
{
...
cv2x_HandoverPreparationInfoHeader::GetMessage () const
{
...
cv2x_LteRrcSap::AsConfig
cv2x_HandoverPreparationInfoHeader::GetAsConfig () const
{
  return m_asConfig;
}

//////////////////// cv2x_RrcConnectionReestablishmentRequestHeader class ////////////////////////

cv2x_RrcConnectionReestablishmentRequestHeader::cv2x_RrcConnectionReestablishmentRequestHeader ()
{
}
...
void
cv2x_RrcConnectionReestablishmentRequestHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
  ...
  switch (m_reestablishmentCause)
    {
    case cv2x_LteRrcSap::RECONFIGURATION_FAILURE:
      SerializeEnum (4,0);
      break;
    case cv2x_LteRrcSap::HANDOVER_FAILURE:
      SerializeEnum (4,1);
      break;
    case cv2x_LteRrcSap::OTHER_FAILURE:
      SerializeEnum (4,2);
      break;
    default:
      SerializeEnum (4,3);
...
uint32_t
cv2x_RrcConnectionReestablishmentRequestHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
  ...
  if ( n == 1)
  ...
  else if ( n == 0)
    {
      ...
      switch (reestCs)
        {
        case 0:
          m_reestablishmentCause = cv2x_LteRrcSap::RECONFIGURATION_FAILURE;
          break;
        case 1:
          m_reestablishmentCause = cv2x_LteRrcSap::HANDOVER_FAILURE;
          break;
        case 2:
          m_reestablishmentCause = cv2x_LteRrcSap::OTHER_FAILURE;
          break;
        case 3:
          break;
        }
...
void
cv2x_RrcConnectionReestablishmentRequestHeader::Print (std::ostream &os) const
{
...
void
cv2x_RrcConnectionReestablishmentRequestHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReestablishmentRequest msg)
{
...
cv2x_LteRrcSap::RrcConnectionReestablishmentRequest
cv2x_RrcConnectionReestablishmentRequestHeader::GetMessage () const
{
...
cv2x_LteRrcSap::ReestabUeIdentity
cv2x_RrcConnectionReestablishmentRequestHeader::GetUeIdentity () const
{
  return m_ueIdentity;
}

cv2x_LteRrcSap::ReestablishmentCause
cv2x_RrcConnectionReestablishmentRequestHeader::GetReestablishmentCause () const
{
  return m_reestablishmentCause;
}

//////////////////// cv2x_RrcConnectionReestablishmentHeader class ////////////////////////

cv2x_RrcConnectionReestablishmentHeader::cv2x_RrcConnectionReestablishmentHeader ()
{
}
...
void
cv2x_RrcConnectionReestablishmentHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReestablishmentHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcConnectionReestablishmentHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int)m_rrcTransactionIdentifier << std::endl;
  os << "RadioResourceConfigDedicated: " << std::endl;
  cv2x_RrcAsn1Header::Print (os,m_radioResourceConfigDedicated);
...
void
cv2x_RrcConnectionReestablishmentHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReestablishment msg)
{
  m_rrcTransactionIdentifier = msg.rrcTransactionIdentifier;
  m_radioResourceConfigDedicated = msg.radioResourceConfigDedicated;
  m_isDataSerialized = false;
...
cv2x_LteRrcSap::RrcConnectionReestablishment
cv2x_RrcConnectionReestablishmentHeader::GetMessage () const
{
...
uint8_t
cv2x_RrcConnectionReestablishmentHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

cv2x_LteRrcSap::RadioResourceConfigDedicated
cv2x_RrcConnectionReestablishmentHeader::GetRadioResourceConfigDedicated () const
{
  return m_radioResourceConfigDedicated;
}

//////////////////// cv2x_RrcConnectionReestablishmentCompleteHeader class ////////////////////////

cv2x_RrcConnectionReestablishmentCompleteHeader::cv2x_RrcConnectionReestablishmentCompleteHeader ()
{
}

void
cv2x_RrcConnectionReestablishmentCompleteHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReestablishmentCompleteHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcConnectionReestablishmentCompleteHeader::Print (std::ostream &os) const
{
  os << "rrcTransactionIdentifier: " << (int)m_rrcTransactionIdentifier << std::endl;
}

void
cv2x_RrcConnectionReestablishmentCompleteHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReestablishmentComplete msg)
{
  m_rrcTransactionIdentifier = msg.rrcTransactionIdentifier;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::RrcConnectionReestablishmentComplete
cv2x_RrcConnectionReestablishmentCompleteHeader::GetMessage () const
{
...
uint8_t
cv2x_RrcConnectionReestablishmentCompleteHeader::GetRrcTransactionIdentifier () const
{
  return m_rrcTransactionIdentifier;
}

//////////////////// cv2x_RrcConnectionReestablishmentRejectHeader class ////////////////////////

cv2x_RrcConnectionReestablishmentRejectHeader::cv2x_RrcConnectionReestablishmentRejectHeader ()
{
}
...
void
cv2x_RrcConnectionReestablishmentRejectHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReestablishmentRejectHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
...
void
cv2x_RrcConnectionReestablishmentRejectHeader::Print (std::ostream &os) const
{
}

void
cv2x_RrcConnectionReestablishmentRejectHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReestablishmentReject msg)
{
  m_rrcConnectionReestablishmentReject = msg;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::RrcConnectionReestablishmentReject
cv2x_RrcConnectionReestablishmentRejectHeader::GetMessage () const
{
  return m_rrcConnectionReestablishmentReject;
}

//////////////////// cv2x_RrcConnectionReleaseHeader class ////////////////////////

cv2x_RrcConnectionReleaseHeader::cv2x_RrcConnectionReleaseHeader ()
{
}
...
void
cv2x_RrcConnectionReleaseHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionReleaseHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcConnectionReleaseHeader::Print (std::ostream &os) const
{
}

void
cv2x_RrcConnectionReleaseHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionRelease msg)
{
  m_rrcConnectionRelease = msg;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::RrcConnectionRelease
cv2x_RrcConnectionReleaseHeader::GetMessage () const
{
  return m_rrcConnectionRelease;
}

//////////////////// cv2x_RrcConnectionRejectHeader class ////////////////////////

cv2x_RrcConnectionRejectHeader::cv2x_RrcConnectionRejectHeader ()
{
}
...
void
cv2x_RrcConnectionRejectHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_RrcConnectionRejectHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcConnectionRejectHeader::Print (std::ostream &os) const
{
  os << "wait time: " << (int)m_rrcConnectionReject.waitTime << std::endl;
}

void
cv2x_RrcConnectionRejectHeader::SetMessage (cv2x_LteRrcSap::RrcConnectionReject msg)
{
  m_rrcConnectionReject = msg;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::RrcConnectionReject
cv2x_RrcConnectionRejectHeader::GetMessage () const
{
  return m_rrcConnectionReject;
}

//////////////////// cv2x_MeasurementReportHeader class ////////////////////////

cv2x_MeasurementReportHeader::cv2x_MeasurementReportHeader ()
{
}
...
void
cv2x_MeasurementReportHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_MeasurementReportHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
...
void
cv2x_MeasurementReportHeader::Print (std::ostream &os) const
{
  ...
  if (m_measurementReport.measResults.haveMeasResultNeighCells)
    {
      std::list<cv2x_LteRrcSap::MeasResultEutra> measResultListEutra = m_measurementReport.measResults.measResultListEutra;
      std::list<cv2x_LteRrcSap::MeasResultEutra>::iterator it = measResultListEutra.begin ();
...
void
cv2x_MeasurementReportHeader::SetMessage (cv2x_LteRrcSap::MeasurementReport msg)
{
  m_measurementReport = msg;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::MeasurementReport
cv2x_MeasurementReportHeader::GetMessage () const
{
...
cv2x_SidelinkUeInformationHeader::cv2x_SidelinkUeInformationHeader ()
{
}
...
void
cv2x_SidelinkUeInformationHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
cv2x_SidelinkUeInformationHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
...
void
cv2x_SidelinkUeInformationHeader::Print (std::ostream &os) const
{
  //os << "measId = " << (int)m_measurementReport.measResults.measId << std::endl;
...
void
cv2x_SidelinkUeInformationHeader::SetMessage (cv2x_LteRrcSap::SidelinkUeInformation msg)
{
  m_sidelinkUeInformation = msg;
  m_isDataSerialized = false;
}

cv2x_LteRrcSap::SidelinkUeInformation
cv2x_SidelinkUeInformationHeader::GetMessage () const
{
  cv2x_LteRrcSap::SidelinkUeInformation msg;
  msg = m_sidelinkUeInformation;
  return msg;
}

///////////////////  cv2x_RrcUlDcchMessage //////////////////////////////////
cv2x_RrcUlDcchMessage::cv2x_RrcUlDcchMessage () : cv2x_RrcAsn1Header ()
{
}

cv2x_RrcUlDcchMessage::~cv2x_RrcUlDcchMessage ()
{
}

uint32_t
cv2x_RrcUlDcchMessage::Deserialize (Buffer::Iterator bIterator)
{
...
void
cv2x_RrcUlDcchMessage::Print (std::ostream &os) const
{
  std::cout << "UL DCCH MSG TYPE: " << m_messageType << std::endl;
}

void
cv2x_RrcUlDcchMessage::PreSerialize () const
{
  SerializeUlDcchMessage (m_messageType);
}

Buffer::Iterator
cv2x_RrcUlDcchMessage::DeserializeUlDcchMessage (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcUlDcchMessage::SerializeUlDcchMessage (int messageType) const
{
  SerializeSequence (std::bitset<0> (),false);
  // Choose c1
  SerializeChoice (2,0,false);
...
cv2x_RrcDlDcchMessage::cv2x_RrcDlDcchMessage () : cv2x_RrcAsn1Header ()
{
}

cv2x_RrcDlDcchMessage::~cv2x_RrcDlDcchMessage ()
{
}

uint32_t
cv2x_RrcDlDcchMessage::Deserialize (Buffer::Iterator bIterator)
{
...
void
cv2x_RrcDlDcchMessage::Print (std::ostream &os) const
{
  std::cout << "DL DCCH MSG TYPE: " << m_messageType << std::endl;
}

void
cv2x_RrcDlDcchMessage::PreSerialize () const
{
  SerializeDlDcchMessage (m_messageType);
}

Buffer::Iterator
cv2x_RrcDlDcchMessage::DeserializeDlDcchMessage (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcDlDcchMessage::SerializeDlDcchMessage (int messageType) const
{
  SerializeSequence (std::bitset<0> (),false);
  // Choose c1
  SerializeChoice (2,0,false);
...
cv2x_RrcUlCcchMessage::cv2x_RrcUlCcchMessage () : cv2x_RrcAsn1Header ()
{
}

cv2x_RrcUlCcchMessage::~cv2x_RrcUlCcchMessage ()
{
}

uint32_t
cv2x_RrcUlCcchMessage::Deserialize (Buffer::Iterator bIterator)
{
...
void
cv2x_RrcUlCcchMessage::Print (std::ostream &os) const
{
  std::cout << "UL CCCH MSG TYPE: " << m_messageType << std::endl;
}

void
cv2x_RrcUlCcchMessage::PreSerialize () const
{
  SerializeUlCcchMessage (m_messageType);
}

Buffer::Iterator
cv2x_RrcUlCcchMessage::DeserializeUlCcchMessage (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcUlCcchMessage::SerializeUlCcchMessage (int messageType) const
{
  SerializeSequence (std::bitset<0> (),false);
  // Choose c1
  SerializeChoice (2,0,false);
...
cv2x_RrcDlCcchMessage::cv2x_RrcDlCcchMessage () : cv2x_RrcAsn1Header ()
{
}

cv2x_RrcDlCcchMessage::~cv2x_RrcDlCcchMessage ()
{
}

uint32_t
cv2x_RrcDlCcchMessage::Deserialize (Buffer::Iterator bIterator)
{
...
void
cv2x_RrcDlCcchMessage::Print (std::ostream &os) const
{
  std::cout << "DL CCCH MSG TYPE: " << m_messageType << std::endl;
}

void
cv2x_RrcDlCcchMessage::PreSerialize () const
{
  SerializeDlCcchMessage (m_messageType);
}

Buffer::Iterator
cv2x_RrcDlCcchMessage::DeserializeDlCcchMessage (Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
void
cv2x_RrcDlCcchMessage::SerializeDlCcchMessage (int messageType) const
{
  SerializeSequence (std::bitset<0> (),false);
  // Choose c1
  SerializeChoice (2,0,false);
