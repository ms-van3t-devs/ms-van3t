...
#ifndef CV2X_EPC_ENB_APPLICATION_H
#define CV2X_EPC_ENB_APPLICATION_H
 ...
 */
class cv2x_EpcEnbApplication : public Application
{

  /// allow cv2x_MemberEpcEnbS1SapProvider<cv2x_EpcEnbApplication> class friend access
  friend class cv2x_MemberEpcEnbS1SapProvider<cv2x_EpcEnbApplication>;
  /// allow cv2x_MemberEpcS1apSapEnb<cv2x_EpcEnbApplication> class friend access
  friend class cv2x_MemberEpcS1apSapEnb<cv2x_EpcEnbApplication>;
...
public:
   ...
   */
  cv2x_EpcEnbApplication (Ptr<Socket> lteSocket, Ptr<Socket> lteSocket6, Ptr<Socket> s1uSocket, Ipv4Address enbS1uAddress, Ipv4Address sgwS1uAddress, uint16_t cellId);

  /**
   * Destructor
   * 
   */
  virtual ~cv2x_EpcEnbApplication (void);
   ...
   */
  void SetS1SapUser (cv2x_EpcEnbS1SapUser * s);

  /** 
   * 
   * \return the S1 SAP Provider
   */
  cv2x_EpcEnbS1SapProvider* GetS1SapProvider ();
   ...
   */
  void SetS1apSapMme (cv2x_EpcS1apSapMme * s);

  /** 
   * 
   * \return the ENB side of the S1-AP SAP 
   */
  cv2x_EpcS1apSapEnb* GetS1apSapEnb ();
...
private:
   ...
   */
  void DoPathSwitchRequest (cv2x_EpcEnbS1SapProvider::PathSwitchRequestParameters params);
  /**
   ...
   */
  void DoInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<cv2x_EpcS1apSapEnb::ErabToBeSetupItem> erabToBeSetupList);
  /**
   ...
   */
  void DoPathSwitchRequestAcknowledge (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi, std::list<cv2x_EpcS1apSapEnb::ErabSwitchedInUplinkItem> erabToBeSwitchedInUplinkList);
   ...
   * 
   */
  cv2x_EpcS1apSapMme* m_s1apSapMme;

  /**
   * ENB side of the S1-AP SAP
   * 
   */
  cv2x_EpcS1apSapEnb* m_s1apSapEnb;
...
#endif /* CV2X_EPC_ENB_APPLICATION_H */
