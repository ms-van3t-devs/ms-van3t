...
#ifndef CV2X_LTE_RLC_AM_HEADER_H
#define CV2X_LTE_RLC_AM_HEADER_H
 ...
 */
class cv2x_LteRlcAmHeader : public Header
{
public:
   ...
   */
  void SetSequenceNumber (cv2x_SequenceNumber10 sequenceNumber);
  /**
   * Get sequence number
   *
   * \returns sequence number
   */
  cv2x_SequenceNumber10 GetSequenceNumber () const;
   ...
   * \param ackSn ack sn
   */
  void SetAckSn (cv2x_SequenceNumber10 ackSn);
  /**
   * Get ack sn function
   *
   * \returns sequence numbr
   */
  cv2x_SequenceNumber10 GetAckSn () const;
   ...
   */
  bool IsNackPresent (cv2x_SequenceNumber10 nack);
...
private:
  ...
  cv2x_SequenceNumber10 m_sequenceNumber; ///< sequence number
  ...
  // Status PDU fields
  cv2x_SequenceNumber10 m_ackSn; ///< ack sn
...
#endif // CV2X_LTE_RLC_AM_HEADER_H
