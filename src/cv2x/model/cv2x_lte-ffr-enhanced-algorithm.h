...
#ifndef CV2X_LTE_FFR_ENHANCED_ALGORITHM_H
#define CV2X_LTE_FFR_ENHANCED_ALGORITHM_H
 ...
 */
class cv2x_LteFfrEnhancedAlgorithm : public cv2x_LteFfrAlgorithm
{
public:
  /**
   * \brief Creates a trivial ffr algorithm instance.
   */
  cv2x_LteFfrEnhancedAlgorithm ();
  virtual ~cv2x_LteFfrEnhancedAlgorithm ();
  ...
  friend class cv2x_MemberLteFfrSapProvider<cv2x_LteFfrEnhancedAlgorithm>;
  /// let the forwarder class access the protected and private members
  friend class cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFfrEnhancedAlgorithm>;
...
private:
   ...
   */
  std::map <uint16_t,cv2x_SbMeasResult_s> m_dlCqi;
...
}; // end of class cv2x_LteFfrEnhancedAlgorithm

} // end of namespace ns3

#endif /* CV2X_LTE_FFR_ENHANCED_ALGORITHM_H */
