...
#ifndef CV2X_PSS_FF_MAC_SCHEDULER_H
#define CV2X_PSS_FF_MAC_SCHEDULER_H
...
class cv2x_PssFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_PssFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_PssFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_PssFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_PssFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_PssFfMacScheduler> class friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_PssFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, cv2x_pssFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, cv2x_pssFlowPerf_t> m_flowStatsUl;
  ...
  */
  ...
  std::map <uint16_t, cv2x_DlHarqRlcPduListBuffer_t> m_dlHarqProcessesRlcPduListBuffer; ///< DL HARQ ELC PDU list buffer
...
#endif /* CV2X_PSS_FF_MAC_SCHEDULER_H */
