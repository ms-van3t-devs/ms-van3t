...
#ifndef CV2X_A3_RSRP_HANDOVER_ALGORITHM_H
#define CV2X_A3_RSRP_HANDOVER_ALGORITHM_H
 ...
 */
class cv2x_A3RsrpHandoverAlgorithm : public cv2x_LteHandoverAlgorithm
{
public:
  /// Creates a strongest cell handover algorithm instance.
  cv2x_A3RsrpHandoverAlgorithm ();

  virtual ~cv2x_A3RsrpHandoverAlgorithm ();
  ...
  friend class cv2x_MemberLteHandoverManagementSapProvider<cv2x_A3RsrpHandoverAlgorithm>;
...
}; // end of class cv2x_A3RsrpHandoverAlgorithm


} // end of namespace ns3


#endif /* CV2X_A3_RSRP_HANDOVER_ALGORITHM_H */
