...
#ifndef CV2X_LTE_ENB_CMAC_SAP_H
#define CV2X_LTE_ENB_CMAC_SAP_H
...
{
public:
  virtual ~cv2x_LteEnbCmacSapProvider ();
  /**
   *
   *
   * @param ulBandwidth
   ...
   * \param msu
   */
  virtual void AddLc (LcInfo lcinfo, cv2x_LteMacSapUser* msu) = 0;
 ...
 */
class cv2x_LteEnbCmacSapUser
{
public:
  virtual ~cv2x_LteEnbCmacSapUser ();
