...
NS_LOG_COMPONENT_DEFINE ("cv2x_Lte3GPPcalMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (cv2x_Lte3GPPcalMacScheduler);


  /**
   * Class providing hooks to control scheduler (control plane)
   */
class cv2x_CalSchedulerMemberCschedSapProvider : public cv2x_FfMacCschedSapProvider
{
public:
  /**
   ...
   */
  cv2x_CalSchedulerMemberCschedSapProvider (cv2x_Lte3GPPcalMacScheduler* scheduler);
...
private:
  cv2x_CalSchedulerMemberCschedSapProvider ();
  cv2x_Lte3GPPcalMacScheduler* m_scheduler;
};

cv2x_CalSchedulerMemberCschedSapProvider::cv2x_CalSchedulerMemberCschedSapProvider ()
{
}

cv2x_CalSchedulerMemberCschedSapProvider::cv2x_CalSchedulerMemberCschedSapProvider (cv2x_Lte3GPPcalMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
cv2x_CalSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
cv2x_CalSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
cv2x_CalSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
cv2x_CalSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
cv2x_CalSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
   ...
   */
class cv2x_CalSchedulerMemberSchedSapProvider : public cv2x_FfMacSchedSapProvider
{
public:
  /**
   ...
   */
  cv2x_CalSchedulerMemberSchedSapProvider (cv2x_Lte3GPPcalMacScheduler* scheduler);
...
private:
  cv2x_CalSchedulerMemberSchedSapProvider ();
  cv2x_Lte3GPPcalMacScheduler* m_scheduler;
};



cv2x_CalSchedulerMemberSchedSapProvider::cv2x_CalSchedulerMemberSchedSapProvider ()
{
}


cv2x_CalSchedulerMemberSchedSapProvider::cv2x_CalSchedulerMemberSchedSapProvider (cv2x_Lte3GPPcalMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
cv2x_CalSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
cv2x_Lte3GPPcalMacScheduler::cv2x_Lte3GPPcalMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new cv2x_CalSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new cv2x_CalSchedulerMemberSchedSapProvider (this);
}
...
void
cv2x_Lte3GPPcalMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
cv2x_Lte3GPPcalMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::cv2x_Lte3GPPcalMacScheduler")
    .SetParent<cv2x_FfMacScheduler> ()
    .AddConstructor<cv2x_Lte3GPPcalMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&cv2x_Lte3GPPcalMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&cv2x_Lte3GPPcalMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&cv2x_Lte3GPPcalMacScheduler::m_ulGrantMcs),
...
void
cv2x_Lte3GPPcalMacScheduler::SetFfMacCschedSapUser (cv2x_FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
cv2x_Lte3GPPcalMacScheduler::SetFfMacSchedSapUser (cv2x_FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

cv2x_FfMacCschedSapProvider*
cv2x_Lte3GPPcalMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

cv2x_FfMacSchedSapProvider*
cv2x_Lte3GPPcalMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
cv2x_Lte3GPPcalMacScheduler::SetLteFfrSapProvider (cv2x_LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

cv2x_LteFfrSapUser*
cv2x_Lte3GPPcalMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
cv2x_Lte3GPPcalMacScheduler::DoCschedCellConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoCschedUeConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
cv2x_Lte3GPPcalMacScheduler::DoCschedLcConfigReq (const struct cv2x_FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoCschedLcReleaseReq (const struct cv2x_FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoCschedUeReleaseReq (const struct cv2x_FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlRlcBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlPagingBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlMacBufferReq (const struct cv2x_FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
cv2x_Lte3GPPcalMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
cv2x_Lte3GPPcalMacScheduler::SortRlcBufferReq (cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
cv2x_Lte3GPPcalMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
cv2x_Lte3GPPcalMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
cv2x_Lte3GPPcalMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlTriggerReq (const struct cv2x_FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  for (itRach = m_rachList.begin (); itRach != m_rachList.end (); itRach++)
    {
      ...
      NS_LOG_INFO (" UL grant allocated to RNTI " << (*itRach).m_rnti << " rbStart " << rbStart << " rbLen " << rbLen << " MCS " << (uint16_t) m_ulGrantMcs << " tbSize " << newRar.m_grant.m_tbSize);
  ...
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
    {
      ...
      if ( (((*it).m_rlcTransmissionQueueSize > 0)
        ...
        {
          NS_LOG_LOGIC (" User " << (*it).m_rnti << " LC " << (uint16_t)(*it).m_logicalChannelIdentity << " is active, status  " << (*it).m_rlcStatusPduSize << " retx " << (*it).m_rlcRetransmissionQueueSize << " tx " << (*it).m_rlcTransmissionQueueSize);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlRachInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedDlCqiInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedUlTriggerReq (const struct cv2x_FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedUlNoiseInterferenceReq (const struct cv2x_FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedUlSrInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedUlMacCtrlInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::DoSchedUlCqiInfoReq (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_Lte3GPPcalMacScheduler::RefreshDlCqiMaps (void)
{
...
void
cv2x_Lte3GPPcalMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
cv2x_Lte3GPPcalMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<cv2x_FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
cv2x_Lte3GPPcalMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
cv2x_Lte3GPPcalMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
