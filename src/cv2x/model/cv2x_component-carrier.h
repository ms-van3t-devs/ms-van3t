...
#ifndef CV2X_COMPONENT_CARRIER_H
#define CV2X_COMPONENT_CARRIER_H
 ...
 * \ingroup lte
 *
 * cv2x_ComponentCarrier Object, it defines a single Carrier
 * This is the parent class for both cv2x_ComponentCarrierEnb
 * and cv2x_ComponentCarrierUe.
 ...
 */
class cv2x_ComponentCarrier : public Object
{
public:
  /**
  ...
  virtual ~cv2x_ComponentCarrier (void);
...
#endif /* CV2X_COMPONENT_CARRIER_H */
