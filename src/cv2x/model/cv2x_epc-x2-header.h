...
#ifndef CV2X_EPC_X2_HEADER_H
#define CV2X_EPC_X2_HEADER_H
...
class cv2x_EpcX2Header : public Header
{
public:
  cv2x_EpcX2Header ();
  virtual ~cv2x_EpcX2Header ();
...
/**
 * cv2x_EpcX2HandoverRequestHeader
 */
class cv2x_EpcX2HandoverRequestHeader : public Header
{
public:
  cv2x_EpcX2HandoverRequestHeader ();
  virtual ~cv2x_EpcX2HandoverRequestHeader ();
   ...
   * \returns <cv2x_EpcX2Sap::ErabToBeSetupItem>
   */
  std::vector <cv2x_EpcX2Sap::ErabToBeSetupItem> GetBearers () const;
  /**
   * Set bearers function
   * \param bearers std::vector <cv2x_EpcX2Sap::ErabToBeSetupItem>
   */ 
  void SetBearers (std::vector <cv2x_EpcX2Sap::ErabToBeSetupItem> bearers);
...
private:
  ...
  std::vector <cv2x_EpcX2Sap::ErabToBeSetupItem> m_erabsToBeSetupList; ///< ERAB to be setup list
};

/**
 * cv2x_EpcX2HandoverRequestAckHeader
 */
class cv2x_EpcX2HandoverRequestAckHeader : public Header
{
public:
  cv2x_EpcX2HandoverRequestAckHeader ();
  virtual ~cv2x_EpcX2HandoverRequestAckHeader ();
   ...
   * \returns <cv2x_EpcX2Sap::ErabAdmittedItem>
   */
  std::vector <cv2x_EpcX2Sap::ErabAdmittedItem> GetAdmittedBearers () const;
  /**
   * Set admitted bearers function
   * \param bearers the admitted bearers
   */
  void SetAdmittedBearers (std::vector <cv2x_EpcX2Sap::ErabAdmittedItem> bearers);

  /**
   * Get not admitted bearers function
   * \returns the not admitted bearers
   */
  std::vector <cv2x_EpcX2Sap::ErabNotAdmittedItem> GetNotAdmittedBearers () const;
  /**
   * Set not admitted bearers function
   * \param bearers the not admitted bearers
   */
  void SetNotAdmittedBearers (std::vector <cv2x_EpcX2Sap::ErabNotAdmittedItem> bearers);
...
private:
  ...
  std::vector <cv2x_EpcX2Sap::ErabAdmittedItem>     m_erabsAdmittedList; ///< ERABs admitted list
  std::vector <cv2x_EpcX2Sap::ErabNotAdmittedItem>  m_erabsNotAdmittedList; ///< ERABs not admitted list
};


/**
 * cv2x_EpcX2HandoverPreparationFailureHeader
 */
class cv2x_EpcX2HandoverPreparationFailureHeader : public Header
{
public:
  cv2x_EpcX2HandoverPreparationFailureHeader ();
  virtual ~cv2x_EpcX2HandoverPreparationFailureHeader ();
...
/**
 * cv2x_EpcX2SnStatusTransferHeader
 */
class cv2x_EpcX2SnStatusTransferHeader : public Header
{
public:
  cv2x_EpcX2SnStatusTransferHeader ();
  virtual ~cv2x_EpcX2SnStatusTransferHeader ();
   ...
   * \returns std::vector <cv2x_EpcX2Sap::ErabsSubjectToStatusTransferItem>
   */
  std::vector <cv2x_EpcX2Sap::ErabsSubjectToStatusTransferItem> GetErabsSubjectToStatusTransferList () const;
  /**
   * Set ERABs subject to status transfer list function
   * \param erabs std::vector <cv2x_EpcX2Sap::ErabsSubjectToStatusTransferItem>
   */
  void SetErabsSubjectToStatusTransferList (std::vector <cv2x_EpcX2Sap::ErabsSubjectToStatusTransferItem> erabs);
...
private:
  ...
  uint16_t          m_oldEnbUeX2apId; ///< old ENB UE X2 AP ID 
  uint16_t          m_newEnbUeX2apId; ///< new ENB UE X2 AP ID
  std::vector <cv2x_EpcX2Sap::ErabsSubjectToStatusTransferItem> m_erabsSubjectToStatusTransferList; ///< ERABs subject to status transfer list
};

/**
 * cv2x_EpcX2UeContextReleaseHeader
 */
class cv2x_EpcX2UeContextReleaseHeader : public Header
{
public:
  cv2x_EpcX2UeContextReleaseHeader ();
  virtual ~cv2x_EpcX2UeContextReleaseHeader ();
...
/**
 * cv2x_EpcX2LoadInformationHeader
 */
class cv2x_EpcX2LoadInformationHeader : public Header
{
public:
  cv2x_EpcX2LoadInformationHeader ();
  virtual ~cv2x_EpcX2LoadInformationHeader ();
   ...
   * \returns std::vector <cv2x_EpcX2Sap::CellInformationItem>
   */
  std::vector <cv2x_EpcX2Sap::CellInformationItem> GetCellInformationList () const;
  /**
   * Set cell information list function
   * \param cellInformationList std::vector <cv2x_EpcX2Sap::CellInformationItem> 
   */
  void SetCellInformationList (std::vector <cv2x_EpcX2Sap::CellInformationItem> cellInformationList);
...
private:
  ...
  std::vector <cv2x_EpcX2Sap::CellInformationItem> m_cellInformationList; ///< cell information list
};


/**
 * cv2x_EpcX2ResourceStatusUpdateHeader
 */
class cv2x_EpcX2ResourceStatusUpdateHeader : public Header
{
public:
  cv2x_EpcX2ResourceStatusUpdateHeader ();
  virtual ~cv2x_EpcX2ResourceStatusUpdateHeader ();
   ...
   */ 
  std::vector <cv2x_EpcX2Sap::CellMeasurementResultItem> GetCellMeasurementResultList () const;
  /**
   * Set cell measurement results list function
   * \param cellMeasurementResultList the cell measurement results list
   */
  void SetCellMeasurementResultList (std::vector <cv2x_EpcX2Sap::CellMeasurementResultItem> cellMeasurementResultList);
...
private:
  ...
  std::vector <cv2x_EpcX2Sap::CellMeasurementResultItem> m_cellMeasurementResultList; ///< cell measurement result list
};


} // namespace ns3

#endif // CV2X_EPC_X2_HEADER_H
