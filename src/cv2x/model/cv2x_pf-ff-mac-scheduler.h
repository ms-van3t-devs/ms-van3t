...
#ifndef CV2X_PF_FF_MAC_SCHEDULER_H
#define CV2X_PF_FF_MAC_SCHEDULER_H
...
/// cv2x_pfsFlowPerf_t structure
struct cv2x_pfsFlowPerf_t
{
...
class cv2x_PfFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_PfFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_PfFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_PfFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_PfFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_PfFfMacScheduler> class friend access  
  friend class cv2x_MemberSchedSapProvider<cv2x_PfFfMacScheduler>;
...
private:
  ...
  */
  std::multimap <uint16_t, std::map <uint8_t, cv2x_pfsFlowPerf_t> > m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::multimap <uint16_t, std::map <uint8_t, cv2x_pfsFlowPerf_t> > m_flowStatsUl;
...
#endif /* CV2X_PF_FF_MAC_SCHEDULER_H */
