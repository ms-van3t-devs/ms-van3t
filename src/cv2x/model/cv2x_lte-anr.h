...
#ifndef CV2X_LTE_ANR_H
#define CV2X_LTE_ANR_H
 ...
 *
 * The cv2x_LteHelper class automatically installs one ANR instance for each eNodeB
 ...
 *
 *     Config::SetDefault ("ns3::cv2x_LteHelper::AnrEnabled", BooleanValue (false));
 ...
 */
class cv2x_LteAnr : public Object
{
public:
  /**
   ...
   */
  cv2x_LteAnr (uint16_t servingCellId);
  virtual ~cv2x_LteAnr ();
   ...
   */
  virtual void SetLteAnrSapUser (cv2x_LteAnrSapUser* s);
   ...
   */
  virtual cv2x_LteAnrSapProvider* GetLteAnrSapProvider ();

  /// let the forwarder class access the protected and private members
  friend class cv2x_MemberLteAnrSapProvider<cv2x_LteAnr>;
...
private:
  ...
  /**
   * \brief Implementation of cv2x_LteAnrSapProvider::ReportUeMeas.
   * \param measResults a single report of one measurement identity
   */
  void DoReportUeMeas (cv2x_LteRrcSap::MeasResults measResults);

  /**
   * \brief Implementation of cv2x_LteAnrSapProvider::AddNeighbourRelation.
   * \param cellId the Physical Cell ID of the new neighbouring cell
   */
  void DoAddNeighbourRelation (uint16_t cellId);

  /**
   * \brief Implementation of cv2x_LteAnrSapProvider::GetNoRemove.
  ...
  /**
   * \brief Implementation of cv2x_LteAnrSapProvider::GetNoHo.
   * \param cellId the Physical Cell ID of the neighbouring cell of interest
  ...
  /**
   * \brief Implementation of cv2x_LteAnrSapProvider::GetNoX2.
   * \param cellId the Physical Cell ID of the neighbouring cell of interest
...
}; // end of class cv2x_LteAnr


} // end of namespace ns3


#endif /* CV2X_LTE_ANR_H */
