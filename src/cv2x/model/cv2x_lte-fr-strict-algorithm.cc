...
#include "cv2x_lte-fr-strict-algorithm.h"
#include <ns3/log.h>
#include "ns3/boolean.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("cv2x_LteFrStrictAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (cv2x_LteFrStrictAlgorithm);
...
cv2x_LteFrStrictAlgorithm::cv2x_LteFrStrictAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    ...
    m_measId (0)
{
  ...
  m_ffrSapProvider = new cv2x_MemberLteFfrSapProvider<cv2x_LteFrStrictAlgorithm> (this);
  m_ffrRrcSapProvider = new cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFrStrictAlgorithm> (this);
}
...
void
cv2x_LteFrStrictAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
cv2x_LteFrStrictAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::cv2x_LteFrStrictAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFrStrictAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFrStrictAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
cv2x_LteFrStrictAlgorithm::SetLteFfrSapUser (cv2x_LteFfrSapUser* s)
{
...
cv2x_LteFrStrictAlgorithm::GetLteFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::SetLteFfrRrcSapUser (cv2x_LteFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
cv2x_LteFrStrictAlgorithm::GetLteFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
cv2x_LteFrStrictAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
cv2x_LteFrStrictAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
cv2x_LteFrStrictAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFrStrictAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
cv2x_LteFrStrictAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFrStrictAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::DoReportDlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::DoReportUlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
cv2x_LteFrStrictAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
cv2x_LteFrStrictAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
cv2x_LteFrStrictAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFrStrictAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
cv2x_LteFrStrictAlgorithm::DoRecvLoadInformation (cv2x_EpcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
