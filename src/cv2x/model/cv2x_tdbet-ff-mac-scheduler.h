...
#ifndef CV2X_TDBET_FF_MAC_SCHEDULER_H
#define CV2X_TDBET_FF_MAC_SCHEDULER_H
...
/// cv2x_tdbetsFlowPerf_t structure
struct cv2x_tdbetsFlowPerf_t
{
...
class cv2x_TdBetFfMacScheduler : public cv2x_FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  cv2x_TdBetFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~cv2x_TdBetFfMacScheduler ();
  ...
  /// allow cv2x_MemberCschedSapProvider<cv2x_TdBetFfMacScheduler> class friend access
  friend class cv2x_MemberCschedSapProvider<cv2x_TdBetFfMacScheduler>;
  /// allow cv2x_MemberSchedSapProvider<cv2x_TdBetFfMacScheduler> class friend access
  friend class cv2x_MemberSchedSapProvider<cv2x_TdBetFfMacScheduler>;
...
private:
  ...
  */
  std::map <uint16_t, cv2x_tdbetsFlowPerf_t> m_flowStatsDl;

  /**
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, cv2x_tdbetsFlowPerf_t> m_flowStatsUl;
...
#endif /* CV2X_TDBET_FF_MAC_SCHEDULER_H */
