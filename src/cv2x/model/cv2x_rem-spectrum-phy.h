...
#ifndef CV2X_REM_SPECTRUM_PHY_H
#define CV2X_REM_SPECTRUM_PHY_H
 ...
 */
class cv2x_RemSpectrumPhy : public SpectrumPhy
{

public:
  cv2x_RemSpectrumPhy ();
  virtual ~cv2x_RemSpectrumPhy ();
