...
NS_LOG_COMPONENT_DEFINE ("cv2x_LteRlcAmHeader");

NS_OBJECT_ENSURE_REGISTERED (cv2x_LteRlcAmHeader);

cv2x_LteRlcAmHeader::cv2x_LteRlcAmHeader ()
  : m_headerLength (0),
...
void
cv2x_LteRlcAmHeader::SetDataPdu (void)
{
  m_headerLength = 4;
  m_dataControlBit = DATA_PDU;
}
void
cv2x_LteRlcAmHeader::SetControlPdu (uint8_t controlPduType)
{
  m_headerLength = 2;
...
bool
cv2x_LteRlcAmHeader::IsDataPdu (void) const
{
  return (m_dataControlBit == DATA_PDU) ? true : false;
}
bool
cv2x_LteRlcAmHeader::IsControlPdu (void) const
{
  return (m_dataControlBit == CONTROL_PDU) ? true : false;
}

void
cv2x_LteRlcAmHeader::SetFramingInfo (uint8_t framingInfo)
{
  m_framingInfo = framingInfo & 0x03;
}

void
cv2x_LteRlcAmHeader::SetSequenceNumber (cv2x_SequenceNumber10 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}

uint8_t
cv2x_LteRlcAmHeader::GetFramingInfo () const
{
  return m_framingInfo;
}

cv2x_SequenceNumber10
cv2x_LteRlcAmHeader::GetSequenceNumber () const
{
...
void
cv2x_LteRlcAmHeader::PushExtensionBit (uint8_t extensionBit)
{
...
void
cv2x_LteRlcAmHeader::PushLengthIndicator (uint16_t lengthIndicator)
{
...
uint8_t
cv2x_LteRlcAmHeader::PopExtensionBit (void)
{
...
uint16_t
cv2x_LteRlcAmHeader::PopLengthIndicator (void)
{
...
void
cv2x_LteRlcAmHeader::SetResegmentationFlag (uint8_t resegFlag)
{
  m_resegmentationFlag = resegFlag & 0x01;
}

uint8_t
cv2x_LteRlcAmHeader::GetResegmentationFlag () const
{
...
void
cv2x_LteRlcAmHeader::SetPollingBit (uint8_t pollingBit)
{
  m_pollingBit = pollingBit & 0x01;
}

uint8_t
cv2x_LteRlcAmHeader::GetPollingBit (void) const
{
  return m_pollingBit;
}
...
void
cv2x_LteRlcAmHeader::SetLastSegmentFlag (uint8_t lsf)
{
  m_lastSegmentFlag = lsf & 0x01;
}

uint8_t
cv2x_LteRlcAmHeader::GetLastSegmentFlag (void) const
{
...
void
cv2x_LteRlcAmHeader::SetSegmentOffset (uint16_t segmentOffset)
{
  m_segmentOffset = segmentOffset & 0x7FFF;
}

uint16_t
cv2x_LteRlcAmHeader::GetSegmentOffset (void) const
{
  return m_segmentOffset;
}

uint16_t
cv2x_LteRlcAmHeader::GetLastOffset (void) const
{
  return m_lastOffset;
}
...
void
cv2x_LteRlcAmHeader::SetAckSn (cv2x_SequenceNumber10 ackSn)
{
  m_ackSn = ackSn;
}

bool
cv2x_LteRlcAmHeader::OneMoreNackWouldFitIn (uint16_t bytes)
{
  NS_LOG_FUNCTION (this << bytes);
  NS_ASSERT_MSG (m_dataControlBit == CONTROL_PDU && m_controlPduType == cv2x_LteRlcAmHeader::STATUS_PDU,
...
void
cv2x_LteRlcAmHeader::PushNack (int nack)
{
...
bool
cv2x_LteRlcAmHeader::IsNackPresent (cv2x_SequenceNumber10 nack)
{
...
int
cv2x_LteRlcAmHeader::PopNack (void)
{
  NS_LOG_FUNCTION (this);
  NS_ASSERT_MSG (m_dataControlBit == CONTROL_PDU && m_controlPduType == cv2x_LteRlcAmHeader::STATUS_PDU,
                 "method allowed only for STATUS PDUs");
...
cv2x_SequenceNumber10
cv2x_LteRlcAmHeader::GetAckSn (void) const
{
  return m_ackSn;
}
...
TypeId
cv2x_LteRlcAmHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::cv2x_LteRlcAmHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
    .AddConstructor<cv2x_LteRlcAmHeader> ()
  ;
  return tid;
}

TypeId
cv2x_LteRlcAmHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

void
cv2x_LteRlcAmHeader::Print (std::ostream &os)  const
{
...
uint32_t cv2x_LteRlcAmHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void cv2x_LteRlcAmHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t cv2x_LteRlcAmHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  uint8_t byte_1;
  uint8_t byte_2;
