...
#include "cv2x_lte-ffr-enhanced-algorithm.h"
...
NS_LOG_COMPONENT_DEFINE ("cv2x_LteFfrEnhancedAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (cv2x_LteFfrEnhancedAlgorithm);
...
cv2x_LteFfrEnhancedAlgorithm::cv2x_LteFfrEnhancedAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    m_measId (0)
{
  NS_LOG_FUNCTION (this);
  m_ffrSapProvider = new cv2x_MemberLteFfrSapProvider<cv2x_LteFfrEnhancedAlgorithm> (this);
  m_ffrRrcSapProvider = new cv2x_MemberLteFfrRrcSapProvider<cv2x_LteFfrEnhancedAlgorithm> (this);
}
...
void
cv2x_LteFfrEnhancedAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
cv2x_LteFfrEnhancedAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::cv2x_LteFfrEnhancedAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFfrEnhancedAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&cv2x_LteFfrEnhancedAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
cv2x_LteFfrEnhancedAlgorithm::SetLteFfrSapUser (cv2x_LteFfrSapUser* s)
{
...
cv2x_LteFfrEnhancedAlgorithm::GetLteFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::SetLteFfrRrcSapUser (cv2x_LteFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
cv2x_LteFfrEnhancedAlgorithm::GetLteFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
cv2x_LteFfrEnhancedAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
int
cv2x_LteFfrEnhancedAlgorithm::GetCqiFromSpectralEfficiency (double s)
{
  NS_LOG_FUNCTION (s);
...
void
cv2x_LteFfrEnhancedAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
cv2x_LteFfrEnhancedAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
cv2x_LteFfrEnhancedAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFfrEnhancedAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
cv2x_LteFfrEnhancedAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
cv2x_LteFfrEnhancedAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::DoReportDlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  ...
  for (unsigned int i = 0; i < params.m_cqiList.size (); i++)
    {
      if ( params.m_cqiList.at (i).m_cqiType == cv2x_CqiListElement_s::A30 )
        {
          ...
          if (it == m_dlCqi.end ())
            {
              ...
              m_dlCqi.insert ( std::pair<uint16_t, cv2x_SbMeasResult_s > (rnti, params.m_cqiList.at (i).m_sbMeasResult) );
            }
          else
            {
...
void
cv2x_LteFfrEnhancedAlgorithm::DoReportUlCqiInfo (const struct cv2x_FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::DoReportUlCqiInfo ( std::map <uint16_t, std::vector <double> > ulCqiMap )
{
  NS_LOG_FUNCTION (this);
...
double
cv2x_LteFfrEnhancedAlgorithm::EstimateUlSinr (uint16_t rnti, uint16_t rb, std::map <uint16_t, std::vector <double> > ulCqiMap)
{
...
uint8_t
cv2x_LteFfrEnhancedAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
cv2x_LteFfrEnhancedAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
cv2x_LteFfrEnhancedAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
cv2x_LteFfrEnhancedAlgorithm::DoRecvLoadInformation (cv2x_EpcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
