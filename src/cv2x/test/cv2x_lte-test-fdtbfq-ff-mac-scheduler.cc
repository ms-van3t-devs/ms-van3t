...
#include "cv2x_lte-test-fdtbfq-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestFdTbfqFfMacScheduler");

cv2x_LenaTestFdTbfqFfMacSchedulerSuite::cv2x_LenaTestFdTbfqFfMacSchedulerSuite ()
  : TestSuite ("lte-fdtbfq-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestFdTbfqFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (1,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (3,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (6,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (12,0,183000,185000,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (1,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (3,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (6,4800,230500,125000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (12,4800,75250,62000,200,1,errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (1,6000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (3,6000,232000,201000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (6,6000,198500,97000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (12,6000,99250,48667,200,1, errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (1,10000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (3,10000,232000,137000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (6,10000,129166,67000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (12,10000,64583,32667,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail

  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (1,100000,0,0,200,1,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase2 (dist1,estThrFdTbfqDl1,packetSize1,1,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase2 (dist2,estThrFdTbfqDl2,packetSize2,1,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdTbfqFfMacSchedulerTestCase2 (dist3,estThrFdTbfqDl3,packetSize3,1,errorModel), TestCase::QUICK);

}

static cv2x_LenaTestFdTbfqFfMacSchedulerSuite lenaTestFdTbfqFfMacSchedulerSuite;

// --------------- T E S T - C A S E   # 1 ------------------------------


std::string 
cv2x_LenaFdTbfqFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaFdTbfqFfMacSchedulerTestCase1::cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval,bool errorModelEnabled)
...
cv2x_LenaFdTbfqFfMacSchedulerTestCase1::~cv2x_LenaFdTbfqFfMacSchedulerTestCase1 ()
{
}

void
cv2x_LenaFdTbfqFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  //LogComponentEnable ("cv2x_FdTbfqFfMacScheduler", LOG_DEBUG);
...
//   LogComponentDisableAll (LOG_LEVEL_ALL);
  ...
  lteHelper->SetSchedulerType ("ns3::cv2x_FdTbfqFfMacScheduler");
...
std::string 
cv2x_LenaFdTbfqFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<double> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
cv2x_LenaFdTbfqFfMacSchedulerTestCase2::cv2x_LenaFdTbfqFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrFdTbfqDl, std::vector<uint16_t> packetSize, uint16_t interval,bool errorModelEnabled)
...
cv2x_LenaFdTbfqFfMacSchedulerTestCase2::~cv2x_LenaFdTbfqFfMacSchedulerTestCase2 ()
{
}

void
cv2x_LenaFdTbfqFfMacSchedulerTestCase2::DoRun (void)
{
