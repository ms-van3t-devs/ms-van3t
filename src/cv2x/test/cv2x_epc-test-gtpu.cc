...
#include "cv2x_epc-test-gtpu.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_EpcGtpuTest");

/**
 * TestSuite
 */

cv2x_EpsGtpuTestSuite::cv2x_EpsGtpuTestSuite ()
  : TestSuite ("epc-gtpu", SYSTEM)
{
  AddTestCase (new cv2x_EpsGtpuHeaderTestCase (), TestCase::QUICK);
}

static cv2x_EpsGtpuTestSuite epsGtpuTestSuite;
...
cv2x_EpsGtpuHeaderTestCase::cv2x_EpsGtpuHeaderTestCase ()
  : TestCase ("Check header coding and decoding")
{
  NS_LOG_INFO ("Creating cv2x_EpsGtpuHeaderTestCase");
}
...
void
cv2x_EpsGtpuHeaderTestCase::DoRun (void)
{
