...
#ifndef CV2X_LTE_SIMPLE_SPECTRUM_PHY_H
#define CV2X_LTE_SIMPLE_SPECTRUM_PHY_H
 ...
 * \ingroup lte
 *
 * The cv2x_LteSimpleSpectrumPhy models the physical layer of LTE
...
class cv2x_LteSimpleSpectrumPhy : public SpectrumPhy
{

public:
  cv2x_LteSimpleSpectrumPhy ();
  virtual ~cv2x_LteSimpleSpectrumPhy ();
...
#endif /* CV2X_LTE_SIMPLE_SPECTRUM_PHY_H */
