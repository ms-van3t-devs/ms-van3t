...
#ifndef CV2X_LENA_TEST_FDBET_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_FDBET_FF_MAC_SCHEDULER_H
 ...
 * scheduling
 */
class cv2x_LenaFdBetFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaFdBetFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl,bool errorModelEnabled);
  virtual ~cv2x_LenaFdBetFfMacSchedulerTestCase1 ();
 ...
 * cv2x_LenaFdBetFfMacSchedulerTestCase1, with the difference that UEs are 
 * placed in such a way to experience different SINRs from eNodeB.
 */
class cv2x_LenaFdBetFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param errorModelEnabled error model enabled?
   */
  cv2x_LenaFdBetFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> achievableRateDl, std::vector<uint32_t> estThrFdBetUl, bool errorModelEnabled);
  virtual ~cv2x_LenaFdBetFfMacSchedulerTestCase2 ();
...
class cv2x_LenaTestFdBetFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestFdBetFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_FDBET_FF_MAC_SCHEDULER_H */
