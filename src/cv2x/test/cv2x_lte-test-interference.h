...
#ifndef CV2X_LTE_TEST_INTERFERENCE_H
#define CV2X_LTE_TEST_INTERFERENCE_H
 ...
 */
class cv2x_LteInterferenceTestSuite : public TestSuite
{
public:
  cv2x_LteInterferenceTestSuite ();
};
 ...
 */
class cv2x_LteInterferenceTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteInterferenceTestCase (std::string name, double d1, double d2, double dlSinr, double ulSinr, double dlSe, double ulSe, uint16_t dlMcs, uint16_t ulMcs);
  virtual ~cv2x_LteInterferenceTestCase ();
...
#endif /* CV2X_LTE_TEST_INTERFERENCE_H */
