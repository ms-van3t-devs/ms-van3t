...
#ifndef CV2X_LENA_TEST_TDTBFQ_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_TDTBFQ_FF_MAC_SCHEDULER_H
 ...
 * queue scheduling
 */
class cv2x_LenaTdTbfqFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaTdTbfqFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaTdTbfqFfMacSchedulerTestCase1 ();
 ...
 */
class cv2x_LenaTdTbfqFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param errorModelEnabled if true the error model is enabled
   */
  cv2x_LenaTdTbfqFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrTdTbfqDl, std::vector<uint16_t> packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaTdTbfqFfMacSchedulerTestCase2 ();
 ...
 * \ingroup tests
 *
 * \brief Test suite for cv2x_TdTbfqFfMacScheduler test.
 */
class cv2x_LenaTestTdTbfqFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestTdTbfqFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_TDTBFQ_FF_MAC_SCHEDULER_H */
