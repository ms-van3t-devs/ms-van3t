...
#ifndef CV2X_LTE_TEST_UE_MEASUREMENTS_H
#define CV2X_LTE_TEST_UE_MEASUREMENTS_H
 ...
 */
class cv2x_LteUeMeasurementsTestSuite : public TestSuite
{
public:
  cv2x_LteUeMeasurementsTestSuite ();
};
 ...
 */
class cv2x_LteUeMeasurementsTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteUeMeasurementsTestCase (std::string name, double d1, double d2, double rsrpDbmUe1, double rsrpDbmUe2, double rsrqDbUe1, double rsrqDbUe2);
  virtual ~cv2x_LteUeMeasurementsTestCase ();
   ...
   * \param cellId the cell ID
   * \param rnti the RNTI
   * \param meas cv2x_LteRrcSap::MeasurementReport
   */
  void RecvMeasurementReport (uint64_t imsi, uint16_t cellId, uint16_t rnti, cv2x_LteRrcSap::MeasurementReport meas);
 ...
 *        ns3::cv2x_LteUeMeasurementsPiecewiseTestCase1.
 */
class cv2x_LteUeMeasurementsPiecewiseTestSuite1 : public TestSuite
{
public:
  cv2x_LteUeMeasurementsPiecewiseTestSuite1 ();
};
 ...
 */
class cv2x_LteUeMeasurementsPiecewiseTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * `cv2x_LteUeRrc::RecvMeasurementReport` trace source.
   *
   ...
   * \param cellId the cell ID
   * \param rnti  the RNTI
   * \param report cv2x_LteRrcSap::MeasurementReport
   */
...
private:
   ...
   */
  cv2x_LteRrcSap::ReportConfigEutra m_config;
...
}; // end of class cv2x_LteUeMeasurementsPiecewiseTestCase1
 ...
 *
 * \brief Test suite for generating calls to UE measurements test case
 *        ns3::cv2x_LteUeMeasurementsPiecewiseTestCase2.
 */
class cv2x_LteUeMeasurementsPiecewiseTestSuite2 : public TestSuite
{
public:
  cv2x_LteUeMeasurementsPiecewiseTestSuite2 ();
};
 ...
 *        
 */
class cv2x_LteUeMeasurementsPiecewiseTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param expectedRsrp the expected RSRP
   */
  cv2x_LteUeMeasurementsPiecewiseTestCase2 (std::string name,
                                       cv2x_LteRrcSap::ReportConfigEutra config,
                                       std::vector<Time> expectedTime,
                                       std::vector<uint8_t> expectedRsrp);

  virtual ~cv2x_LteUeMeasurementsPiecewiseTestCase2 ();
...
}; // end of class cv2x_LteUeMeasurementsPiecewiseTestCase2
 ...
 *
 * \brief Test suite for generating calls to UE measurements test case
 *        ns3::cv2x_LteUeMeasurementsHandoverTestCase.
 */
class cv2x_LteUeMeasurementsHandoverTestSuite : public TestSuite
{
public:
  cv2x_LteUeMeasurementsHandoverTestSuite ();
};
 ...
 * 
 */
class cv2x_LteUeMeasurementsHandoverTestCase : public TestCase
{
public:
  /**
   * Constructor
   *
   * \param name the reference name
   * \param sourceConfigList std::list<cv2x_LteRrcSap::ReportConfigEutra>
   * \param targetConfigList std::list<cv2x_LteRrcSap::ReportConfigEutra>
   * \param expectedTime the expected time
   * \param expectedRsrp the expected RSRP
   * \param duration the duration
   */
  cv2x_LteUeMeasurementsHandoverTestCase (std::string name,
  ...
  virtual ~cv2x_LteUeMeasurementsHandoverTestCase ();
...
private:
   ...
   *        eNodeB.
   */
  std::list<cv2x_LteRrcSap::ReportConfigEutra> m_sourceConfigList;

  /**
   * \brief The list of active report triggering configuration for the target
   *        eNodeB.
   */
  std::list<cv2x_LteRrcSap::ReportConfigEutra> m_targetConfigList;
...
}; // end of class cv2x_LteUeMeasurementsHandoverTestCase

#endif /* CV2X_LTE_TEST_UE_MEASUREMENTS_H */
