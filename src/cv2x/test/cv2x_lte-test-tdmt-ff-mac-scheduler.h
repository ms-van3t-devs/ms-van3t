...
#ifndef CV2X_LENA_TEST_TDMT_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_TDMT_FF_MAC_SCHEDULER_H
 ...
 * scheduling
 */
class cv2x_LenaTdMtFfMacSchedulerTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaTdMtFfMacSchedulerTestCase (uint16_t nUser, double dist, double thrRefDl, double thrRefUl,bool errorModelEnabled);
  virtual ~cv2x_LenaTdMtFfMacSchedulerTestCase ();
 ...
 * \ingroup tests
 *
 * \brief Test suite for cv2x_TdMtFfMacScheduler tests.
 */
class cv2x_LenaTestTdMtFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestTdMtFfMacSchedulerSuite ();
};




#endif /* CV2X_LENA_TEST_TDMT_FF_MAC_SCHEDULER_H */
