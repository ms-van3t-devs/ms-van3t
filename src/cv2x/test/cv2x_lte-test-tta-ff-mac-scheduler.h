...
#ifndef CV2X_LENA_TEST_TTA_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_TTA_FF_MAC_SCHEDULER_H
 ...
 * scheduling
 */
class cv2x_LenaTtaFfMacSchedulerTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaTtaFfMacSchedulerTestCase (uint16_t nUser, double dist, double thrRefDl, double thrRefUl,bool errorModelEnabled);
  virtual ~cv2x_LenaTtaFfMacSchedulerTestCase ();
 ...
 */
class cv2x_LenaTestTtaFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestTtaFfMacSchedulerSuite ();
};




#endif /* CV2X_LENA_TEST_TTA_FF_MAC_SCHEDULER_H */
