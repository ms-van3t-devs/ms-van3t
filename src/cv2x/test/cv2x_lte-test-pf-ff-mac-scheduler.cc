...
#include "cv2x_lte-test-pf-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestPfFfMacScheduler");

cv2x_LenaTestPfFfMacSchedulerSuite::cv2x_LenaTestPfFfMacSchedulerSuite ()
  : TestSuite ("lte-pf-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestPfFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,0,2196000,2292000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (3,0,732000,749000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (6,0,366000,373000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (12,0,183000,184670,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (15,0,146400,147730,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,4800,1383000,807000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (3,4800,461000,253000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (6,4800,230500,125000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (12,4800,115250,62000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (15,4800,92200,49600,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,6000,1191000,621000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (3,6000,397000,201000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (6,6000,198500,97000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (12,6000,99250,48667,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (15,6000,79400,38993,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,10000,775000,437000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (3,10000,258333,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (6,10000,129167,67000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (12,10000,64583,32667,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (15,10000,51667,26133,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,20000,421000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (3,20000,140333,41000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (6,20000,70167,22000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (12,20000,35083,12000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (15,20000,28067,9600,errorModel), TestCase::EXTENSIVE);

  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase1 (1,100000,0,0,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaPfFfMacSchedulerTestCase2 (dist, estThrPfDl, estThrPfUl,errorModel), TestCase::QUICK);


}

static cv2x_LenaTestPfFfMacSchedulerSuite lenaTestPfFfMacSchedulerSuite;
...
std::string 
cv2x_LenaPfFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaPfFfMacSchedulerTestCase1::cv2x_LenaPfFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled)
...
cv2x_LenaPfFfMacSchedulerTestCase1::~cv2x_LenaPfFfMacSchedulerTestCase1 ()
{
}

void
cv2x_LenaPfFfMacSchedulerTestCase1::DoRun (void)
{
...
std::string 
cv2x_LenaPfFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<double> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
cv2x_LenaPfFfMacSchedulerTestCase2::cv2x_LenaPfFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrPfDl, std::vector<uint32_t> estThrPfUl, bool errorModelEnabled)
...
cv2x_LenaPfFfMacSchedulerTestCase2::~cv2x_LenaPfFfMacSchedulerTestCase2 ()
{
}

void
cv2x_LenaPfFfMacSchedulerTestCase2::DoRun (void)
{
