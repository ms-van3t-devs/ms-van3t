...
#include "cv2x_lte-test-cell-selection.h"
...
NS_LOG_COMPONENT_DEFINE ("cv2x_LteCellSelectionTest");
...
cv2x_LteCellSelectionTestSuite::cv2x_LteCellSelectionTestSuite ()
  : TestSuite ("lte-cell-selection", SYSTEM)
{
  std::vector<cv2x_LteCellSelectionTestCase::UeSetup_t> w;
  ...
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (0.0, 0.55, false,
                                                    MilliSeconds (283), 1, 0));
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (0.0, 0.45, false,
                                                    MilliSeconds (283), 1, 0));
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (0.5, 0.45, false,
                                                    MilliSeconds (363), 1, 3));
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (0.5, 0.0,  true,
                                                    MilliSeconds (283), 2, 4));
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (1.0, 0.55, true,
                                                    MilliSeconds (283), 3, 0));
  w.push_back (cv2x_LteCellSelectionTestCase::UeSetup_t (1.0, 0.45, true,
                                                    MilliSeconds (283), 4, 0));

  AddTestCase (new cv2x_LteCellSelectionTestCase ("EPC, real RRC, RngNum=1",
                                             true, false, 60.0, w, 1),
               //                                        isd       rngrun
               TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteCellSelectionTestCase ("EPC, ideal RRC, RngNum=1",
                                             true, true, 60.0, w, 1),
               //                                        isd      rngrun
               TestCase::QUICK);

} // end of cv2x_LteCellSelectionTestSuite::cv2x_LteCellSelectionTestSuite ()


static cv2x_LteCellSelectionTestSuite g_lteCellSelectionTestSuite;
...
cv2x_LteCellSelectionTestCase::UeSetup_t::UeSetup_t (
...
cv2x_LteCellSelectionTestCase::cv2x_LteCellSelectionTestCase (
    ...
    m_rngRun (rngRun)
{
  ...
  m_lastState.resize (m_ueSetupList.size (), cv2x_LteUeRrc::NUM_STATES);
}
...
void
cv2x_LteCellSelectionTestCase::DoRun ()
{
  NS_LOG_FUNCTION (this << GetName ());
  ...
  Ptr<cv2x_PointToPointEpcHelper> epcHelper;

  if (m_isEpcMode)
    {
      epcHelper = CreateObject<cv2x_PointToPointEpcHelper> ();
  ...
  for (itSetup = m_ueSetupList.begin (), itNode = ueNodes.Begin ();
       ...
       itSetup++, itNode++)
    {
      ...
      Ptr<cv2x_LteUeNetDevice> ueDev = devs.Get (0)->GetObject<cv2x_LteUeNetDevice> ();
      NS_ASSERT (ueDev != 0);
      ueDevs.Add (devs);
      Simulator::Schedule (itSetup->checkPoint,
                           &cv2x_LteCellSelectionTestCase::CheckPoint,
                           this, ueDev,
  ...
  for (itSetup = m_ueSetupList.begin (), itDev = ueDevs.Begin ();
       ...
       itSetup++, itDev++)
    {
      Ptr<cv2x_LteUeNetDevice> ueDev = (*itDev)->GetObject<cv2x_LteUeNetDevice> ();
    }
  ...
  Config::Connect ("/NodeList/*/DeviceList/*/cv2x_LteUeRrc/StateTransition",
                   MakeCallback (&cv2x_LteCellSelectionTestCase::StateTransitionCallback,
                                 this));
  Config::Connect ("/NodeList/*/DeviceList/*/cv2x_LteUeRrc/InitialCellSelectionEndOk",
                   MakeCallback (&cv2x_LteCellSelectionTestCase::InitialCellSelectionEndOkCallback,
                                 this));
  Config::Connect ("/NodeList/*/DeviceList/*/cv2x_LteUeRrc/InitialCellSelectionEndError",
                   MakeCallback (&cv2x_LteCellSelectionTestCase::InitialCellSelectionEndErrorCallback,
                                 this));
  Config::Connect ("/NodeList/*/DeviceList/*/cv2x_LteUeRrc/ConnectionEstablished",
                   MakeCallback (&cv2x_LteCellSelectionTestCase::ConnectionEstablishedCallback,
                                 this));
...
} // end of void cv2x_LteCellSelectionTestCase::DoRun ()


void
cv2x_LteCellSelectionTestCase::CheckPoint (Ptr<cv2x_LteUeNetDevice> ueDev,
...
void
cv2x_LteCellSelectionTestCase::StateTransitionCallback (
...
void
cv2x_LteCellSelectionTestCase::InitialCellSelectionEndOkCallback (
...
void
cv2x_LteCellSelectionTestCase::InitialCellSelectionEndErrorCallback (
  std::string context, uint64_t imsi, uint16_t cellId)
{
  NS_LOG_FUNCTION (this << imsi << cellId);
}
...
void
cv2x_LteCellSelectionTestCase::ConnectionEstablishedCallback (
  std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti)
{
