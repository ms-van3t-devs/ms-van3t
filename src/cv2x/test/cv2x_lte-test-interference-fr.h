...
#ifndef CV2X_LTE_TEST_INTERFERENCE_FR_H
#define CV2X_LTE_TEST_INTERFERENCE_FR_H
 ...
 * theoretical values.
 */
class cv2x_LteInterferenceFrTestSuite : public TestSuite
{
public:
  cv2x_LteInterferenceFrTestSuite ();
};
 ...
 */
class cv2x_LteInterferenceHardFrTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteInterferenceHardFrTestCase (std::string name, double d1, double d2, double dlSinr, double ulSinr);
  virtual ~cv2x_LteInterferenceHardFrTestCase ();
 ...
 */
class cv2x_LteInterferenceStrictFrTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteInterferenceStrictFrTestCase (std::string name, double d1, double d2,
                                   double commonDlSinr, double commonUlSinr, double edgeDlSinr, double edgeUlSinr,
                                   uint32_t rspqThreshold);
  virtual ~cv2x_LteInterferenceStrictFrTestCase ();
...
#endif /* CV2X_LTE_TEST_INTERFERENCE_FR_H */
