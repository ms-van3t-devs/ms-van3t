...
#include "cv2x_lte-test-fdbet-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestFdBetFfMacScheduler");

cv2x_LenaTestFdBetFfMacSchedulerSuite::cv2x_LenaTestFdBetFfMacSchedulerSuite ()
  : TestSuite ("lte-fdbet-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestFdBetFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,0,2196000,2292000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (3,0,749000,749000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (6,0,373000,373000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (12,0,185000,184670, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,4800,1383000,807000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (3,4800,469000,253000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (6,4800,233500,125000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (12,4800,113000,62000, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,6000,1191000,621000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (3,6000,389000,201000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (6,6000,193000,97000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (12,6000,97000,48667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,10000,775000,421000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (3,10000,253000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (6,10000,125000,67000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (12,10000,61000,32667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,20000,421000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (3,20000,137000,41000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (6,20000,67000,22000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (12,20000,32000,12000,errorModel), TestCase::EXTENSIVE);

  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase1 (1,100000,0,0,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaFdBetFfMacSchedulerTestCase2 (dist, estAchievableRateDl, estThrFdBetUl, errorModel), TestCase::QUICK);
}

static cv2x_LenaTestFdBetFfMacSchedulerSuite lenaTestFdBetFfMacSchedulerSuite;
...
std::string 
cv2x_LenaFdBetFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaFdBetFfMacSchedulerTestCase1::cv2x_LenaFdBetFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled)
...
cv2x_LenaFdBetFfMacSchedulerTestCase1::~cv2x_LenaFdBetFfMacSchedulerTestCase1 ()
{
}

void
cv2x_LenaFdBetFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  lteHelper->SetSchedulerType ("ns3::cv2x_FdBetFfMacScheduler");
...
std::string 
cv2x_LenaFdBetFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<double> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
cv2x_LenaFdBetFfMacSchedulerTestCase2::cv2x_LenaFdBetFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> achievableRateDl, std::vector<uint32_t> estThrFdBetUl, bool errorModelEnabled)
...
cv2x_LenaFdBetFfMacSchedulerTestCase2::~cv2x_LenaFdBetFfMacSchedulerTestCase2 ()
{
}

void
cv2x_LenaFdBetFfMacSchedulerTestCase2::DoRun (void)
{
