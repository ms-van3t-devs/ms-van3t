...
#ifndef CV2X_LTE_TEST_DOWNLINK_FR_H
#define CV2X_LTE_TEST_DOWNLINK_FR_H
 ...
 */
class cv2x_LteFrequencyReuseTestSuite : public TestSuite
{
public:
  cv2x_LteFrequencyReuseTestSuite ();
};
 ...
 *  are being used.
 */
class cv2x_LteFrTestCase : public TestCase
{
public:
  /**
   * Constructor
 ...
 */
class cv2x_LteHardFrTestCase : public cv2x_LteFrTestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteHardFrTestCase (std::string name, uint32_t userNum,
                     ...
                     std::vector<bool> availableDlRb, std::vector<bool> availableUlRb);
  virtual ~cv2x_LteHardFrTestCase ();
 ...
 *  are being used.
 */
class cv2x_LteStrictFrTestCase : public cv2x_LteFrTestCase
{
public:
  /**
   * Constructor
   ...
   * \param availableUlRb the avaialbel UL per RB
   */
  cv2x_LteStrictFrTestCase (std::string name, uint32_t userNum,
                       std::string schedulerType,
                       uint8_t dlBandwidth, uint8_t ulBandwidth,
                       ...
                       std::vector<bool> availableDlRb, std::vector<bool> availableUlRb);
  virtual ~cv2x_LteStrictFrTestCase ();
 ...
 */
class cv2x_LteFrAreaTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteFrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteFrAreaTestCase ();
 ...
 */
class cv2x_LteStrictFrAreaTestCase : public cv2x_LteFrAreaTestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteStrictFrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteStrictFrAreaTestCase ();
 ...
 */
class cv2x_LteSoftFrAreaTestCase : public cv2x_LteFrAreaTestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteSoftFrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteSoftFrAreaTestCase ();
 ...
 */
class cv2x_LteSoftFfrAreaTestCase : public cv2x_LteFrAreaTestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteSoftFfrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteSoftFfrAreaTestCase ();
 ...
 */
class cv2x_LteEnhancedFfrAreaTestCase : public cv2x_LteFrAreaTestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteEnhancedFfrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteEnhancedFfrAreaTestCase ();
 ...
 */
class cv2x_LteDistributedFfrAreaTestCase : public cv2x_LteFrAreaTestCase
{
public:
  /**
   * Constructor
   ...
   * \param schedulerType the scheduler type
   */
  cv2x_LteDistributedFfrAreaTestCase (std::string name, std::string schedulerType);
  virtual ~cv2x_LteDistributedFfrAreaTestCase ();
...
#endif /* CV2X_LTE_TEST_DOWNLINK_FR_H */
