...
cpp_examples = [
    ...
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_TtaFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_TdTbfqFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_TdMtFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_TdBetFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_RrFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_PssFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_PfFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_FdTbfqFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_FdMtFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-epc --simTime=1.1 --ns3::cv2x_LteHelper::Scheduler=ns3::cv2x_FdBetFfMacScheduler", "options.valgrind", "True"),
