...
#ifndef CV2X_LENA_TEST_PF_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_PF_FF_MAC_SCHEDULER_H
 ...
 * fair scheduling
 */
class cv2x_LenaPfFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaPfFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled);
  virtual ~cv2x_LenaPfFfMacSchedulerTestCase1 ();
 ...
 */
class cv2x_LenaPfFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param errorModelEnabled if true the error model is enabled
   */
  cv2x_LenaPfFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrPfDl, std::vector<uint32_t> estThrPfUl, bool errorModelEnabled);
  virtual ~cv2x_LenaPfFfMacSchedulerTestCase2 ();
 ...
 * \ingroup tests
 *
 * \brief cv2x_PfFfMacScheduler test suite
 */

class cv2x_LenaTestPfFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestPfFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_PF_FF_MAC_SCHEDULER_H */
