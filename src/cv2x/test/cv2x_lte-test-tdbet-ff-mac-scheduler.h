...
#ifndef CV2X_LENA_TEST_TDBET_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_TDBET_FF_MAC_SCHEDULER_H
 ...
 * scheduling
 */
class cv2x_LenaTdBetFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaTdBetFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl,bool errorModelEnabled);
  virtual ~cv2x_LenaTdBetFfMacSchedulerTestCase1 ();
 ...
 */
class cv2x_LenaTdBetFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param errorModelEnabled indicates whether the error model is enabled
   */
  cv2x_LenaTdBetFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> achievableRateDl, std::vector<uint32_t> estThrTdBetUl, bool errorModelEnabled);
  virtual ~cv2x_LenaTdBetFfMacSchedulerTestCase2 ();
 ...
 * \ingroup tests
 *
 * \brief Test suite for cv2x_TdBetFfMacScheduler tests.
 */
class cv2x_LenaTestTdBetFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestTdBetFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_TDBET_FF_MAC_SCHEDULER_H */
