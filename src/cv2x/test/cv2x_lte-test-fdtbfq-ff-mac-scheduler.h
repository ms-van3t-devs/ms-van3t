...
#ifndef CV2X_LENA_TEST_FDTBFQ_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_FDTBFQ_FF_MAC_SCHEDULER_H
 ...
 * queue scheduling
 */
class cv2x_LenaFdTbfqFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaFdTbfqFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaFdTbfqFfMacSchedulerTestCase1 ();
 ...
 * cv2x_LenaFdTbfqFfMacSchedulerTestCase1, with the difference that UEs are 
 * placed in such a way to experience different SINRs from eNodeB.
 */
class cv2x_LenaFdTbfqFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaFdTbfqFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrFdTbfqDl, std::vector<uint16_t> packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaFdTbfqFfMacSchedulerTestCase2 ();
 ...
 * \ingroup tests
 *
 * \brief Test suit for cv2x_FdTbfqFfMacScheduler test.
 */
class cv2x_LenaTestFdTbfqFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestFdTbfqFfMacSchedulerSuite ();
};



#endif /* CV2X_LENA_TEST_FDTBFQ_FF_MAC_SCHEDULER_H */
