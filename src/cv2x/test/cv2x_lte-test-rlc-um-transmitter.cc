...
#include "cv2x_lte-test-rlc-um-transmitter.h"
#include "cv2x_lte-test-entities.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LteRlcUmTransmitterTest");

/**
 * TestSuite 4.1.1 RLC UM: Only transmitter
 */

cv2x_LteRlcUmTransmitterTestSuite::cv2x_LteRlcUmTransmitterTestSuite ()
  : TestSuite ("lte-rlc-um-transmitter", SYSTEM)
{
  // LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
  // LogComponentEnable ("cv2x_LteRlcUmTransmitterTest", logLevel);

  // NS_LOG_INFO ("Creating cv2x_LteRlcUmTransmitterTestSuite");

  AddTestCase (new cv2x_LteRlcUmTransmitterOneSduTestCase ("One SDU, one PDU"), TestCase::QUICK);
  AddTestCase (new cv2x_LteRlcUmTransmitterSegmentationTestCase ("Segmentation"), TestCase::QUICK);
  AddTestCase (new cv2x_LteRlcUmTransmitterConcatenationTestCase ("Concatenation"), TestCase::QUICK);
  AddTestCase (new cv2x_LteRlcUmTransmitterReportBufferStatusTestCase ("ReportBufferStatus primitive"), TestCase::QUICK);

}

static cv2x_LteRlcUmTransmitterTestSuite lteRlcUmTransmitterTestSuite;


cv2x_LteRlcUmTransmitterTestCase::cv2x_LteRlcUmTransmitterTestCase (std::string name)
  : TestCase (name)
{
  // NS_LOG_UNCOND ("Creating cv2x_LteRlcUmTransmitterTestCase: " + name);
}

cv2x_LteRlcUmTransmitterTestCase::~cv2x_LteRlcUmTransmitterTestCase ()
{
}

void
cv2x_LteRlcUmTransmitterTestCase::DoRun (void)
{
  // LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
  // LogComponentEnable ("cv2x_LteRlcUmTransmitterTest", logLevel);
  // LogComponentEnable ("LteTestEntities", logLevel);
  // LogComponentEnable ("cv2x_LteRlc", logLevel);
  // LogComponentEnable ("cv2x_LteRlcUm", logLevel);
  ...
  txRlc = CreateObject<cv2x_LteRlcUm> ();
  txRlc->SetRnti (rnti);
  txRlc->SetLcId (lcid);

  // Create transmission MAC test entity
  txMac = CreateObject<cv2x_LteTestMac> ();
  txMac->SetRlcHeaderType (cv2x_LteTestMac::UM_RLC_HEADER);
...
void
cv2x_LteRlcUmTransmitterTestCase::CheckDataReceived (Time time, std::string shouldReceived, std::string assertMsg)
{
  Simulator::Schedule (time, &cv2x_LteRlcUmTransmitterTestCase::DoCheckDataReceived, this, shouldReceived, assertMsg);
}

void
cv2x_LteRlcUmTransmitterTestCase::DoCheckDataReceived (std::string shouldReceived, std::string assertMsg)
{
 ...
 */
cv2x_LteRlcUmTransmitterOneSduTestCase::cv2x_LteRlcUmTransmitterOneSduTestCase (std::string name)
  : cv2x_LteRlcUmTransmitterTestCase (name)
{
}

cv2x_LteRlcUmTransmitterOneSduTestCase::~cv2x_LteRlcUmTransmitterOneSduTestCase ()
{
}

void
cv2x_LteRlcUmTransmitterOneSduTestCase::DoRun (void)
{
  // Create topology
  cv2x_LteRlcUmTransmitterTestCase::DoRun ();
 ...
 */
cv2x_LteRlcUmTransmitterSegmentationTestCase::cv2x_LteRlcUmTransmitterSegmentationTestCase (std::string name)
  : cv2x_LteRlcUmTransmitterTestCase (name)
{
}

cv2x_LteRlcUmTransmitterSegmentationTestCase::~cv2x_LteRlcUmTransmitterSegmentationTestCase ()
{
}

void
cv2x_LteRlcUmTransmitterSegmentationTestCase::DoRun (void)
{
  // Create topology
  cv2x_LteRlcUmTransmitterTestCase::DoRun ();
 ...
 */
cv2x_LteRlcUmTransmitterConcatenationTestCase::cv2x_LteRlcUmTransmitterConcatenationTestCase (std::string name)
  : cv2x_LteRlcUmTransmitterTestCase (name)
{
}

cv2x_LteRlcUmTransmitterConcatenationTestCase::~cv2x_LteRlcUmTransmitterConcatenationTestCase ()
{
}

void
cv2x_LteRlcUmTransmitterConcatenationTestCase::DoRun (void)
{
  // Create topology
  cv2x_LteRlcUmTransmitterTestCase::DoRun ();
 ...
 */
cv2x_LteRlcUmTransmitterReportBufferStatusTestCase::cv2x_LteRlcUmTransmitterReportBufferStatusTestCase (std::string name)
  : cv2x_LteRlcUmTransmitterTestCase (name)
{
}

cv2x_LteRlcUmTransmitterReportBufferStatusTestCase::~cv2x_LteRlcUmTransmitterReportBufferStatusTestCase ()
{
}

void
cv2x_LteRlcUmTransmitterReportBufferStatusTestCase::DoRun (void)
{
  // Create topology
  cv2x_LteRlcUmTransmitterTestCase::DoRun ();
