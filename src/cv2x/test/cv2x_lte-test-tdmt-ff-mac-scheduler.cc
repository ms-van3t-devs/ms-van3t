...
#include "cv2x_lte-test-tdmt-ff-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestTdMtFfMacScheduler");

cv2x_LenaTestTdMtFfMacSchedulerSuite::cv2x_LenaTestTdMtFfMacSchedulerSuite ()
  : TestSuite ("lte-tdmt-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestTdMtFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,0,2196000,2292000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (3,0,2196000,749000,errorModel), TestCase::QUICK);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (6,0,2196000,373000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (12,0,2196000,184670, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,4800,1383000,807000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (3,4800,1383000,253000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (6,4800,1383000,125000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (12,4800,1383000,62000,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,6000,1191000,621000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (3,6000,1191000,201000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (6,6000,1191000,97000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (12,6000,1191000,48667, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,10000,775000,437000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (3,10000,775000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (6,10000,775000,67000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (12,10000,775000,32667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,20000,421000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (3,20000,421000,41000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (6,20000,421000,22000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (12,20000,421000,12000,errorModel), TestCase::EXTENSIVE);

  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaTdMtFfMacSchedulerTestCase (1,100000,0,0,errorModel), TestCase::QUICK);
}

static cv2x_LenaTestTdMtFfMacSchedulerSuite lenaTestTdMtFfMacSchedulerSuite;


// --------------- T E S T - C A S E ------------------------------

std::string 
cv2x_LenaTdMtFfMacSchedulerTestCase::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaTdMtFfMacSchedulerTestCase::cv2x_LenaTdMtFfMacSchedulerTestCase (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled)
...
cv2x_LenaTdMtFfMacSchedulerTestCase::~cv2x_LenaTdMtFfMacSchedulerTestCase ()
{
}


void
cv2x_LenaTdMtFfMacSchedulerTestCase::DoRun (void)
{
  ...
  lteHelper->SetSchedulerType ("ns3::cv2x_TdMtFfMacScheduler");
