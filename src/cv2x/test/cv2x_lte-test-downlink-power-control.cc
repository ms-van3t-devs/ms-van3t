...
#include "cv2x_lte-test-downlink-power-control.h"
#include <ns3/cv2x_lte-rrc-sap.h>

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LteDownlinkPowerControlTest");

/**
 * TestSuite
 */

cv2x_LteDownlinkPowerControlTestSuite::cv2x_LteDownlinkPowerControlTestSuite ()
...
//  LogComponentEnable ("LteDownlinkPowerControlTest", logLevel);
  NS_LOG_INFO ("Creating cv2x_LteDownlinkPowerControlTestSuite");
  ...
  // Spectrum helper test
  {
    ...
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert (std::pair<int,double>(0, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_3);
    powerTxMap.insert (std::pair<int,double>(2, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB0);
    powerTxMap.insert (std::pair<int,double>(3, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB2);
    ...
    AddTestCase (new cv2x_LteDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb6run1earfcn500_allRbPower",
                                                                   earfcn, bw, powerTx,
  ...
  }
  {
    ...
    AddTestCase (new cv2x_LteDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb6run1earfcn500",
                                                                   earfcn, bw, powerTx,
                                                                   powerTxMap, activeRbs_txpowdB30nrb6run1earfcn500,
                                                                   spectrumValue_txpowdB30nrb6run1earfcn500), TestCase::QUICK);
  }
  {
    ...
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_3);
    powerTxMap.insert (std::pair<int,double>(0, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_4dot77);
    powerTxMap.insert (std::pair<int,double>(1, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert (std::pair<int,double>(2, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB1);
    powerTxMap.insert (std::pair<int,double>(3, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB2);
    ...
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB_1dot77);
    ...
    rbTxPower = CalculateRbTxPower (powerTx, cv2x_LteRrcSap::PdschConfigDedicated::dB3);
    powerTxMap.insert (std::pair<int,double>(24, rbTxPower));


    SpectrumValue spectrumValue_txpowdB30nrb25run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, bw));
    ...
    AddTestCase (new cv2x_LteDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb25run1earfcn500_allRbPower",
                                                                   earfcn, bw, powerTx,
  ...
  }
  {
    ...
    AddTestCase (new cv2x_LteDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb25run1earfcn500",
                                                                   earfcn, bw, powerTx,
                                                                   powerTxMap, activeRbs_txpowdB30nrb25run1earfcn500,
                                                                   spectrumValue_txpowdB30nrb25run1earfcn500), TestCase::QUICK);
  }
  ...
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (false, cv2x_LteRrcSap::PdschConfigDedicated::dB0,
                                                    "DataCtrlPowerDifference_noChange"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB_6,
                                                    "DataCtrlPowerDifference_dB_6"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB_4dot77,
                                                    "DataCtrlPowerDifference_dB_4dot77"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB_3,
                                                    "DataCtrlPowerDifference_dB_3"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB_1dot77,
                                                    "DataCtrlPowerDifference_dB_1dot77"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB0,
                                                    "DataCtrlPowerDifference_dB0"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB1,
                                                    "DataCtrlPowerDifference_dB1"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB2,
                                                    "DataCtrlPowerDifference_dB2"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlTestCase (true, cv2x_LteRrcSap::PdschConfigDedicated::dB3,
                                                    "DataCtrlPowerDifference_dB3"), TestCase::QUICK);


  // RrcConnectionReconfiguration test
  AddTestCase (new cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase (false, "RrcConnReconf-IdealRrc"), TestCase::QUICK);
  AddTestCase (new cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase (true, "RrcConnReconf-RealRrc"), TestCase::QUICK);


}

double
cv2x_LteDownlinkPowerControlTestSuite::CalculateRbTxPower (double txPower, uint8_t pa)
{
  cv2x_LteRrcSap::PdschConfigDedicated pdschConfigDedicated;
  pdschConfigDedicated.pa = pa;
  double rbTxpower = txPower + cv2x_LteRrcSap::ConvertPdschConfigDedicated2Double (pdschConfigDedicated);

  return rbTxpower;
}

static cv2x_LteDownlinkPowerControlTestSuite lteDownlinkPowerControlTestSuite;
...
cv2x_LteDownlinkPowerControlSpectrumValueTestCase::cv2x_LteDownlinkPowerControlSpectrumValueTestCase (std::string name,
  ...
  : TestCase ("Downlink Power Control: " + name),
    m_actual (cv2x_LteSpectrumValueHelper::CreateTxPowerSpectralDensity (earfcn, bw, powerTx, powerTxMap, activeRbs)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_INFO ("Creating cv2x_LteDownlinkPowerControlTestCase");
}

cv2x_LteDownlinkPowerControlSpectrumValueTestCase::~cv2x_LteDownlinkPowerControlSpectrumValueTestCase ()
{
}

void
cv2x_LteDownlinkPowerControlSpectrumValueTestCase::DoRun (void)
{
  NS_LOG_INFO ("Creating cv2x_LteDownlinkPowerControlSpectrumValueTestCase");
...
cv2x_LteDownlinkPowerControlTestCase::cv2x_LteDownlinkPowerControlTestCase (bool changePower, uint8_t pa, std::string name)
  : TestCase ("Downlink Power Control: " + name)
{
  m_changePdschConfigDedicated = changePower;
  m_pdschConfigDedicated.pa = pa;
  m_expectedPowerDiff = cv2x_LteRrcSap::ConvertPdschConfigDedicated2Double (m_pdschConfigDedicated);
  NS_LOG_INFO ("Creating cv2x_LteDownlinkPowerControlTestCase");
}

cv2x_LteDownlinkPowerControlTestCase::~cv2x_LteDownlinkPowerControlTestCase ()
{
}

void
cv2x_LteDownlinkPowerControlTestCase::DoRun (void)
{
  Config::Reset ();
  ...
  Ptr<cv2x_LteFfrSimple> simpleFfrAlgorithm = DynamicCast<cv2x_LteFfrSimple>(tmp.GetObject ());
  ...
  Ptr<cv2x_LtePhy> ue1Phy = ueDevs.Get (0)->GetObject<cv2x_LteUeNetDevice> ()->GetPhy ()->GetObject<cv2x_LtePhy> ();

  Ptr<cv2x_LteChunkProcessor> testDlDataPowerReceived = Create<cv2x_LteChunkProcessor> ();
  cv2x_LteSpectrumValueCatcher dlDataPowerReceivedCatcher;
  testDlDataPowerReceived->AddCallback (MakeCallback (&cv2x_LteSpectrumValueCatcher::ReportValue, &dlDataPowerReceivedCatcher));
  ue1Phy->GetDownlinkSpectrumPhy ()->AddDataPowerChunkProcessor (testDlDataPowerReceived);

  Ptr<cv2x_LteChunkProcessor> testDlCtrlPowerReceived = Create<cv2x_LteChunkProcessor> ();
  cv2x_LteSpectrumValueCatcher dlCtrlPowerReceivedCatcher;
  testDlCtrlPowerReceived->AddCallback (MakeCallback (&cv2x_LteSpectrumValueCatcher::ReportValue, &dlCtrlPowerReceivedCatcher));
...
void
NotifyConnectionReconfigurationUe (cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
...
void
NotifyConnectionReconfigurationEnb (cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
                                    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti)
{
...
void
ChangePdschConfigDedicatedCallback (cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
...
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase (bool useIdealRrc, std::string name)
  : TestCase ("Downlink Power Control: " + name),
...
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::~cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase ()
{
}

void
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::ConnectionReconfigurationEnb (std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti)
{
...
void
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::ConnectionReconfigurationUe (std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti)
{
  if (Simulator::Now () > MilliSeconds (100))
    {
...
void
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::ChangePdschConfigDedicated (uint16_t rnti, uint8_t pa)
{
...
void
cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::DoRun (void)
{
  Config::Reset ();
  ...
  */
  ...
  Ptr<cv2x_LteFfrSimple> simpleFfrAlgorithm = DynamicCast<cv2x_LteFfrSimple>(tmp.GetObject ());
  cv2x_LteRrcSap::PdschConfigDedicated pdschConfigDedicated;
  pdschConfigDedicated.pa = cv2x_LteRrcSap::PdschConfigDedicated::dB_6;
  ...
  Config::Connect ("/NodeList/0/DeviceList/0/cv2x_LteFfrAlgorithm/ChangePdschConfigDedicated",
                   MakeBoundCallback (&ChangePdschConfigDedicatedCallback, this));
  Config::Connect ("/NodeList/1/DeviceList/0/cv2x_LteUeRrc/ConnectionReconfiguration",
                   MakeBoundCallback (&NotifyConnectionReconfigurationUe, this));
  Config::Connect ("/NodeList/0/DeviceList/0/cv2x_LteEnbRrc/ConnectionReconfiguration",
