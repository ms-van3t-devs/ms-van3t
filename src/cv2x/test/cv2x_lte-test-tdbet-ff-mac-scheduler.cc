...
#include "cv2x_lte-test-tdbet-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestTdBetFfMacScheduler");

cv2x_LenaTestTdBetFfMacSchedulerSuite::cv2x_LenaTestTdBetFfMacSchedulerSuite ()
  : TestSuite ("lte-tdbet-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestTdBetFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,0,2196000,2292000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (3,0,732000,749000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (6,0,366000,373000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (12,0,183000,184670, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,4800,1383000,807000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (3,4800,461000,253000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (6,4800,230500,125000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (12,4800,115250,62000, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,6000,1191000,621000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (3,6000,397000,201000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (6,6000,198500,97000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (12,6000,99250,48667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,10000,775000,421000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (3,10000,258333,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (6,10000,129166,67000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (12,10000,64583,32667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,20000,421000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (3,20000,140333,41000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (6,20000,70166,22000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (12,20000,35083,12000,errorModel), TestCase::EXTENSIVE);

  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase1 (1,100000,0,0,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaTdBetFfMacSchedulerTestCase2 (dist, estAchievableRateDl, estThrTdBetUl, errorModel), TestCase::QUICK);
}

static cv2x_LenaTestTdBetFfMacSchedulerSuite lenaTestTdBetFfMacSchedulerSuite;
...
std::string 
cv2x_LenaTdBetFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaTdBetFfMacSchedulerTestCase1::cv2x_LenaTdBetFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled)
...
cv2x_LenaTdBetFfMacSchedulerTestCase1::~cv2x_LenaTdBetFfMacSchedulerTestCase1 ()
{
}

void
cv2x_LenaTdBetFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  lteHelper->SetSchedulerType ("ns3::cv2x_TdBetFfMacScheduler");
...
std::string 
cv2x_LenaTdBetFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<double> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
cv2x_LenaTdBetFfMacSchedulerTestCase2::cv2x_LenaTdBetFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estAchievableRateDl, std::vector<uint32_t> estThrTdBetUl, bool errorModelEnabled)
...
cv2x_LenaTdBetFfMacSchedulerTestCase2::~cv2x_LenaTdBetFfMacSchedulerTestCase2 ()
{
}

void
cv2x_LenaTdBetFfMacSchedulerTestCase2::DoRun (void)
{
