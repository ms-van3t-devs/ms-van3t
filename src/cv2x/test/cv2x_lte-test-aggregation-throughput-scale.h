...
#ifndef CV2X_LTE_AGGREGATION_THROUGHPUT_SCALE_H
#define CV2X_LTE_AGGREGATION_THROUGHPUT_SCALE_H
 ...
 *
 * \sa ns3::cv2x_LteAggregationThroughputScaleTestCase
 */
class cv2x_LteAggregationThroughputScaleTestSuite : public TestSuite
{
public:
  cv2x_LteAggregationThroughputScaleTestSuite ();
};
 ...
 */
class cv2x_LteAggregationThroughputScaleTestCase : public TestCase
{
public:
  /**
   ...
   */
  cv2x_LteAggregationThroughputScaleTestCase (std::string name);

  virtual ~cv2x_LteAggregationThroughputScaleTestCase ();
...
#endif /* CV2X_LTE_AGGREGATION_THROUGHPUT_SCALE_H */
