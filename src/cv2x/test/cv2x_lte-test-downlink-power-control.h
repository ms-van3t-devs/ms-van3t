...
#ifndef CV2X_LTE_TEST_DOWNLINK_POWER_CONTROL_H
#define CV2X_LTE_TEST_DOWNLINK_POWER_CONTROL_H
 ...
 * \ingroup tests
 *
 * \brief Test suite for the cv2x_LteDownlinkPowerControlSpectrumValueTestCase.
 *
 */
class cv2x_LteDownlinkPowerControlTestSuite : public TestSuite
{
public:
  cv2x_LteDownlinkPowerControlTestSuite ();
 ...
 */
class cv2x_LteDownlinkPowerControlSpectrumValueTestCase : public TestCase
{
public:
/**
 * \brief Constructor
 ...
 */
  cv2x_LteDownlinkPowerControlSpectrumValueTestCase (std::string name,
                                                uint16_t earfcn, uint8_t bw, double powerTx,
                                                std::map<int, double> powerTxMap, std::vector <int> activeRbs,
                                                SpectrumValue& expected);
  virtual ~cv2x_LteDownlinkPowerControlSpectrumValueTestCase ();
 ...
 */
class cv2x_LteDownlinkPowerControlTestCase : public TestCase
{
public:
/**
 * \brief Constructor
 ...
 * \param name the reference name
 */
  cv2x_LteDownlinkPowerControlTestCase (bool changePower, uint8_t pa, std::string name);
  virtual ~cv2x_LteDownlinkPowerControlTestCase ();
 ...
 * 
 */
class cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase : public TestCase
{
public:
  /**
   * \brief Constructor
   ...
   * \param name the reference name
   */
  cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase (bool useIdealRrc, std::string name);
  virtual ~cv2x_LteDownlinkPowerControlRrcConnectionReconfigurationTestCase ();
...
#endif /* CV2X_LTE_TEST_DOWNLINK_POWER_CONTROL_H */
