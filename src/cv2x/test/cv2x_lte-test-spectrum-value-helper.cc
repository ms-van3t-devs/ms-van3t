...
NS_LOG_COMPONENT_DEFINE ("cv2x_LteTestSpectrumValueHelper");
 ...
 */
class cv2x_LteSpectrumModelTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteSpectrumModelTestCase (const char* str, uint16_t earfcn, uint8_t bw, std::vector<double> fcs);
  virtual ~cv2x_LteSpectrumModelTestCase ();
...
cv2x_LteSpectrumModelTestCase::cv2x_LteSpectrumModelTestCase (const char* str, uint16_t earfcn, uint8_t bw, std::vector<double> fcs)
  :   TestCase (std::string ("SpectrumModel ") + str)
{
  NS_LOG_FUNCTION (this << str << earfcn << bw);
  m_actual = cv2x_LteSpectrumValueHelper::GetSpectrumModel (earfcn, bw);
  m_expected = Create<SpectrumModel> (fcs);
}

cv2x_LteSpectrumModelTestCase::~cv2x_LteSpectrumModelTestCase ()
{
}

void 
cv2x_LteSpectrumModelTestCase::DoRun (void)
{
 ...
 */
class cv2x_LteNoisePsdTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteNoisePsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected);
  virtual ~cv2x_LteNoisePsdTestCase ();
...
cv2x_LteNoisePsdTestCase::cv2x_LteNoisePsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected)
  :   TestCase (str),
    m_actual (cv2x_LteSpectrumValueHelper::CreateNoisePowerSpectralDensity (earfcn, bw, noiseFigureDb)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_FUNCTION (this << str << earfcn << bw << noiseFigureDb);
}

cv2x_LteNoisePsdTestCase::~cv2x_LteNoisePsdTestCase ()
{
}

void 
cv2x_LteNoisePsdTestCase::DoRun (void)
{
 ...
 */
class cv2x_LteTxPsdTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   * \param expected executed spectrum value
   */
  cv2x_LteTxPsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected);
  virtual ~cv2x_LteTxPsdTestCase ();
...
cv2x_LteTxPsdTestCase::cv2x_LteTxPsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected)
  :   TestCase (str),
    m_actual (cv2x_LteSpectrumValueHelper::CreateTxPowerSpectralDensity (earfcn, bw, txPowerDbm, activeRbs)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_FUNCTION (this << str << earfcn << bw << txPowerDbm);
}

cv2x_LteTxPsdTestCase::~cv2x_LteTxPsdTestCase ()
{
}

void 
cv2x_LteTxPsdTestCase::DoRun (void)
{
  NS_TEST_ASSERT_MSG_EQ (m_actual->GetSpectrumModelUid (), m_expected->GetSpectrumModelUid (), "SpectrumModel UID mismatch");
 ...
 * \ingroup tests
 *
 * \brief Test suite for cv2x_LteSpectrumValueHelper. Test suite is 
 * checking different functionalities of cv2x_LteSpectrumValueHelper.
 */
class cv2x_LteSpectrumValueHelperTestSuite : public TestSuite
{
public:
  cv2x_LteSpectrumValueHelperTestSuite ();
};

static cv2x_LteSpectrumValueHelperTestSuite g_lteSpectrumValueHelperTestSuite;

cv2x_LteSpectrumValueHelperTestSuite::cv2x_LteSpectrumValueHelperTestSuite ()
  : TestSuite ("lte-spectrum-value-helper", UNIT)
{
//   LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
//   LogComponentEnable ("cv2x_LteSpectrumModelTestCase", logLevel);
//   LogComponentEnable ("cv2x_LteSpectrumValueHelperTestSuite", logLevel);
//   LogComponentEnable ("cv2x_LteSpectrumValueHelper", logLevel);

 
  NS_LOG_INFO ("Creating cv2x_LteSpectrumValueHelperTestSuite");
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb6", 500, 6, fc2160nrb6), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb15", 500, 15, fc2160nrb15), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb25", 500, 25, fc2160nrb25), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb50", 500, 50, fc2160nrb50), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb75", 500, 75, fc2160nrb75), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc2160nrb100", 500, 100, fc2160nrb100), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb6", 19400, 6, fc1730nrb6), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb15", 19400, 15, fc1730nrb15), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb25", 19400, 25, fc1730nrb25), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb50", 19400, 50, fc1730nrb50), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb75", 19400, 75, fc1730nrb75), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteSpectrumModelTestCase ("fc1730nrb100", 19400, 100, fc1730nrb100), TestCase::QUICK);


  SpectrumValue nfdB0earfcn500nrb6 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteNoisePsdTestCase ("nfdB0earfcn500nrb6", 500, 6, 0.000000, nfdB0earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb6 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteNoisePsdTestCase ("nfdB5earfcn500nrb6", 500, 6, 5.000000, nfdB5earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb6 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteNoisePsdTestCase ("nfdB10earfcn500nrb6", 500, 6, 10.000000, nfdB10earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB0earfcn500nrb15 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  AddTestCase (new cv2x_LteNoisePsdTestCase ("nfdB0earfcn500nrb15", 500, 15, 0.000000, nfdB0earfcn500nrb15), TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb15 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  AddTestCase (new cv2x_LteNoisePsdTestCase ("nfdB5earfcn500nrb15", 500, 15, 5.000000, nfdB5earfcn500nrb15), TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb15 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  SpectrumValue spectrumValue_txpowdB10nrb6run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb6run1earfcn500", 500, 6, 10.000000, activeRbs_txpowdB10nrb6run1earfcn500, spectrumValue_txpowdB10nrb6run1earfcn500), TestCase::QUICK);

  std::vector<int> activeRbs_txpowdB30nrb6run1earfcn500 (1);
  activeRbs_txpowdB30nrb6run1earfcn500[0] = 5.000000000000e+00;
  SpectrumValue spectrumValue_txpowdB30nrb6run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb6run1earfcn500", 500, 6, 30.000000, activeRbs_txpowdB30nrb6run1earfcn500, spectrumValue_txpowdB30nrb6run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb25run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb25run1earfcn500", 500, 25, 10.000000, activeRbs_txpowdB10nrb25run1earfcn500, spectrumValue_txpowdB10nrb25run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb25run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb25run1earfcn500", 500, 25, 30.000000, activeRbs_txpowdB30nrb25run1earfcn500, spectrumValue_txpowdB30nrb25run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb100run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb100run1earfcn500", 500, 100, 10.000000, activeRbs_txpowdB10nrb100run1earfcn500, spectrumValue_txpowdB10nrb100run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb100run1earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb100run1earfcn500", 500, 100, 30.000000, activeRbs_txpowdB30nrb100run1earfcn500, spectrumValue_txpowdB30nrb100run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb6run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb6run2earfcn500", 500, 6, 10.000000, activeRbs_txpowdB10nrb6run2earfcn500, spectrumValue_txpowdB10nrb6run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb6run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb6run2earfcn500", 500, 6, 30.000000, activeRbs_txpowdB30nrb6run2earfcn500, spectrumValue_txpowdB30nrb6run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb25run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb25run2earfcn500", 500, 25, 10.000000, activeRbs_txpowdB10nrb25run2earfcn500, spectrumValue_txpowdB10nrb25run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb25run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb25run2earfcn500", 500, 25, 30.000000, activeRbs_txpowdB30nrb25run2earfcn500, spectrumValue_txpowdB30nrb25run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb100run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB10nrb100run2earfcn500", 500, 100, 10.000000, activeRbs_txpowdB10nrb100run2earfcn500, spectrumValue_txpowdB10nrb100run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb100run2earfcn500 (cv2x_LteSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new cv2x_LteTxPsdTestCase ("txpowdB30nrb100run2earfcn500", 500, 100, 30.000000, activeRbs_txpowdB30nrb100run2earfcn500, spectrumValue_txpowdB30nrb100run2earfcn500), TestCase::QUICK);
