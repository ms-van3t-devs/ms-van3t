...
#include "cv2x_lte-test-uplink-sinr.h"
...
NS_LOG_COMPONENT_DEFINE ("cv2x_LteUplinkSinrTest");
 ...
 * TestSuite
 */
cv2x_LteUplinkSinrTestSuite::cv2x_LteUplinkSinrTestSuite ()
  : TestSuite ("lte-uplink-sinr", SYSTEM)
{
  ...
  AddTestCase (new cv2x_LteUplinkDataSinrTestCase (rxPsd1, rxPsd2, theoreticalSinr1, "sdBm = [-46 -inf] and [-inf -48]"), TestCase::QUICK);
  
  AddTestCase (new cv2x_LteUplinkSrsSinrTestCase (rxPsd1, rxPsd2, theoreticalSinr1, "sdBm = [-46 -inf] and [-inf -48]"), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LteUplinkDataSinrTestCase (rxPsd3, rxPsd4, theoreticalSinr2, "sdBm = [-63 -inf] and [-inf -61]"), TestCase::QUICK);
  
  AddTestCase (new cv2x_LteUplinkSrsSinrTestCase (rxPsd3, rxPsd4, theoreticalSinr2, "sdBm = [-63 -inf] and [-inf -61]"), TestCase::QUICK);

}

static cv2x_LteUplinkSinrTestSuite lteUplinkSinrTestSuite;
...
cv2x_LteUplinkDataSinrTestCase::cv2x_LteUplinkDataSinrTestCase (Ptr<SpectrumValue> sv1, Ptr<SpectrumValue> sv2, Ptr<SpectrumValue> sinr, std::string name)
  : TestCase ("SINR calculation in uplink data frame: " + name),
    ...
    m_expectedSinr (sinr)
{
  NS_LOG_INFO ("Creating cv2x_LteUplinkDataSinrTestCase");
}

cv2x_LteUplinkDataSinrTestCase::~cv2x_LteUplinkDataSinrTestCase ()
{
}


void
cv2x_LteUplinkDataSinrTestCase::DoRun (void)
{
  /**
  ...
  */
  ...
  Simulator::Schedule (ts, &cv2x_LteSpectrumPhy::StartRx, ulPhy, sp1);

  Ptr<cv2x_LteSpectrumSignalParametersDataFrame> sp2 = Create<cv2x_LteSpectrumSignalParametersDataFrame> ();
  sp2->psd = m_sv2;
  sp2->txPhy = 0;
  sp2->duration = ds;
  sp2->packetBurst = packetBursts[1];
  sp2->cellId = pbCellId[1];
  Simulator::Schedule (ts, &cv2x_LteSpectrumPhy::StartRx, ulPhy, sp2);
  ...
  Simulator::Schedule (ti1, &cv2x_LteSpectrumPhy::StartRx, ulPhy, ip1);
  ...
  Simulator::Schedule (ti2, &cv2x_LteSpectrumPhy::StartRx, ulPhy, ip2);
  ...
  Simulator::Schedule (ti3, &cv2x_LteSpectrumPhy::StartRx, ulPhy, ip3);
  ...
  Simulator::Schedule (ti4, &cv2x_LteSpectrumPhy::StartRx, ulPhy, ip4);
...
cv2x_LteUplinkSrsSinrTestCase::cv2x_LteUplinkSrsSinrTestCase (Ptr<SpectrumValue> sv1, Ptr<SpectrumValue> sv2, Ptr<SpectrumValue> sinr, std::string name)
  : TestCase ("SINR calculation in uplink srs frame: " + name),
    ...
    m_expectedSinr (sinr)
{
  NS_LOG_INFO ("Creating cv2x_LteUplinkSrsSinrTestCase");
}

cv2x_LteUplinkSrsSinrTestCase::~cv2x_LteUplinkSrsSinrTestCase ()
{
}

void
cv2x_LteUplinkSrsSinrTestCase::ReportSinr (const SpectrumValue& sinr)
{
  m_actualSinr = sinr.Copy ();
}

void
cv2x_LteUplinkSrsSinrTestCase::DoRun (void)
{
  /**
  * Instantiate a single receiving cv2x_LteSpectrumPhy
  */
  ...
  Ptr<cv2x_LteChunkProcessor> chunkProcessor = Create<cv2x_LteChunkProcessor> ();
  chunkProcessor->AddCallback (MakeCallback (&cv2x_LteUplinkSrsSinrTestCase::ReportSinr, this));
  ...
  *  cv2x_LteSpectrumSignalParametersUlSrsFrame of the first signal will have the
  ...
  */
  ...
  // 2 UEs send data to the eNB through 2 subcarriers
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> sp1 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  sp1->psd = m_sv1;
  sp1->txPhy = 0;
  sp1->duration = ds;
  sp1->cellId = pbCellId[0];
  ...
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> sp2 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  sp2->psd = m_sv2;
  sp2->txPhy = 0;
  sp2->duration = ds;
  sp2->cellId = pbCellId[1];
  ...
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> ip1 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  ip1->psd = i1;
  ip1->txPhy = 0;
  ip1->duration = di1;
  ip1->cellId = pbCellId[2];
  ...
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> ip2 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  ip2->psd = i2;
  ip2->txPhy = 0;
  ip2->duration = di2;
  ip2->cellId = pbCellId[3];
  ...
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> ip3 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  ip3->psd = i3;
  ip3->txPhy = 0;
  ip3->duration = di3;
  ip3->cellId = pbCellId[4];
  ...
  Ptr<cv2x_LteSpectrumSignalParametersUlSrsFrame> ip4 = Create<cv2x_LteSpectrumSignalParametersUlSrsFrame> ();
  ip4->psd = i4;
  ip4->txPhy = 0;
  ip4->duration = di4;
  ip4->cellId = pbCellId[5];
