...
#ifndef CV2X_LENA_TEST_PHY_ERROR_MODEL_H
#define CV2X_LENA_TEST_PHY_ERROR_MODEL_H
 ...
 */
class cv2x_LenaDataPhyErrorModelTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaDataPhyErrorModelTestCase (uint16_t nUser, uint16_t dist,
                                 double blerRef, uint16_t toleranceRxPackets,
                                 Time statsStartTime, uint32_t rngRun);
  virtual ~cv2x_LenaDataPhyErrorModelTestCase ();
 ...
 */
class cv2x_LenaDlCtrlPhyErrorModelTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaDlCtrlPhyErrorModelTestCase (uint16_t nEnb, uint16_t dist,
                                   double blerRef, uint16_t toleranceRxPackets,
                                   Time statsStartTime, uint32_t rngRun);
  virtual ~cv2x_LenaDlCtrlPhyErrorModelTestCase ();
 ...
 */
class cv2x_LenaTestPhyErrorModelSuite : public TestSuite
{
public:
  cv2x_LenaTestPhyErrorModelSuite ();
};

#endif /* CV2X_LENA_TEST_PHY_ERROR_MODEL_H */
