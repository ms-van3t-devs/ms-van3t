...
#ifndef CV2X_LTE_TEST_CELL_SELECTION_H
#define CV2X_LTE_TEST_CELL_SELECTION_H
 ...
 *
 * \sa ns3::cv2x_LteCellSelectionTestCase
 */
class cv2x_LteCellSelectionTestSuite : public TestSuite
{
public:
  cv2x_LteCellSelectionTestSuite ();
};
 ...
 */
class cv2x_LteCellSelectionTestCase : public TestCase
{
public:
  /**
   ...
   */
  cv2x_LteCellSelectionTestCase (std::string name, bool isEpcMode, bool isIdealRrc,
                            double interSiteDistance,
                            std::vector<UeSetup_t> ueSetupList,
                            uint64_t rngRun);

  virtual ~cv2x_LteCellSelectionTestCase ();
...
private:
   ...
   */
  void CheckPoint (Ptr<cv2x_LteUeNetDevice> ueDev, uint16_t expectedCellId1,
  ...
  std::vector<cv2x_LteUeRrc::State> m_lastState;

}; // end of class cv2x_LteCellSelectionTestCase

#endif /* CV2X_LTE_TEST_CELL_SELECTION_H */
