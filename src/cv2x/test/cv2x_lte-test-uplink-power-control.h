...
#ifndef CV2X_LTE_TEST_UPLINK_POWER_CONTROL_H
#define CV2X_LTE_TEST_UPLINK_POWER_CONTROL_H
 ...
 */
class cv2x_LteUplinkPowerControlTestSuite : public TestSuite
{
public:
  cv2x_LteUplinkPowerControlTestSuite ();
};
 ...
 */
class cv2x_LteUplinkPowerControlTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteUplinkPowerControlTestCase (std::string name);
  virtual ~cv2x_LteUplinkPowerControlTestCase ();
...
protected:
  ...
  Ptr<cv2x_LteUePowerControl> m_ueUpc; ///< UE power control
  bool m_accumulatedMode; ///< indicates whether accumulated mode is being used

  Ptr<cv2x_LteFfrSimple> m_ffrSimple; ///< FFR simple
};
 ...
 */
class cv2x_LteUplinkOpenLoopPowerControlTestCase : public cv2x_LteUplinkPowerControlTestCase
{
public:
  /**
   * Constructor
   ...
   * \param name the reference name
   */
  cv2x_LteUplinkOpenLoopPowerControlTestCase (std::string name);
  virtual ~cv2x_LteUplinkOpenLoopPowerControlTestCase ();
 ...
 */
class cv2x_LteUplinkClosedLoopPowerControlAbsoluteModeTestCase : public cv2x_LteUplinkPowerControlTestCase
{
public:
  /**
   * Constructor
   ...
   * \param name the reference name
   */
  cv2x_LteUplinkClosedLoopPowerControlAbsoluteModeTestCase (std::string name);
  virtual ~cv2x_LteUplinkClosedLoopPowerControlAbsoluteModeTestCase ();
 ...
 */
class cv2x_LteUplinkClosedLoopPowerControlAccumulatedModeTestCase : public cv2x_LteUplinkPowerControlTestCase
{
public:
  /**
   * Constructor
   ...
   * \param name the reference name
   */
  cv2x_LteUplinkClosedLoopPowerControlAccumulatedModeTestCase (std::string name);
  virtual ~cv2x_LteUplinkClosedLoopPowerControlAccumulatedModeTestCase ();

private:
  virtual void DoRun (void);
};

#endif /* CV2X_LTE_TEST_UPLINK_POWER_CONTROL_H */
