...
#ifndef CV2X_LTE_TEST_UPLINK_SINR_H
#define CV2X_LTE_TEST_UPLINK_SINR_H
 ...
 */
class cv2x_LteUplinkSinrTestSuite : public TestSuite
{
public:
  cv2x_LteUplinkSinrTestSuite ();
};
 ...
 * in given conditions. 
 */
class cv2x_LteUplinkDataSinrTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LteUplinkDataSinrTestCase (Ptr<SpectrumValue> sv1, Ptr<SpectrumValue> sv2, Ptr<SpectrumValue> sinr, std::string name);
  virtual ~cv2x_LteUplinkDataSinrTestCase ();
 ...
 * \brief  In this test one signal will be of interest, i.e., the
  ...
  *  theoretical value.
 */
class cv2x_LteUplinkSrsSinrTestCase : public TestCase
{
  public:
  /**
   * Constructor
   ...
   * \param name the reference name
   */
    cv2x_LteUplinkSrsSinrTestCase (Ptr<SpectrumValue> sv1, Ptr<SpectrumValue> sv2, Ptr<SpectrumValue> sinr, std::string name);
    virtual ~cv2x_LteUplinkSrsSinrTestCase ();
    
  /** 
   * Callback to be connected to an cv2x_LteChunkProcessor to collect the reported SINR
   * 
   * \param sinr 
   */
...
#endif /* CV2X_LTE_TEST_UPLINK_SINR_H */
