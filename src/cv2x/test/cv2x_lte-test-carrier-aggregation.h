...
#ifndef CV2X_TEST_CARRIER_AGGREGATION_H
#define CV2X_TEST_CARRIER_AGGREGATION_H
 ...
 */
class cv2x_CarrierAggregationTestCase : public TestCase
{
public:
   ...
   */
  cv2x_CarrierAggregationTestCase (uint16_t nUser, uint16_t dist, uint32_t dlbandwidth, uint32_t ulBandwidth, uint32_t numberOfComponentCarriers);
  virtual ~cv2x_CarrierAggregationTestCase ();
  /**
 ...
 */
class cv2x_TestCarrierAggregationSuite : public TestSuite
{
public:
  cv2x_TestCarrierAggregationSuite ();
};

#endif /* CV2X_TEST_CARRIER_AGGREGATION_H */
