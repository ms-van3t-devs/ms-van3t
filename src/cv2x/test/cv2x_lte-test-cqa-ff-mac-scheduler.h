...
#ifndef CV2X_LENA_TEST_CQA_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_CQA_FF_MAC_SCHEDULER_H
...
class cv2x_LenaCqaFfMacSchedulerTestCase1 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaCqaFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaCqaFfMacSchedulerTestCase1 ();
...
class cv2x_LenaCqaFfMacSchedulerTestCase2 : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaCqaFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrCqaDl, std::vector<uint16_t> packetSize, uint16_t interval, bool  errorModelEnabled);
  virtual ~cv2x_LenaCqaFfMacSchedulerTestCase2 ();
...
class cv2x_LenaTestCqaFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestCqaFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_CQA_FF_MAC_SCHEDULER_H */
