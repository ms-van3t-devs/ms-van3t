...
#include "cv2x_lte-test-cqa-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("cv2x_LenaTestCqaFfMacScheduler");

cv2x_LenaTestCqaFfMacSchedulerSuite::cv2x_LenaTestCqaFfMacSchedulerSuite ()
  : TestSuite ("lte-cqa-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating cv2x_LenaTestCqaFfMacSchedulerSuite");
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (1,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (3,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (6,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);

  //AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (12,0,183000,185000,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (1,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (3,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (6,4800,230500,125000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (12,4800,115250,62000,200,1,errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (1,6000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (3,6000,232000,201000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (6,6000,198500,97000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (12,6000,99250,48667,200,1, errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (1,10000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (3,10000,232000,137000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (6,10000,129166,67000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (12,10000,64583,32667,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail


  // DOWNLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  // UPLINK - DISTANCE 100000 -> CQI == 0 -> out of range -> 0 bytes/sec
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase1 (1,100000,0,0,200,1,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase2 (dist1,estThrCqaDl1,packetSize1,1,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase2 (dist2,estThrCqaDl2,packetSize2,1,errorModel), TestCase::QUICK);
  ...
  AddTestCase (new cv2x_LenaCqaFfMacSchedulerTestCase2 (dist3,estThrCqaDl3,packetSize3,1,errorModel), TestCase::QUICK);

}

static cv2x_LenaTestCqaFfMacSchedulerSuite lenaTestCqaFfMacSchedulerSuite;

// --------------- T E S T - C A S E   # 1 ------------------------------


std::string 
cv2x_LenaCqaFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, double dist)
{
...
cv2x_LenaCqaFfMacSchedulerTestCase1::cv2x_LenaCqaFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval,bool errorModelEnabled)
...
cv2x_LenaCqaFfMacSchedulerTestCase1::~cv2x_LenaCqaFfMacSchedulerTestCase1 ()
{
}

void
cv2x_LenaCqaFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  //LogComponentEnable ("cv2x_CqaFfMacScheduler", LOG_DEBUG);
...
//   LogComponentDisableAll (LOG_LEVEL_ALL);
  ...
  lteHelper->SetSchedulerType ("ns3::cv2x_CqaFfMacScheduler");
...
std::string 
cv2x_LenaCqaFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<double> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
cv2x_LenaCqaFfMacSchedulerTestCase2::cv2x_LenaCqaFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrCqaDl, std::vector<uint16_t> packetSize, uint16_t interval,bool errorModelEnabled)
...
cv2x_LenaCqaFfMacSchedulerTestCase2::~cv2x_LenaCqaFfMacSchedulerTestCase2 ()
{
}

void
cv2x_LenaCqaFfMacSchedulerTestCase2::DoRun (void)
{
