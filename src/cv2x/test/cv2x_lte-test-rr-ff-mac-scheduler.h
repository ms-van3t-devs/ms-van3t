...
#ifndef CV2X_LENA_TEST_RR_FF_MAC_SCHEDULER_H
#define CV2X_LENA_TEST_RR_FF_MAC_SCHEDULER_H
 ...
 * tolerance.
 */
class cv2x_LenaRrFfMacSchedulerTestCase : public TestCase
{
public:
  /**
   * Constructor
   ...
   */
  cv2x_LenaRrFfMacSchedulerTestCase (uint16_t nUser, double dist, double thrRefDl, double thrRefUl, bool errorModelEnabled);
  virtual ~cv2x_LenaRrFfMacSchedulerTestCase ();
 ...
 * \ingroup tests
 *
 * \brief Test suite for cv2x_RrFfMacScheduler test
 */
class cv2x_LenaTestRrFfMacSchedulerSuite : public TestSuite
{
public:
  cv2x_LenaTestRrFfMacSchedulerSuite ();
};

#endif /* CV2X_LENA_TEST_RR_FF_MAC_SCHEDULER_H */
