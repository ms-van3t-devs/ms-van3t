...
typedef enum CauseCodeType {
	...
	CauseCodeType_dangerousDriving	= 101,
	CauseCodeType_intersectionViolation	= 102,
	CauseCodeType_vehicleProblem	= 103,
	CauseCodeType_intersectionCollision	= 104,
	CauseCodeType_hazardousLocation	= 105
} e_CauseCodeType;
