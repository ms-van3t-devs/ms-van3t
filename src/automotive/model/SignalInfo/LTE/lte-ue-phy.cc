...
double LteUePhy::s_sentinel_value = 42000;
double LteUePhy::s_last_rsrp = LteUePhy::s_sentinel_value;
double LteUePhy::s_last_rssi = LteUePhy::s_sentinel_value;
      ...
      while (itPss != m_pssList.end ())
        {
          ...
          LteUePhy::s_last_rssi = (10* log10 (rssiSum/rbNum));
          LteUePhy::s_last_rsrp = rsrq_dB;
