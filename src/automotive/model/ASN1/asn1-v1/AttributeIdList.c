...
static asn_oer_constraints_t asn_OER_type_AttributeIdList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
static asn_per_constraints_t asn_PER_type_AttributeIdList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  7,  7,  0,  127 }	/* (SIZE(0..127,...)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_AttributeIdList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_AttributeIdList_specs_1 = {
