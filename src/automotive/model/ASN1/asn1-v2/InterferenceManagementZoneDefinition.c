...
asn_TYPE_member_t asn_MBR_InterferenceManagementZoneDefinition_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct InterferenceManagementZoneDefinition, interferenceManagementZoneShape),
		...
		&asn_DEF_Shape,
		0,
		{ &asn_OER_memb_interferenceManagementZoneShape_constr_5, &asn_PER_memb_interferenceManagementZoneShape_constr_5,  memb_interferenceManagementZoneShape_constraint_1 },
		0, 0, /* No default value */
