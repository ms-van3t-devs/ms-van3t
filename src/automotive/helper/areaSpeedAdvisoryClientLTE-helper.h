#ifndef AREASPEEDADVISORYCLIENTLTE_HELPER_H
#define AREASPEEDADVISORYCLIENTLTE_HELPER_H
 ...
 */
class areaSpeedAdvisoryClientLTEHelper
{
public:
  /**
   ...
   */
  areaSpeedAdvisoryClientLTEHelper ();
...
#endif /* AREASPEEDADVISORYCLIENTLTE */
