#ifndef cooperativePerception_HELPER_H
#define cooperativePerception_HELPER_H
 ...
 */
class cooperativePerceptionHelper
{
public:
  /**
...
#endif /* cooperativePerception_HELPER_H */
