#ifndef AREASPEEDADVISORYSERVERLTE_HELPER_H
#define AREASPEEDADVISORYSERVERLTE_HELPER_H
 ...
 */
class areaSpeedAdvisoryServerLTEHelper
{
public:
  /**
   ...
   */
  areaSpeedAdvisoryServerLTEHelper ();
...
#endif /* AREASPEEDADVISORYSERVERLTE_HELPER_H */
