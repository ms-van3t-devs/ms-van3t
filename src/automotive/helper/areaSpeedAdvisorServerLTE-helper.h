#ifndef AREASPEEDADVISORSERVERLTE_HELPER_H
#define AREASPEEDADVISORSERVERLTE_HELPER_H
 ...
 */
class areaSpeedAdvisorServerLTEHelper
{
public:
  /**
   ...
   */
  areaSpeedAdvisorServerLTEHelper ();
...
#endif /* AREASPEEDADVISORSERVERLTE_HELPER_H */
