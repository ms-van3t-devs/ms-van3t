#ifndef V2I_DENM_SENDER_HELPER_H
#define V2I_DENM_SENDER_HELPER_H
 ...
 */
class DENMSenderHelper
{
public:

  DENMSenderHelper (uint16_t port);
   ...
   */
  DENMSenderHelper (std::string protocol, Address address);
