#ifndef trafficManagerSERVER80211PHELPER_H
#define trafficManagerSERVER80211PHELPER_H
...
class trafficManagerServer80211pHelper
{
public:
  trafficManagerServer80211pHelper();
...
#endif // trafficManagerSERVER80211PHELPER_H
