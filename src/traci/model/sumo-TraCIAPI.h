...
public:
    ...
    */
    ...
    public:
        ...
        libsumo::TraCIRoadPosition convertLonLattoRoadmap(double lon, double lat);
    ...
    public:
        ...
        void setAcceleration(const std::string& vehicleID, double acceleration, double duration) const;
